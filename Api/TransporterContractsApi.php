...
/**
 * TransporterContractsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TransporterContractsApi
{
    ...
    /**
     * Operation transporterContractsGet
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transporterContractsGet'] to see the possible values for this operation
     *
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OngoingAPI\Model\GetTransporterContract[]
     */
    public function transporterContractsGet($goods_owner_id, string $contentType = self::contentTypes['transporterContractsGet'][0])
    {
        list($response) = $this->transporterContractsGetWithHttpInfo($goods_owner_id, $contentType);
        return $response;
    }

    /**
     * Operation transporterContractsGetWithHttpInfo
     *
     * Get all transporter contracts for a specific goods owner. The response will include all transporter codes which are available for the goods owner.
     *
     * @param  int $goods_owner_id Goods owner ID. (required)
     ...
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OngoingAPI\Model\GetTransporterContract[], HTTP status code, HTTP response headers (array of strings)
     */
    public function transporterContractsGetWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['transporterContractsGet'][0])
    {
        $request = $this->transporterContractsGetRequest($goods_owner_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OngoingAPI\Model\GetTransporterContract[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OngoingAPI\Model\GetTransporterContract[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OngoingAPI\Model\GetTransporterContract[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OngoingAPI\Model\GetTransporterContract[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OngoingAPI\Model\GetTransporterContract[]',
    ...
    /**
     * Operation transporterContractsGetAsync
     *
     * Get all transporter contracts for a specific goods owner. The response will include all transporter codes which are available for the goods owner.
     *
     * @param  int $goods_owner_id Goods owner ID. (required)
     ...
     */
    public function transporterContractsGetAsync($goods_owner_id, string $contentType = self::contentTypes['transporterContractsGet'][0])
    {
        return $this->transporterContractsGetAsyncWithHttpInfo($goods_owner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transporterContractsGetAsyncWithHttpInfo
     *
     * Get all transporter contracts for a specific goods owner. The response will include all transporter codes which are available for the goods owner.
     *
     * @param  int $goods_owner_id Goods owner ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transporterContractsGetAsyncWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['transporterContractsGet'][0])
    {
        $returnType = '\OngoingAPI\Model\GetTransporterContract[]';
        $request = $this->transporterContractsGetRequest($goods_owner_id, $contentType);
    ...
    /**
     * Create request for operation 'transporterContractsGet'
     *
     * @param  int $goods_owner_id Goods owner ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transporterContractsGet'] to see the possible values for this operation
     *
     ...
     */
    public function transporterContractsGetRequest($goods_owner_id, string $contentType = self::contentTypes['transporterContractsGet'][0])
    {
        ...
        if ($goods_owner_id === null || (is_array($goods_owner_id) && count($goods_owner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goods_owner_id when calling transporterContractsGet'
            );
        }


        $resourcePath = '/api/v1/transporterContracts';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
