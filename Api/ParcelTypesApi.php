...
/**
 * ParcelTypesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ParcelTypesApi
{
    ...
    /**
     * Operation parcelTypesGetParcelTypes
     *
     * Get all parcel types which are valid for a particular goods owner.
     *
     * @param  int $goods_owner_id goods_owner_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['parcelTypesGetParcelTypes'] to see the possible values for this operation
     *
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OngoingAPI\Model\ParcelTypeModel[]
     */
    public function parcelTypesGetParcelTypes($goods_owner_id, string $contentType = self::contentTypes['parcelTypesGetParcelTypes'][0])
    {
        list($response) = $this->parcelTypesGetParcelTypesWithHttpInfo($goods_owner_id, $contentType);
        return $response;
    }

    /**
     * Operation parcelTypesGetParcelTypesWithHttpInfo
     *
     * Get all parcel types which are valid for a particular goods owner.
     *
     ...
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OngoingAPI\Model\ParcelTypeModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function parcelTypesGetParcelTypesWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['parcelTypesGetParcelTypes'][0])
    {
        $request = $this->parcelTypesGetParcelTypesRequest($goods_owner_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OngoingAPI\Model\ParcelTypeModel[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OngoingAPI\Model\ParcelTypeModel[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OngoingAPI\Model\ParcelTypeModel[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OngoingAPI\Model\ParcelTypeModel[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OngoingAPI\Model\ParcelTypeModel[]',
    ...
    /**
     * Operation parcelTypesGetParcelTypesAsync
     *
     * Get all parcel types which are valid for a particular goods owner.
     *
     * @param  int $goods_owner_id (required)
     ...
     */
    public function parcelTypesGetParcelTypesAsync($goods_owner_id, string $contentType = self::contentTypes['parcelTypesGetParcelTypes'][0])
    {
        return $this->parcelTypesGetParcelTypesAsyncWithHttpInfo($goods_owner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation parcelTypesGetParcelTypesAsyncWithHttpInfo
     *
     * Get all parcel types which are valid for a particular goods owner.
     *
     * @param  int $goods_owner_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function parcelTypesGetParcelTypesAsyncWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['parcelTypesGetParcelTypes'][0])
    {
        $returnType = '\OngoingAPI\Model\ParcelTypeModel[]';
        $request = $this->parcelTypesGetParcelTypesRequest($goods_owner_id, $contentType);
    ...
    /**
     * Create request for operation 'parcelTypesGetParcelTypes'
     *
     * @param  int $goods_owner_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['parcelTypesGetParcelTypes'] to see the possible values for this operation
     *
     ...
     */
    public function parcelTypesGetParcelTypesRequest($goods_owner_id, string $contentType = self::contentTypes['parcelTypesGetParcelTypes'][0])
    {
        ...
        if ($goods_owner_id === null || (is_array($goods_owner_id) && count($goods_owner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goods_owner_id when calling parcelTypesGetParcelTypes'
            );
        }


        $resourcePath = '/api/v1/parcelTypes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
