...
class InvoicesApi
{
     ...
     * @param  int[] $invoice_ids Only return the specific invoice IDs. (optional)
     * @param  bool $is_exported Filter for invoices which have (or have not) been marked as exported. (optional)
     * @param  \DateTime $invoice_exported_date_from Only return invoices which have been exported after this date. (optional)
     * @param  \DateTime $invoice_exported_date_to Only return invoices which have been exported before this date. (optional)
     * @param  \DateTime $invoice_date_from Only return invoices whose invoice date is later than this. (optional)
     * @param  \DateTime $invoice_date_to &gt;Only return invoices whose invoice date is earlier than this. (optional)
     * @param  int $invoice_id_from &gt;Only return invoices whose IDs are larger than this. (optional)
     * @param  int $max_invoices_to_get Maximum number of invoices to return. (optional)
     ...
     * @return \OngoingAPI\Model\GetInvoiceModel[]
     */
    public function invoicesGet($goods_owner_id, $invoice_ids = null, $is_exported = null, $invoice_exported_date_from = null, $invoice_exported_date_to = null, $invoice_date_from = null, $invoice_date_to = null, $invoice_id_from = null, $max_invoices_to_get = null, string $contentType = self::contentTypes['invoicesGet'][0])
    {
        list($response) = $this->invoicesGetWithHttpInfo($goods_owner_id, $invoice_ids, $is_exported, $invoice_exported_date_from, $invoice_exported_date_to, $invoice_date_from, $invoice_date_to, $invoice_id_from, $max_invoices_to_get, $contentType);
        return $response;
    }
     ...
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OngoingAPI\Model\GetInvoiceModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function invoicesGetWithHttpInfo($goods_owner_id, $invoice_ids = null, $is_exported = null, $invoice_exported_date_from = null, $invoice_exported_date_to = null, $invoice_date_from = null, $invoice_date_to = null, $invoice_id_from = null, $max_invoices_to_get = null, string $contentType = self::contentTypes['invoicesGet'][0])
    {
        $request = $this->invoicesGetRequest($goods_owner_id, $invoice_ids, $is_exported, $invoice_exported_date_from, $invoice_exported_date_to, $invoice_date_from, $invoice_date_to, $invoice_id_from, $max_invoices_to_get, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OngoingAPI\Model\GetInvoiceModel[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OngoingAPI\Model\GetInvoiceModel[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OngoingAPI\Model\GetInvoiceModel[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OngoingAPI\Model\GetInvoiceModel[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OngoingAPI\Model\GetInvoiceModel[]',
     ...
     */
    public function invoicesGetAsync($goods_owner_id, $invoice_ids = null, $is_exported = null, $invoice_exported_date_from = null, $invoice_exported_date_to = null, $invoice_date_from = null, $invoice_date_to = null, $invoice_id_from = null, $max_invoices_to_get = null, string $contentType = self::contentTypes['invoicesGet'][0])
    {
        return $this->invoicesGetAsyncWithHttpInfo($goods_owner_id, $invoice_ids, $is_exported, $invoice_exported_date_from, $invoice_exported_date_to, $invoice_date_from, $invoice_date_to, $invoice_id_from, $max_invoices_to_get, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesGetAsyncWithHttpInfo($goods_owner_id, $invoice_ids = null, $is_exported = null, $invoice_exported_date_from = null, $invoice_exported_date_to = null, $invoice_date_from = null, $invoice_date_to = null, $invoice_id_from = null, $max_invoices_to_get = null, string $contentType = self::contentTypes['invoicesGet'][0])
    {
        $returnType = '\OngoingAPI\Model\GetInvoiceModel[]';
        $request = $this->invoicesGetRequest($goods_owner_id, $invoice_ids, $is_exported, $invoice_exported_date_from, $invoice_exported_date_to, $invoice_date_from, $invoice_date_to, $invoice_id_from, $max_invoices_to_get, $contentType);
     ...
     */
    public function invoicesGetRequest($goods_owner_id, $invoice_ids = null, $is_exported = null, $invoice_exported_date_from = null, $invoice_exported_date_to = null, $invoice_date_from = null, $invoice_date_to = null, $invoice_id_from = null, $max_invoices_to_get = null, string $contentType = self::contentTypes['invoicesGet'][0])
    {
        ...
        if ($goods_owner_id === null || (is_array($goods_owner_id) && count($goods_owner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goods_owner_id when calling invoicesGet'
            );
        }
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $invoice_exported_date_from,
            'invoiceExportedDateFrom', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $invoice_exported_date_to,
            'invoiceExportedDateTo', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $max_invoices_to_get,
            'maxInvoicesToGet', // param base name
            'integer', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['invoicesGetById'] to see the possible values for this operation
     *
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OngoingAPI\Model\GetInvoiceModel
     */
    public function invoicesGetById($invoice_id, string $contentType = self::contentTypes['invoicesGetById'][0])
    {
        list($response) = $this->invoicesGetByIdWithHttpInfo($invoice_id, $contentType);
        return $response;
    }

    /**
     * Operation invoicesGetByIdWithHttpInfo
     *
     * Get an invoice. This function requires an additional permission for the API user, see Administration-&gt;Integration-&gt;API for goods owners.
     *
     * @param  int $invoice_id Invoice ID. (required)
     ...
     * @return array of \OngoingAPI\Model\GetInvoiceModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function invoicesGetByIdWithHttpInfo($invoice_id, string $contentType = self::contentTypes['invoicesGetById'][0])
    {
        $request = $this->invoicesGetByIdRequest($invoice_id, $contentType);
    ...
    /**
     * Operation invoicesGetByIdAsync
     *
     * Get an invoice. This function requires an additional permission for the API user, see Administration-&gt;Integration-&gt;API for goods owners.
     *
     * @param  int $invoice_id Invoice ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesGetByIdAsync($invoice_id, string $contentType = self::contentTypes['invoicesGetById'][0])
    {
        return $this->invoicesGetByIdAsyncWithHttpInfo($invoice_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation invoicesGetByIdAsyncWithHttpInfo
     *
     * Get an invoice. This function requires an additional permission for the API user, see Administration-&gt;Integration-&gt;API for goods owners.
     *
     * @param  int $invoice_id Invoice ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoicesGetByIdAsyncWithHttpInfo($invoice_id, string $contentType = self::contentTypes['invoicesGetById'][0])
    {
        $returnType = '\OngoingAPI\Model\GetInvoiceModel';
        $request = $this->invoicesGetByIdRequest($invoice_id, $contentType);
    ...
    /**
     * Create request for operation 'invoicesGetById'
     *
     * @param  int $invoice_id Invoice ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['invoicesGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function invoicesGetByIdRequest($invoice_id, string $contentType = self::contentTypes['invoicesGetById'][0])
    {

        // verify the required parameter 'invoice_id' is set
        if ($invoice_id === null || (is_array($invoice_id) && count($invoice_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invoice_id when calling invoicesGetById'
            );
        }


        $resourcePath = '/api/v1/invoices/{invoiceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
