...
/**
 * ArticleItemsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ArticleItemsApi
{
    ...
    public const contentTypes = [
        'articleItemsGetArticleItems' => [
            'application/json',
        ],
        'articleItemsGetOrderClasses' => [
            'application/json',
        ],
    ];
    ...
    /**
     * Operation articleItemsGetArticleItemsWithHttpInfo
     *
     * Get all article items which match the specified search criteria.
     *
     ...
     */
    public function articleItemsGetArticleItemsWithHttpInfo($goods_owner_id, $article_number = null, $article_system_id_from = null, $max_articles_to_get = null, $article_numbers = null, $location_names = null, $article_item_status_codes = null, string $contentType = self::contentTypes['articleItemsGetArticleItems'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OngoingAPI\Model\GetArticleItemsModel[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OngoingAPI\Model\GetArticleItemsModel[]' !== 'string') {
                            try {
            ...
            $returnType = '\OngoingAPI\Model\GetArticleItemsModel[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OngoingAPI\Model\GetArticleItemsModel[]',
    ...
    /**
     * Operation articleItemsGetArticleItemsAsync
     *
     * Get all article items which match the specified search criteria.
     *
     * @param  int $goods_owner_id (required)
     ...
     */
    public function articleItemsGetArticleItemsAsync($goods_owner_id, $article_number = null, $article_system_id_from = null, $max_articles_to_get = null, $article_numbers = null, $location_names = null, $article_item_status_codes = null, string $contentType = self::contentTypes['articleItemsGetArticleItems'][0])
    {
        return $this->articleItemsGetArticleItemsAsyncWithHttpInfo($goods_owner_id, $article_number, $article_system_id_from, $max_articles_to_get, $article_numbers, $location_names, $article_item_status_codes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation articleItemsGetArticleItemsAsyncWithHttpInfo
     *
     * Get all article items which match the specified search criteria.
     *
     * @param  int $goods_owner_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleItemsGetArticleItemsAsyncWithHttpInfo($goods_owner_id, $article_number = null, $article_system_id_from = null, $max_articles_to_get = null, $article_numbers = null, $location_names = null, $article_item_status_codes = null, string $contentType = self::contentTypes['articleItemsGetArticleItems'][0])
    {
        $returnType = '\OngoingAPI\Model\GetArticleItemsModel[]';
        $request = $this->articleItemsGetArticleItemsRequest($goods_owner_id, $article_number, $article_system_id_from, $max_articles_to_get, $article_numbers, $location_names, $article_item_status_codes, $contentType);
    ...
    /**
     * Create request for operation 'articleItemsGetArticleItems'
     *
     * @param  int $goods_owner_id (required)
     * @param  string $article_number Only return article items for this article number (only 1 article number may be specified). (optional)
     * @param  int $article_system_id_from Only return articles whose article system ID is greater than or equal to this. (optional)
     ...
     */
    public function articleItemsGetArticleItemsRequest($goods_owner_id, $article_number = null, $article_system_id_from = null, $max_articles_to_get = null, $article_numbers = null, $location_names = null, $article_item_status_codes = null, string $contentType = self::contentTypes['articleItemsGetArticleItems'][0])
    {
        ...
        if ($goods_owner_id === null || (is_array($goods_owner_id) && count($goods_owner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goods_owner_id when calling articleItemsGetArticleItems'
            );
        }
        ...
        $resourcePath = '/api/v1/articleItems';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $article_item_status_codes,
            'articleItemStatusCodes', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation articleItemsGetOrderClasses
     *
     * Get all article item statuses.
     *
     * @param  int $goods_owner_id goods_owner_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['articleItemsGetOrderClasses'] to see the possible values for this operation
     *
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OngoingAPI\Model\ArticleItemStatusModel
     */
    public function articleItemsGetOrderClasses($goods_owner_id, string $contentType = self::contentTypes['articleItemsGetOrderClasses'][0])
    {
        list($response) = $this->articleItemsGetOrderClassesWithHttpInfo($goods_owner_id, $contentType);
        return $response;
    }

    /**
     * Operation articleItemsGetOrderClassesWithHttpInfo
     *
     * Get all article item statuses.
     *
     * @param  int $goods_owner_id (required)
     ...
     * @throws \OngoingAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OngoingAPI\Model\ArticleItemStatusModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function articleItemsGetOrderClassesWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['articleItemsGetOrderClasses'][0])
    {
        $request = $this->articleItemsGetOrderClassesRequest($goods_owner_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OngoingAPI\Model\ArticleItemStatusModel' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OngoingAPI\Model\ArticleItemStatusModel' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OngoingAPI\Model\ArticleItemStatusModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OngoingAPI\Model\ArticleItemStatusModel';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OngoingAPI\Model\ArticleItemStatusModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation articleItemsGetOrderClassesAsync
     *
     * Get all article item statuses.
     *
     * @param  int $goods_owner_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleItemsGetOrderClassesAsync($goods_owner_id, string $contentType = self::contentTypes['articleItemsGetOrderClasses'][0])
    {
        return $this->articleItemsGetOrderClassesAsyncWithHttpInfo($goods_owner_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation articleItemsGetOrderClassesAsyncWithHttpInfo
     *
     * Get all article item statuses.
     *
     * @param  int $goods_owner_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function articleItemsGetOrderClassesAsyncWithHttpInfo($goods_owner_id, string $contentType = self::contentTypes['articleItemsGetOrderClasses'][0])
    {
        $returnType = '\OngoingAPI\Model\ArticleItemStatusModel';
        $request = $this->articleItemsGetOrderClassesRequest($goods_owner_id, $contentType);
    ...
    /**
     * Create request for operation 'articleItemsGetOrderClasses'
     *
     * @param  int $goods_owner_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['articleItemsGetOrderClasses'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function articleItemsGetOrderClassesRequest($goods_owner_id, string $contentType = self::contentTypes['articleItemsGetOrderClasses'][0])
    {

        // verify the required parameter 'goods_owner_id' is set
        if ($goods_owner_id === null || (is_array($goods_owner_id) && count($goods_owner_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $goods_owner_id when calling articleItemsGetOrderClasses'
            );
        }


        $resourcePath = '/api/v1/articleItems/statuses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
