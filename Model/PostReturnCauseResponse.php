...
/**
 * PostReturnCauseResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostReturnCauseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostReturnCauseResponse';
    ...
    protected static $setters = [
        'return_cause_id' => 'setReturnCauseId',
        'success' => 'setSuccess',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        'return_cause_id' => 'getReturnCauseId',
        'success' => 'getSuccess',
        'message' => 'getMessage'
    ];
    ...
    {
        $this->setIfExists('return_cause_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets return_cause_id
     *
     * @return int|null
     */
    public function getReturnCauseId()
    {
        return $this->container['return_cause_id'];
    }

    /**
     * Sets return_cause_id
     *
     * @param int|null $return_cause_id return_cause_id
     *
     * @return self
     */
    public function setReturnCauseId($return_cause_id)
    {
        if (is_null($return_cause_id)) {
            array_push($this->openAPINullablesSetToNull, 'return_cause_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_cause_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_cause_id'] = $return_cause_id;
