...
/**
 * GetWayOfDeliveryTypesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetWayOfDeliveryTypesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetWayOfDeliveryTypesModel';
    ...
    protected static $openAPITypes = [
        'way_of_delivery_types' => '\OngoingAPI\Model\GetWayOfDeliveryTypeModel[]'
    ];
    ...
    protected static $attributeMap = [
        'way_of_delivery_types' => 'wayOfDeliveryTypes'
    ];
    ...
    protected static $setters = [
        'way_of_delivery_types' => 'setWayOfDeliveryTypes'
    ];
    ...
    protected static $getters = [
        'way_of_delivery_types' => 'getWayOfDeliveryTypes'
    ];
    ...
    {
        $this->setIfExists('way_of_delivery_types', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets way_of_delivery_types
     *
     * @return \OngoingAPI\Model\GetWayOfDeliveryTypeModel[]|null
     */
    public function getWayOfDeliveryTypes()
    {
        return $this->container['way_of_delivery_types'];
    }

    /**
     * Sets way_of_delivery_types
     *
     * @param \OngoingAPI\Model\GetWayOfDeliveryTypeModel[]|null $way_of_delivery_types way_of_delivery_types
     *
     * @return self
     */
    public function setWayOfDeliveryTypes($way_of_delivery_types)
    {
        if (is_null($way_of_delivery_types)) {
            array_push($this->openAPINullablesSetToNull, 'way_of_delivery_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('way_of_delivery_types', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['way_of_delivery_types'] = $way_of_delivery_types;
