<?php
/**
 * GetPickedArticleItemParcelParentAdvanced
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetPickedArticleItemParcelParentAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPickedArticleItemParcelParentAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPickedArticleItemParcelParent_advanced';
    ...
    protected static $openAPITypes = [
        'parcel_serial_number' => 'string',
        'parcel_comment' => 'string',
        'parcel_tare_weight' => 'float'
    ];
    ...
    protected static $openAPIFormats = [
        'parcel_serial_number' => null,
        'parcel_comment' => null,
        'parcel_tare_weight' => 'decimal'
    ];
    ...
    protected static $attributeMap = [
        ...
        'parcel_comment' => 'parcelComment',
        'parcel_tare_weight' => 'parcelTareWeight'
    ];
    ...
    protected static $setters = [
        'parcel_serial_number' => 'setParcelSerialNumber',
        'parcel_comment' => 'setParcelComment',
        'parcel_tare_weight' => 'setParcelTareWeight'
    ];
    ...
    protected static $getters = [
        'parcel_serial_number' => 'getParcelSerialNumber',
        'parcel_comment' => 'getParcelComment',
        'parcel_tare_weight' => 'getParcelTareWeight'
    ];
    ...
    {
        $this->setIfExists('parcel_serial_number', $data ?? [], null);
        $this->setIfExists('parcel_comment', $data ?? [], null);
        $this->setIfExists('parcel_tare_weight', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets parcel_serial_number
     *
     * @return string|null
     */
    public function getParcelSerialNumber()
    {
        return $this->container['parcel_serial_number'];
    }

    /**
     * Sets parcel_serial_number
     *
     * @param string|null $parcel_serial_number parcel_serial_number
     *
     * @return self
     */
    public function setParcelSerialNumber($parcel_serial_number)
    {
        if (is_null($parcel_serial_number)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_serial_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_serial_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parcel_serial_number'] = $parcel_serial_number;
     ...
     * @return string|null
     */
    public function getParcelComment()
    {
        return $this->container['parcel_comment'];
    }

    /**
     * Sets parcel_comment
     *
     * @param string|null $parcel_comment parcel_comment
     *
     * @return self
     */
    public function setParcelComment($parcel_comment)
    {
        if (is_null($parcel_comment)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parcel_comment'] = $parcel_comment;

        return $this;
    }

    /**
     * Gets parcel_tare_weight
     *
     * @return float|null
     */
    public function getParcelTareWeight()
    {
        return $this->container['parcel_tare_weight'];
    }

    /**
     * Sets parcel_tare_weight
     *
     * @param float|null $parcel_tare_weight parcel_tare_weight
     *
     * @return self
     */
    public function setParcelTareWeight($parcel_tare_weight)
    {
        if (is_null($parcel_tare_weight)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_tare_weight');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_tare_weight', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parcel_tare_weight'] = $parcel_tare_weight;
