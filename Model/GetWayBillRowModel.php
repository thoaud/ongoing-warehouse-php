...
/**
 * GetWayBillRowModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetWayBillRowModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetWayBillRowModel';
    ...
    protected static $openAPITypes = [
        ...
        'approved_number_of_packages' => 'int',
        'comment' => 'string',
        'category' => 'string',
        'parcel_type' => '\OngoingAPI\Model\GetWayBillRowModelParcelType'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'approved_number_of_packages' => 'int32',
        'comment' => null,
        'category' => null,
        'parcel_type' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'approved_number_of_packages' => true,
        'comment' => true,
        'category' => true,
        'parcel_type' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'approved_number_of_packages' => 'approvedNumberOfPackages',
        'comment' => 'comment',
        'category' => 'category',
    ...
    protected static $setters = [
        'way_bill_row_id' => 'setWayBillRowId',
        'weight' => 'setWeight',
        'volume' => 'setVolume',
        'length' => 'setLength',
        'width' => 'setWidth',
        ...
        'approved_number_of_packages' => 'setApprovedNumberOfPackages',
        'comment' => 'setComment',
    ...
    protected static $getters = [
        'way_bill_row_id' => 'getWayBillRowId',
        'weight' => 'getWeight',
        'volume' => 'getVolume',
        'length' => 'getLength',
        'width' => 'getWidth',
        ...
        'approved_number_of_packages' => 'getApprovedNumberOfPackages',
        'comment' => 'getComment',
    ...
    {
        $this->setIfExists('way_bill_row_id', $data ?? [], null);
        $this->setIfExists('weight', $data ?? [], null);
        $this->setIfExists('volume', $data ?? [], null);
        $this->setIfExists('length', $data ?? [], null);
        $this->setIfExists('width', $data ?? [], null);
        $this->setIfExists('height', $data ?? [], null);
        $this->setIfExists('number_of_packages', $data ?? [], null);
        $this->setIfExists('approved_number_of_packages', $data ?? [], null);
        $this->setIfExists('comment', $data ?? [], null);
        $this->setIfExists('category', $data ?? [], null);
        $this->setIfExists('parcel_type', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets way_bill_row_id
     *
     * @return int|null
     */
    public function getWayBillRowId()
    {
        return $this->container['way_bill_row_id'];
    }

    /**
     * Sets way_bill_row_id
     *
     * @param int|null $way_bill_row_id way_bill_row_id
     *
     * @return self
     */
    public function setWayBillRowId($way_bill_row_id)
    {
        if (is_null($way_bill_row_id)) {
            throw new \InvalidArgumentException('non-nullable way_bill_row_id cannot be null');
        }
        $this->container['way_bill_row_id'] = $way_bill_row_id;
     ...
     *
     * @param int|null $number_of_packages number_of_packages
     *
     * @return self
     */
    public function setNumberOfPackages($number_of_packages)
    {
        if (is_null($number_of_packages)) {
            throw new \InvalidArgumentException('non-nullable number_of_packages cannot be null');
        }
    ...
    /**
     * Gets approved_number_of_packages
     *
     * @return int|null
     */
    public function getApprovedNumberOfPackages()
    {
        return $this->container['approved_number_of_packages'];
    }

    /**
     * Sets approved_number_of_packages
     *
     * @param int|null $approved_number_of_packages approved_number_of_packages
     *
     * @return self
     */
    public function setApprovedNumberOfPackages($approved_number_of_packages)
    {
        if (is_null($approved_number_of_packages)) {
            array_push($this->openAPINullablesSetToNull, 'approved_number_of_packages');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('approved_number_of_packages', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['approved_number_of_packages'] = $approved_number_of_packages;
     ...
     * Gets parcel_type
     *
     * @return \OngoingAPI\Model\GetWayBillRowModelParcelType|null
     */
     ...
     * Sets parcel_type
     *
     * @param \OngoingAPI\Model\GetWayBillRowModelParcelType|null $parcel_type parcel_type
     *
     * @return self
     */
    public function setParcelType($parcel_type)
    {
        if (is_null($parcel_type)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
