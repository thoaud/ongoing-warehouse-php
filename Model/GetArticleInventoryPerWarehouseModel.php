...
/**
 * GetArticleInventoryPerWarehouseModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleInventoryPerWarehouseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleInventoryPerWarehouseModel';
    ...
    protected static $openAPITypes = [
        ...
        'inventory_per_warehouse' => '\OngoingAPI\Model\GetArticleInventoryPerWarehouseInfo[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'inventory_per_warehouse' => 'inventoryPerWarehouse'
    ];
    ...
    protected static $setters = [
        ...
        'inventory_per_warehouse' => 'setInventoryPerWarehouse'
    ];
    ...
    protected static $getters = [
        ...
        'inventory_per_warehouse' => 'getInventoryPerWarehouse'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inventory_per_warehouse', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets inventory_per_warehouse
     *
     * @return \OngoingAPI\Model\GetArticleInventoryPerWarehouseInfo[]|null
     */
    public function getInventoryPerWarehouse()
    {
        return $this->container['inventory_per_warehouse'];
    }

    /**
     * Sets inventory_per_warehouse
     *
     * @param \OngoingAPI\Model\GetArticleInventoryPerWarehouseInfo[]|null $inventory_per_warehouse inventory_per_warehouse
     *
     * @return self
     */
    public function setInventoryPerWarehouse($inventory_per_warehouse)
    {
        if (is_null($inventory_per_warehouse)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_per_warehouse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_per_warehouse', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['inventory_per_warehouse'] = $inventory_per_warehouse;
