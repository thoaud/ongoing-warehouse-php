<?php
/**
 * PostFilePrintingInfoPrintAsWorkstation
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostFilePrintingInfoPrintAsWorkstation Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostFilePrintingInfoPrintAsWorkstation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFilePrintingInfo_printAsWorkstation';
    ...
    */
     ...
     * Sets workstation_id
     *
     * @param int|null $workstation_id workstation_id
     *
     * @return self
     */
