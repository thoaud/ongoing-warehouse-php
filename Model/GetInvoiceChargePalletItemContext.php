<?php
/**
 * GetInvoiceChargePalletItemContext
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetInvoiceChargePalletItemContext Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceChargePalletItemContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceCharge_palletItemContext';
    ...
    */
     ...
     * Sets parcel_id
     *
     * @param int|null $parcel_id parcel_id
     *
     * @return self
     */
