...
/**
 * GetOrderPickabilityModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickabilityModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickabilityModel';
    ...
    protected static $openAPITypes = [
        'pickability_results' => '\OngoingAPI\Model\GetOrderPickabilityResult[]'
    ];
    ...
    protected static $attributeMap = [
        'pickability_results' => 'pickabilityResults'
    ];
    ...
    protected static $setters = [
        'pickability_results' => 'setPickabilityResults'
    ];
    ...
    protected static $getters = [
        'pickability_results' => 'getPickabilityResults'
    ];
    ...
    {
        $this->setIfExists('pickability_results', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets pickability_results
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityResult[]|null
     */
    public function getPickabilityResults()
    {
        return $this->container['pickability_results'];
    }

    /**
     * Sets pickability_results
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityResult[]|null $pickability_results pickability_results
     *
     * @return self
     */
    public function setPickabilityResults($pickability_results)
    {
        if (is_null($pickability_results)) {
            array_push($this->openAPINullablesSetToNull, 'pickability_results');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickability_results', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pickability_results'] = $pickability_results;
