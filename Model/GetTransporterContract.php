...
/**
 * GetTransporterContract Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetTransporterContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTransporterContract';
    ...
    protected static $openAPITypes = [
        ...
        'transporter_service_code' => 'string',
        'transporter_services' => '\OngoingAPI\Model\GetTransporterService[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'transporter_service_code' => null,
        'transporter_services' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'transporter_code' => true,
        'transporter_service_code' => true,
        'transporter_services' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'transporter_service_code' => 'transporterServiceCode',
    ...
    protected static $setters = [
        ...
        'transporter_service_code' => 'setTransporterServiceCode',
        'transporter_services' => 'setTransporterServices'
    ];
    ...
    protected static $getters = [
        ...
        'transporter_service_code' => 'getTransporterServiceCode',
        'transporter_services' => 'getTransporterServices'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transporter_name', $data ?? [], null);
        $this->setIfExists('transporter_code', $data ?? [], null);
        $this->setIfExists('transporter_service_code', $data ?? [], null);
        $this->setIfExists('transporter_services', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets edi_code
     *
     * @param string|null $edi_code edi_code
     *
     * @return self
     */
    ...
    {
        if (is_null($edi_code)) {
            array_push($this->openAPINullablesSetToNull, 'edi_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('edi_code', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $transporter_name transporter_name
     *
     * @return self
     */
    public function setTransporterName($transporter_name)
    {
        if (is_null($transporter_name)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($transporter_code)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets transporter_service_code
     *
     * @return string|null
     */
    public function getTransporterServiceCode()
    {
        return $this->container['transporter_service_code'];
    }

    /**
     * Sets transporter_service_code
     *
     * @param string|null $transporter_service_code transporter_service_code
     *
     * @return self
     */
    public function setTransporterServiceCode($transporter_service_code)
    {
        if (is_null($transporter_service_code)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_service_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_service_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transporter_service_code'] = $transporter_service_code;

        return $this;
    }

    /**
     * Gets transporter_services
     *
     * @return \OngoingAPI\Model\GetTransporterService[]|null
     */
    public function getTransporterServices()
    {
        return $this->container['transporter_services'];
    }

    /**
     * Sets transporter_services
     *
     * @param \OngoingAPI\Model\GetTransporterService[]|null $transporter_services transporter_services
     *
     * @return self
     */
    public function setTransporterServices($transporter_services)
    {
        if (is_null($transporter_services)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_services');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_services', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transporter_services'] = $transporter_services;
