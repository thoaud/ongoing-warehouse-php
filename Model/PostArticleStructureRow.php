...
/**
 * PostArticleStructureRow Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleStructureRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleStructureRow';
    ...
    */
    ...
    public function setArticleNumber($article_number)
    {
        ...
        if ((mb_strlen($article_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $article_number when calling PostArticleStructureRow., must be bigger than or equal to 1.');
        }
