<?php
/**
 * GetProductionOrderInfoProductionOrderStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetProductionOrderInfoProductionOrderStatus Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderInfoProductionOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderInfo_productionOrderStatus';
