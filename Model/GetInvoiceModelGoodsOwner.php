...
/**
 * GetInvoiceModelGoodsOwner Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceModelGoodsOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceModel_goodsOwner';
    ...
    protected static $openAPITypes = [
        ...
        'goods_owner_invoice_currency_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'name' => null,
        'financial_code' => null,
        'goods_location_code' => null,
        'goods_owner_reference' => null,
        'goods_owner_invoice_currency_code' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'name' => true,
        'financial_code' => true,
        'goods_location_code' => true,
        'goods_owner_reference' => true,
        'goods_owner_invoice_currency_code' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'goods_location_code' => 'goodsLocationCode',
        'goods_owner_reference' => 'goodsOwnerReference',
        'goods_owner_invoice_currency_code' => 'goodsOwnerInvoiceCurrencyCode'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'name' => 'setName',
        'financial_code' => 'setFinancialCode',
        'goods_location_code' => 'setGoodsLocationCode',
        'goods_owner_reference' => 'setGoodsOwnerReference',
        'goods_owner_invoice_currency_code' => 'setGoodsOwnerInvoiceCurrencyCode'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'name' => 'getName',
        'financial_code' => 'getFinancialCode',
        'goods_location_code' => 'getGoodsLocationCode',
        'goods_owner_reference' => 'getGoodsOwnerReference',
        'goods_owner_invoice_currency_code' => 'getGoodsOwnerInvoiceCurrencyCode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('financial_code', $data ?? [], null);
        $this->setIfExists('goods_location_code', $data ?? [], null);
        $this->setIfExists('goods_owner_reference', $data ?? [], null);
        $this->setIfExists('goods_owner_invoice_currency_code', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['financial_code'];
    }

    /**
     * Sets financial_code
     *
     * @param string|null $financial_code financial_code
     *
     * @return self
     */
    public function setFinancialCode($financial_code)
    {
        if (is_null($financial_code)) {
            array_push($this->openAPINullablesSetToNull, 'financial_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('financial_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['financial_code'] = $financial_code;

        return $this;
    }

    /**
     * Gets goods_location_code
     *
     * @return string|null
     */
    public function getGoodsLocationCode()
    {
        return $this->container['goods_location_code'];
    }

    /**
     * Sets goods_location_code
     *
     * @param string|null $goods_location_code goods_location_code
     *
     * @return self
     */
    public function setGoodsLocationCode($goods_location_code)
    {
        if (is_null($goods_location_code)) {
            array_push($this->openAPINullablesSetToNull, 'goods_location_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('goods_location_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['goods_location_code'] = $goods_location_code;
    ...
    /**
     * Gets goods_owner_invoice_currency_code
     *
     * @return string|null
     */
    public function getGoodsOwnerInvoiceCurrencyCode()
    {
        return $this->container['goods_owner_invoice_currency_code'];
    }

    /**
     * Sets goods_owner_invoice_currency_code
     *
     * @param string|null $goods_owner_invoice_currency_code goods_owner_invoice_currency_code
     *
     * @return self
     */
    public function setGoodsOwnerInvoiceCurrencyCode($goods_owner_invoice_currency_code)
    {
        if (is_null($goods_owner_invoice_currency_code)) {
            array_push($this->openAPINullablesSetToNull, 'goods_owner_invoice_currency_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('goods_owner_invoice_currency_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['goods_owner_invoice_currency_code'] = $goods_owner_invoice_currency_code;
