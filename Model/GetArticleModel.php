...
/**
 * GetArticleModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel';
    ...
    protected static $openAPITypes = [
        'goods_owner' => '\OngoingAPI\Model\GetArticleModelGoodsOwner',
        ...
        'is_active' => 'bool',
        'supplier_info' => '\OngoingAPI\Model\GetArticleModelSupplierInfo',
        'bar_code_info' => '\OngoingAPI\Model\GetArticleModelBarCodeInfo',
        ...
        'inventory_info' => '\OngoingAPI\Model\GetArticleModelInventoryInfo',
        'article_data_last_updated' => '\DateTime',
        'article_kind' => 'string',
        'stock_limit' => 'int',
        'minimum_reorder_quantity' => 'float',
        'net_weight' => 'float',
        'free_values' => '\OngoingAPI\Model\GetArticleModelFreeValues',
        'sub_quantity_per_item' => 'float',
        'classes' => '\OngoingAPI\Model\GetArticleClass[]',
        'customs_description' => 'string',
        'taric_numbers_info' => '\OngoingAPI\Model\GetArticleModelTaricNumbersInfo',
        'default_location_max_number_of_items' => 'float',
        'default_location_stock_limit' => 'float',
        'link_to_picture' => 'string',
        'storage_properties' => '\OngoingAPI\Model\GetArticleModelStorageProperties',
        'default_location' => '\OngoingAPI\Model\GetArticleModelDefaultLocation',
        ...
        'article_name_translations' => '\OngoingAPI\Model\GetArticleNameTranslation[]',
        'article_handling_comments' => '\OngoingAPI\Model\GetArticleModelArticleHandlingComments',
        'storage_class' => '\OngoingAPI\Model\GetArticleModelStorageClass'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'inventory_info' => null,
        'article_data_last_updated' => 'date-time',
        'article_kind' => null,
        'stock_limit' => 'int32',
        ...
        'default_location_max_number_of_items' => 'decimal',
        'default_location_stock_limit' => 'decimal',
        ...
        'article_handling_comments' => null,
        'storage_class' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'inventory_info' => true,
        'article_data_last_updated' => true,
        'article_kind' => true,
        'stock_limit' => true,
        ...
        'default_location_max_number_of_items' => true,
        'default_location_stock_limit' => true,
        ...
        'article_handling_comments' => true,
        'storage_class' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'article_system_id' => 'articleSystemId',
        ...
        'article_data_last_updated' => 'articleDataLastUpdated',
        ...
        'default_location_max_number_of_items' => 'defaultLocationMaxNumberOfItems',
        'default_location_stock_limit' => 'defaultLocationStockLimit',
        ...
        'article_handling_comments' => 'articleHandlingComments',
    ...
    protected static $setters = [
        ...
        'article_system_id' => 'setArticleSystemId',
        ...
        'article_data_last_updated' => 'setArticleDataLastUpdated',
        'article_kind' => 'setArticleKind',
        ...
        'default_location_max_number_of_items' => 'setDefaultLocationMaxNumberOfItems',
        'default_location_stock_limit' => 'setDefaultLocationStockLimit',
        ...
        'article_handling_comments' => 'setArticleHandlingComments',
    ...
    protected static $getters = [
        ...
        'article_system_id' => 'getArticleSystemId',
        ...
        'article_data_last_updated' => 'getArticleDataLastUpdated',
        'article_kind' => 'getArticleKind',
        ...
        'default_location_max_number_of_items' => 'getDefaultLocationMaxNumberOfItems',
        'default_location_stock_limit' => 'getDefaultLocationStockLimit',
        ...
        'article_handling_comments' => 'getArticleHandlingComments',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('article_system_id', $data ?? [], null);
        ...
        $this->setIfExists('inventory_info', $data ?? [], null);
        $this->setIfExists('article_data_last_updated', $data ?? [], null);
        $this->setIfExists('article_kind', $data ?? [], null);
        ...
        $this->setIfExists('default_location_max_number_of_items', $data ?? [], null);
        $this->setIfExists('default_location_stock_limit', $data ?? [], null);
        ...
        $this->setIfExists('article_handling_comments', $data ?? [], null);
    ...
    */
     ...
     * Gets goods_owner
     *
     * @return \OngoingAPI\Model\GetArticleModelGoodsOwner|null
     */
     ...
     * Sets goods_owner
     *
     * @param \OngoingAPI\Model\GetArticleModelGoodsOwner|null $goods_owner goods_owner
     *
     * @return self
     */
    public function setGoodsOwner($goods_owner)
    {
    ...
    {
        return $this->container['article_system_id'];
    }

    /**
     * Sets article_system_id
     *
     * @param int|null $article_system_id article_system_id
     *
     * @return self
     */
    public function setArticleSystemId($article_system_id)
    {
        if (is_null($article_system_id)) {
            throw new \InvalidArgumentException('non-nullable article_system_id cannot be null');
        }
        $this->container['article_system_id'] = $article_system_id;
     ...
     * Gets supplier_info
     *
     * @return \OngoingAPI\Model\GetArticleModelSupplierInfo|null
     */
     ...
     * Sets supplier_info
     *
     * @param \OngoingAPI\Model\GetArticleModelSupplierInfo|null $supplier_info supplier_info
     *
     * @return self
     */
     ...
     * Gets bar_code_info
     *
     * @return \OngoingAPI\Model\GetArticleModelBarCodeInfo|null
     */
     ...
     * Sets bar_code_info
     *
     * @param \OngoingAPI\Model\GetArticleModelBarCodeInfo|null $bar_code_info bar_code_info
     *
     * @return self
     */
     ...
     * Gets inventory_info
     *
     * @return \OngoingAPI\Model\GetArticleModelInventoryInfo|null
     */
     ...
     * Sets inventory_info
     *
     * @param \OngoingAPI\Model\GetArticleModelInventoryInfo|null $inventory_info inventory_info
     *
     * @return self
     */
    public function setInventoryInfo($inventory_info)
    {
        if (is_null($inventory_info)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets article_data_last_updated
     *
     * @return \DateTime|null
     */
    public function getArticleDataLastUpdated()
    {
        return $this->container['article_data_last_updated'];
    }
    ...
    /**
     * Sets article_data_last_updated
     *
     * @param \DateTime|null $article_data_last_updated article_data_last_updated
     *
     * @return self
     */


    public function setArticleDataLastUpdated($article_data_last_updated)
    {
        if (is_null($article_data_last_updated)) {
            array_push($this->openAPINullablesSetToNull, 'article_data_last_updated');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_data_last_updated', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_data_last_updated'] = $article_data_last_updated;
     ...
     * @return string|null
     */
    public function getArticleKind()
    {
        return $this->container['article_kind'];
    }

    /**
     * Sets article_kind
     *
     * @param string|null $article_kind article_kind
     *
     * @return self
     */
    public function setArticleKind($article_kind)
    {
        if (is_null($article_kind)) {
            array_push($this->openAPINullablesSetToNull, 'article_kind');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_kind', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_kind'] = $article_kind;
     ...
     * Gets free_values
     *
     * @return \OngoingAPI\Model\GetArticleModelFreeValues|null
     */
     ...
     * Sets free_values
     *
     * @param \OngoingAPI\Model\GetArticleModelFreeValues|null $free_values free_values
     *
     * @return self
     */
     ...
     * Gets classes
     *
     * @return \OngoingAPI\Model\GetArticleClass[]|null
     */
     ...
     * Sets classes
     *
     * @param \OngoingAPI\Model\GetArticleClass[]|null $classes classes
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetArticleModelTaricNumbersInfo|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetArticleModelTaricNumbersInfo|null $taric_numbers_info taric_numbers_info
     *
     * @return self
     */
    ...
    /**
     * Gets default_location_max_number_of_items
     *
     * @return float|null
     */
    public function getDefaultLocationMaxNumberOfItems()
    {
        return $this->container['default_location_max_number_of_items'];
    }

    /**
     * Sets default_location_max_number_of_items
     *
     * @param float|null $default_location_max_number_of_items default_location_max_number_of_items
     *
     * @return self
     */
    public function setDefaultLocationMaxNumberOfItems($default_location_max_number_of_items)
    {
        if (is_null($default_location_max_number_of_items)) {
            array_push($this->openAPINullablesSetToNull, 'default_location_max_number_of_items');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_location_max_number_of_items', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['default_location_max_number_of_items'] = $default_location_max_number_of_items;

        return $this;
    }

    /**
     * Gets default_location_stock_limit
     *
     * @return float|null
     */
    public function getDefaultLocationStockLimit()
    {
        return $this->container['default_location_stock_limit'];
    }

    /**
     * Sets default_location_stock_limit
     *
     * @param float|null $default_location_stock_limit default_location_stock_limit
     *
     * @return self
     */
    public function setDefaultLocationStockLimit($default_location_stock_limit)
    {
        if (is_null($default_location_stock_limit)) {
            array_push($this->openAPINullablesSetToNull, 'default_location_stock_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_location_stock_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['default_location_stock_limit'] = $default_location_stock_limit;
     ...
     *
     * @return \OngoingAPI\Model\GetArticleModelStorageProperties|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetArticleModelStorageProperties|null $storage_properties storage_properties
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetArticleModelDefaultLocation|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetArticleModelDefaultLocation|null $default_location default_location
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetArticleNameTranslation[]|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetArticleNameTranslation[]|null $article_name_translations article_name_translations
     *
     * @return self
     */
    ...
    /**
     * Gets article_handling_comments
     *
     * @return \OngoingAPI\Model\GetArticleModelArticleHandlingComments|null
     */
    public function getArticleHandlingComments()
    {
        return $this->container['article_handling_comments'];
    }

    /**
     * Sets article_handling_comments
     *
     * @param \OngoingAPI\Model\GetArticleModelArticleHandlingComments|null $article_handling_comments article_handling_comments
     *
     * @return self
     */
    public function setArticleHandlingComments($article_handling_comments)
    {
        if (is_null($article_handling_comments)) {
            array_push($this->openAPINullablesSetToNull, 'article_handling_comments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_handling_comments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_handling_comments'] = $article_handling_comments;
     ...
     * Gets storage_class
     *
     * @return \OngoingAPI\Model\GetArticleModelStorageClass|null
     */
     ...
     * Sets storage_class
     *
     * @param \OngoingAPI\Model\GetArticleModelStorageClass|null $storage_class storage_class
     *
     * @return self
     */
