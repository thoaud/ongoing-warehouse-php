<?php
/**
 * GetArticleDangerousGoodsInfoModelUnNumber
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetArticleDangerousGoodsInfoModelUnNumber Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleDangerousGoodsInfoModelUnNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleDangerousGoodsInfoModel_unNumber';
    ...
    protected static $openAPITypes = [
        'un_number' => 'string',
        'un_tunnel_codes' => '\OngoingAPI\Model\GetArticleTunnelCodesModel[]',
        'un_class_number' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'un_number' => null,
        'un_tunnel_codes' => null,
        'un_class_number' => null
    ];
    ...
    protected static array $openAPINullables = [
        'un_number' => true,
        'un_tunnel_codes' => true,
        'un_class_number' => true
    ];
    ...
    protected static $attributeMap = [
        'un_number' => 'unNumber',
        'un_tunnel_codes' => 'unTunnelCodes',
        'un_class_number' => 'unClassNumber'
    ];
    ...
    protected static $setters = [
        ...
        'un_tunnel_codes' => 'setUnTunnelCodes',
        'un_class_number' => 'setUnClassNumber'
    ];
    ...
    protected static $getters = [
        ...
        'un_tunnel_codes' => 'getUnTunnelCodes',
        'un_class_number' => 'getUnClassNumber'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('un_tunnel_codes', $data ?? [], null);
        $this->setIfExists('un_class_number', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets un_tunnel_codes
     *
     * @return \OngoingAPI\Model\GetArticleTunnelCodesModel[]|null
     */
    public function getUnTunnelCodes()
    {
        return $this->container['un_tunnel_codes'];
    }

    /**
     * Sets un_tunnel_codes
     *
     * @param \OngoingAPI\Model\GetArticleTunnelCodesModel[]|null $un_tunnel_codes un_tunnel_codes
     *
     * @return self
     */
    public function setUnTunnelCodes($un_tunnel_codes)
    {
        if (is_null($un_tunnel_codes)) {
            array_push($this->openAPINullablesSetToNull, 'un_tunnel_codes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('un_tunnel_codes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['un_tunnel_codes'] = $un_tunnel_codes;

        return $this;
    }

    /**
     * Gets un_class_number
     *
     * @return string|null
     */
    public function getUnClassNumber()
    {
        return $this->container['un_class_number'];
    }

    /**
     * Sets un_class_number
     *
     * @param string|null $un_class_number un_class_number
     *
     * @return self
     */
    public function setUnClassNumber($un_class_number)
    {
        if (is_null($un_class_number)) {
            array_push($this->openAPINullablesSetToNull, 'un_class_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('un_class_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['un_class_number'] = $un_class_number;
