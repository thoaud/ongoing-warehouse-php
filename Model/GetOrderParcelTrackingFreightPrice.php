<?php
/**
 * GetOrderParcelTrackingFreightPrice
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderParcelTrackingFreightPrice Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderParcelTrackingFreightPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderParcelTracking_freightPrice';
    ...
    protected static $openAPITypes = [
        'price' => 'float',
        'currency' => '\OngoingAPI\Model\GetArticleItemInfoStatus'
    ];
    ...
    */
     ...
     * Sets currency
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $currency currency
     *
     * @return self
     */
