...
/**
 * GetArticleItemInfoLockCauses Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleItemInfoLockCauses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleItemInfo_lockCauses';
    ...
    protected static $openAPITypes = [
        ...
        'by_location' => 'bool',
        'by_status' => 'bool',
        'by_warehouse_transfer_order' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'by_location' => null,
        'by_status' => null,
        'by_warehouse_transfer_order' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'by_location' => false,
        'by_status' => false,
        'by_warehouse_transfer_order' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'by_item_lock' => 'byItemLock',
        'by_location' => 'byLocation',
        'by_status' => 'byStatus',
        'by_warehouse_transfer_order' => 'byWarehouseTransferOrder'
    ];
    ...
    protected static $setters = [
        'by_allocation' => 'setByAllocation',
        'by_inventory' => 'setByInventory',
        'by_item_lock' => 'setByItemLock',
        'by_location' => 'setByLocation',
        'by_status' => 'setByStatus',
        'by_warehouse_transfer_order' => 'setByWarehouseTransferOrder'
    ];
    ...
    protected static $getters = [
        'by_allocation' => 'getByAllocation',
        'by_inventory' => 'getByInventory',
        'by_item_lock' => 'getByItemLock',
        'by_location' => 'getByLocation',
        'by_status' => 'getByStatus',
        'by_warehouse_transfer_order' => 'getByWarehouseTransferOrder'
    ];
    ...
    {
        $this->setIfExists('by_allocation', $data ?? [], null);
        $this->setIfExists('by_inventory', $data ?? [], null);
        $this->setIfExists('by_item_lock', $data ?? [], null);
        $this->setIfExists('by_location', $data ?? [], null);
        $this->setIfExists('by_status', $data ?? [], null);
        $this->setIfExists('by_warehouse_transfer_order', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getByAllocation()
    {
        return $this->container['by_allocation'];
    }

    /**
     * Sets by_allocation
     *
     * @param bool|null $by_allocation by_allocation
     *
     * @return self
     */
    public function setByAllocation($by_allocation)
    {
        if (is_null($by_allocation)) {
            throw new \InvalidArgumentException('non-nullable by_allocation cannot be null');
        }
        $this->container['by_allocation'] = $by_allocation;
     ...
     * @return bool|null
     */
    public function getByInventory()
    {
        return $this->container['by_inventory'];
    }

    /**
     * Sets by_inventory
     *
     * @param bool|null $by_inventory by_inventory
     *
     * @return self
     */
    public function setByInventory($by_inventory)
    {
        if (is_null($by_inventory)) {
            throw new \InvalidArgumentException('non-nullable by_inventory cannot be null');
        }
        $this->container['by_inventory'] = $by_inventory;
     ...
     * @return bool|null
     */
    public function getByItemLock()
    {
        return $this->container['by_item_lock'];
    }

    /**
     * Sets by_item_lock
     *
     * @param bool|null $by_item_lock by_item_lock
     *
     * @return self
     */
    public function setByItemLock($by_item_lock)
    {
        if (is_null($by_item_lock)) {
            throw new \InvalidArgumentException('non-nullable by_item_lock cannot be null');
        }
        $this->container['by_item_lock'] = $by_item_lock;
    ...
    {
        return $this->container['by_location'];
    }

    /**
     * Sets by_location
     *
     * @param bool|null $by_location by_location
     *
     * @return self
     */
    public function setByLocation($by_location)
    {
        if (is_null($by_location)) {
            throw new \InvalidArgumentException('non-nullable by_location cannot be null');
        }
        $this->container['by_location'] = $by_location;
     ...
     * Sets by_status
     *
     * @param bool|null $by_status by_status
     *
     * @return self
     */
    ...
    /**
     * Gets by_warehouse_transfer_order
     *
     * @return bool|null
     */
    public function getByWarehouseTransferOrder()
    {
        return $this->container['by_warehouse_transfer_order'];
    }

    /**
     * Sets by_warehouse_transfer_order
     *
     * @param bool|null $by_warehouse_transfer_order by_warehouse_transfer_order
     *
     * @return self
     */
    public function setByWarehouseTransferOrder($by_warehouse_transfer_order)
    {
        if (is_null($by_warehouse_transfer_order)) {
            throw new \InvalidArgumentException('non-nullable by_warehouse_transfer_order cannot be null');
        }
        $this->container['by_warehouse_transfer_order'] = $by_warehouse_transfer_order;
