<?php
/**
 * GetInvoiceChargeArticleItemContext
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetInvoiceChargeArticleItemContext Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceChargeArticleItemContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceCharge_articleItemContext';
    ...
    protected static $setters = [
        ...
        'scanned_serial' => 'setScannedSerial'
    ];
    ...
    protected static $getters = [
        ...
        'scanned_serial' => 'getScannedSerial'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('scanned_serial', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getScannedSerial()
    {
        return $this->container['scanned_serial'];
    }

    /**
     * Sets scanned_serial
     *
     * @param string|null $scanned_serial scanned_serial
     *
     * @return self
     */
    public function setScannedSerial($scanned_serial)
    {
        if (is_null($scanned_serial)) {
            array_push($this->openAPINullablesSetToNull, 'scanned_serial');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('scanned_serial', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['scanned_serial'] = $scanned_serial;
