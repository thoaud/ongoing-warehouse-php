...
/**
 * PostOrderModelCustomsInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderModelCustomsInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderModel_customsInfo';
    ...
    protected static array $openAPINullables = [
        'customs_value_currency_code' => true
    ];
    ...
    */
     ...
     *
     * @param string|null $customs_value_currency_code customs_value_currency_code
     *
     * @return self
     */
    public function setCustomsValueCurrencyCode($customs_value_currency_code)
    {
        if (is_null($customs_value_currency_code)) {
            array_push($this->openAPINullablesSetToNull, 'customs_value_currency_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customs_value_currency_code', $nullablesSetToNull);
            if ($index !== FALSE) {
