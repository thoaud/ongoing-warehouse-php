...
/**
 * PostProductionOrderResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostProductionOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostProductionOrderResponse';
    ...
    */
    ...
    public function setProductionOrderId($production_order_id)
    {
        if (is_null($production_order_id)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_id', $nullablesSetToNull);
            if ($index !== FALSE) {
