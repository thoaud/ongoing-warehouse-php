...
/**
 * PostParcelTrackingModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostParcelTrackingModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostParcelTrackingModel';
    ...
    protected static $attributeMap = [
        ...
        'is_return_tracking' => 'isReturnTracking'
    ];
    ...
    protected static $setters = [
        ...
        'is_return_tracking' => 'setIsReturnTracking'
    ];
    ...
    protected static $getters = [
        ...
        'is_return_tracking' => 'getIsReturnTracking'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_return_tracking', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['waybill']) < 1)) {
            $invalidProperties[] = "invalid value for 'waybill', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['tracking_url'] === null) {
            $invalidProperties[] = "'tracking_url' can't be null";
        }
        if ((mb_strlen($this->container['tracking_url']) < 1)) {
            $invalidProperties[] = "invalid value for 'tracking_url', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['is_return_tracking'] === null) {
            $invalidProperties[] = "'is_return_tracking' can't be null";
        }
    ...
    public function setWaybill($waybill)
    {
        ...
        if ((mb_strlen($waybill) < 1)) {
            throw new \InvalidArgumentException('invalid length for $waybill when calling PostParcelTrackingModel., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingUrl($tracking_url)
    {
        ...
        if ((mb_strlen($tracking_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling PostParcelTrackingModel., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets is_return_tracking
     *
     * @return bool
     */
    public function getIsReturnTracking()
    {
        return $this->container['is_return_tracking'];
    }

    /**
     * Sets is_return_tracking
     *
     * @param bool $is_return_tracking is_return_tracking
     *
     * @return self
     */
    public function setIsReturnTracking($is_return_tracking)
    {
        if (is_null($is_return_tracking)) {
            throw new \InvalidArgumentException('non-nullable is_return_tracking cannot be null');
        }
        $this->container['is_return_tracking'] = $is_return_tracking;
