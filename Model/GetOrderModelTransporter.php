...
/**
 * GetOrderModelTransporter Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderModelTransporter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderModel_transporter';
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'string',
        'service_code' => 'string',
        'transporter_contract' => '\OngoingAPI\Model\GetOrderTransporterTransporterContract',
    ...
    protected static array $openAPINullables = [
        ...
        'code' => true,
        'service_code' => true,
        'transporter_contract' => true,
        'service_comment' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'transporter_contract' => 'transporterContract',
    ...
    protected static $setters = [
        ...
        'transporter_contract' => 'setTransporterContract',
        'service_comment' => 'setServiceComment'
    ];
    ...
    protected static $getters = [
        ...
        'transporter_contract' => 'getTransporterContract',
        'service_comment' => 'getServiceComment'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transporter_contract', $data ?? [], null);
        $this->setIfExists('service_comment', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets transporter_contract
     *
     * @return \OngoingAPI\Model\GetOrderTransporterTransporterContract|null
     */
    public function getTransporterContract()
    {
        return $this->container['transporter_contract'];
    }

    /**
     * Sets transporter_contract
     *
     * @param \OngoingAPI\Model\GetOrderTransporterTransporterContract|null $transporter_contract transporter_contract
     *
     * @return self
     */
    public function setTransporterContract($transporter_contract)
    {
        if (is_null($transporter_contract)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_contract');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_contract', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transporter_contract'] = $transporter_contract;

        return $this;
    }

    /**
     * Gets service_comment
     *
     * @return string|null
     */
    ...
    /**
     * Sets service_comment
     *
     * @param string|null $service_comment service_comment
     *
     * @return self
     */
    public function setServiceComment($service_comment)
    {
        if (is_null($service_comment)) {
            array_push($this->openAPINullablesSetToNull, 'service_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('service_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['service_comment'] = $service_comment;
