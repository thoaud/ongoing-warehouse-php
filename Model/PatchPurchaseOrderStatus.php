...
/**
 * PatchPurchaseOrderStatus Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderStatus';
    ...
    protected static $openAPIFormats = [
        'purchase_order_status_number' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        'purchase_order_status_number' => false
    ];
    ...
    protected static $attributeMap = [
        'purchase_order_status_number' => 'purchaseOrderStatusNumber'
    ];
    ...
    protected static $setters = [
        'purchase_order_status_number' => 'setPurchaseOrderStatusNumber'
    ];
    ...
    protected static $getters = [
        'purchase_order_status_number' => 'getPurchaseOrderStatusNumber'
    ];
    ...
    {
        $this->setIfExists('purchase_order_status_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['purchase_order_status_number'] === null) {
            $invalidProperties[] = "'purchase_order_status_number' can't be null";
        }
    ...
    /**
     * Gets purchase_order_status_number
     *
     * @return int
     */
    public function getPurchaseOrderStatusNumber()
    {
        return $this->container['purchase_order_status_number'];
    }

    /**
     * Sets purchase_order_status_number
     *
     * @param int $purchase_order_status_number purchase_order_status_number
     *
     * @return self
     */
    public function setPurchaseOrderStatusNumber($purchase_order_status_number)
    {
        if (is_null($purchase_order_status_number)) {
            throw new \InvalidArgumentException('non-nullable purchase_order_status_number cannot be null');
        }
        $this->container['purchase_order_status_number'] = $purchase_order_status_number;
