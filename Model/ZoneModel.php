 ...
 */
class ZoneModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ZoneModel';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'position' => '\OngoingAPI\Model\ZoneModelPosition',
        'aisles' => '\OngoingAPI\Model\AisleModel[]',
        'warehouse_id' => 'int',
    ...
    */
     ...
     * Gets position
     *
     * @return \OngoingAPI\Model\ZoneModelPosition|null
     */
     ...
     * Sets position
     *
     * @param \OngoingAPI\Model\ZoneModelPosition|null $position position
     *
     * @return self
     */
     ...
     * Gets aisles
     *
     * @return \OngoingAPI\Model\AisleModel[]|null
     */
     ...
     * Sets aisles
     *
     * @param \OngoingAPI\Model\AisleModel[]|null $aisles aisles
     *
     * @return self
     */
    ...
    {
        if (is_null($aisles)) {
            array_push($this->openAPINullablesSetToNull, 'aisles');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('aisles', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setWarehouseName($warehouse_name)
    {
        if (is_null($warehouse_name)) {
            array_push($this->openAPINullablesSetToNull, 'warehouse_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('warehouse_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
