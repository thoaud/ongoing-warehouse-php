...
/**
 * PostPurchaseOrderArticleItemsModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemsModel';
    ...
    protected static $openAPITypes = [
        'items' => '\OngoingAPI\Model\PostPurchaseOrderArticleItemModel[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderArticleItemModel[]|null
     */
     ...
     * Sets items
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderArticleItemModel[]|null $items items
     *
     * @return self
     */
