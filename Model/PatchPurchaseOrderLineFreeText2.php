...
/**
 * PatchPurchaseOrderLineFreeText2 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderLineFreeText2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderLineFreeText2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_text2'] === null) {
            $invalidProperties[] = "'free_text2' can't be null";
        }
        if ((mb_strlen($this->container['free_text2']) < 1)) {
            $invalidProperties[] = "invalid value for 'free_text2', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets free_text2
     *
     * @param string $free_text2 free_text2
     *
     * @return self
     */
    public function setFreeText2($free_text2)
    {
        if (is_null($free_text2)) {
            throw new \InvalidArgumentException('non-nullable free_text2 cannot be null');
        }

        if ((mb_strlen($free_text2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $free_text2 when calling PatchPurchaseOrderLineFreeText2., must be bigger than or equal to 1.');
        }
