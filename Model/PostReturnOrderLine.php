...
/**
 * PostReturnOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostReturnOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostReturnOrderLine';
    ...
    protected static $openAPITypes = [
        ...
        'customer_order_line' => '\OngoingAPI\Model\PostReturnOrderLineCustomerOrderLine',
        'to_be_returned_number_of_items' => 'float',
        'return_cause' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'return_order_line_comment' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'return_cause' => null,
        'return_order_line_comment' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'return_order_line_comment' => 'returnOrderLineComment'
    ];
    ...
    protected static $setters = [
        ...
        'return_order_line_comment' => 'setReturnOrderLineComment'
    ];
    ...
    protected static $getters = [
        ...
        'return_order_line_comment' => 'getReturnOrderLineComment'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_order_line_comment', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['return_order_row_number'] === null) {
            $invalidProperties[] = "'return_order_row_number' can't be null";
        }
        if ((mb_strlen($this->container['return_order_row_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'return_order_row_number', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['customer_order_line'] === null) {
            $invalidProperties[] = "'customer_order_line' can't be null";
        }
        if ($this->container['to_be_returned_number_of_items'] === null) {
            $invalidProperties[] = "'to_be_returned_number_of_items' can't be null";
        }
     ...
     *
     * @param string $return_order_row_number return_order_row_number
     *
     * @return self
     */
    public function setReturnOrderRowNumber($return_order_row_number)
    {
        if (is_null($return_order_row_number)) {
            throw new \InvalidArgumentException('non-nullable return_order_row_number cannot be null');
        }

        if ((mb_strlen($return_order_row_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_order_row_number when calling PostReturnOrderLine., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OngoingAPI\Model\PostReturnOrderLineCustomerOrderLine
     */
     ...
     *
     * @param \OngoingAPI\Model\PostReturnOrderLineCustomerOrderLine $customer_order_line customer_order_line
     *
     * @return self
     */
     ...
     *
     * @param float $to_be_returned_number_of_items to_be_returned_number_of_items
     *
     * @return self
     */
    ...
    /**
     * Gets return_order_line_comment
     *
     * @return string|null
     */
    public function getReturnOrderLineComment()
    {
        return $this->container['return_order_line_comment'];
    }

    /**
     * Sets return_order_line_comment
     *
     * @param string|null $return_order_line_comment return_order_line_comment
     *
     * @return self
     */
    public function setReturnOrderLineComment($return_order_line_comment)
    {
        if (is_null($return_order_line_comment)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_line_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_line_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_line_comment'] = $return_order_line_comment;
