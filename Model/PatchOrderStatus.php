...
/**
 * PatchOrderStatus Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderStatus';
    ...
    protected static $setters = [
        'order_status_number' => 'setOrderStatusNumber'
    ];
    ...
    protected static $getters = [
        'order_status_number' => 'getOrderStatusNumber'
    ];
    ...
    {
        $this->setIfExists('order_status_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_status_number'] === null) {
            $invalidProperties[] = "'order_status_number' can't be null";
        }
    ...
    /**
     * Gets order_status_number
     *
     * @return int
     */
    public function getOrderStatusNumber()
    {
        return $this->container['order_status_number'];
    }

    /**
     * Sets order_status_number
     *
     * @param int $order_status_number order_status_number
     *
     * @return self
     */
    public function setOrderStatusNumber($order_status_number)
    {
        if (is_null($order_status_number)) {
            throw new \InvalidArgumentException('non-nullable order_status_number cannot be null');
        }
        $this->container['order_status_number'] = $order_status_number;
