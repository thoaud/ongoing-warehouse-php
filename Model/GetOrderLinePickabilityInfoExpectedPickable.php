<?php
/**
 * GetOrderLinePickabilityInfoExpectedPickable
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderLinePickabilityInfoExpectedPickable Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderLinePickabilityInfoExpectedPickable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderLinePickabilityInfo_expectedPickable';
    ...
    protected static $openAPITypes = [
        'expected_in_date' => '\DateTime',
        'is_pickable_by_advised' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'expected_in_date' => 'date-time',
        'is_pickable_by_advised' => null
    ];
    ...
    protected static array $openAPINullables = [
        'expected_in_date' => true,
        'is_pickable_by_advised' => false
    ];
    ...
    protected static $attributeMap = [
        'expected_in_date' => 'expectedInDate',
        'is_pickable_by_advised' => 'isPickableByAdvised'
    ];
    ...
    protected static $setters = [
        'expected_in_date' => 'setExpectedInDate',
        'is_pickable_by_advised' => 'setIsPickableByAdvised'
    ];
    ...
    protected static $getters = [
        'expected_in_date' => 'getExpectedInDate',
        'is_pickable_by_advised' => 'getIsPickableByAdvised'
    ];
    ...
    {
        $this->setIfExists('expected_in_date', $data ?? [], null);
        $this->setIfExists('is_pickable_by_advised', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets expected_in_date
     *
     * @return \DateTime|null
     */
    public function getExpectedInDate()
    {
        return $this->container['expected_in_date'];
    }

    /**
     * Sets expected_in_date
     *
     * @param \DateTime|null $expected_in_date expected_in_date
     *
     * @return self
     */
    public function setExpectedInDate($expected_in_date)
    {
        if (is_null($expected_in_date)) {
            array_push($this->openAPINullablesSetToNull, 'expected_in_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expected_in_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['expected_in_date'] = $expected_in_date;

        return $this;
    }

    /**
     * Gets is_pickable_by_advised
     *
     * @return bool|null
     */
    public function getIsPickableByAdvised()
    {
        return $this->container['is_pickable_by_advised'];
    }

    /**
     * Sets is_pickable_by_advised
     *
     * @param bool|null $is_pickable_by_advised is_pickable_by_advised
     *
     * @return self
     */
    public function setIsPickableByAdvised($is_pickable_by_advised)
    {
        if (is_null($is_pickable_by_advised)) {
            throw new \InvalidArgumentException('non-nullable is_pickable_by_advised cannot be null');
        }
        $this->container['is_pickable_by_advised'] = $is_pickable_by_advised;
