<?php
/**
 * GetOrderInfoAdvancedBackOrderInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderInfoAdvancedBackOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderInfoAdvancedBackOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderInfoAdvanced_backOrderInfo';
    ...
    protected static $attributeMap = [
        'back_order_for_order_id' => 'backOrderForOrderId'
    ];
    ...
    protected static $setters = [
        'back_order_for_order_id' => 'setBackOrderForOrderId'
    ];
    ...
    protected static $getters = [
        'back_order_for_order_id' => 'getBackOrderForOrderId'
    ];
    ...
    {
        $this->setIfExists('back_order_for_order_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets back_order_for_order_id
     *
     * @return int|null
     */
    public function getBackOrderForOrderId()
    {
        return $this->container['back_order_for_order_id'];
    }

    /**
     * Sets back_order_for_order_id
     *
     * @param int|null $back_order_for_order_id back_order_for_order_id
     *
     * @return self
     */
    public function setBackOrderForOrderId($back_order_for_order_id)
    {
        if (is_null($back_order_for_order_id)) {
            throw new \InvalidArgumentException('non-nullable back_order_for_order_id cannot be null');
        }
        $this->container['back_order_for_order_id'] = $back_order_for_order_id;
