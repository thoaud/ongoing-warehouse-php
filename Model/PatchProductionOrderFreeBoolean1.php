...
/**
 * PatchProductionOrderFreeBoolean1 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchProductionOrderFreeBoolean1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchProductionOrderFreeBoolean1';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_boolean1'] === null) {
            $invalidProperties[] = "'free_boolean1' can't be null";
        }
     ...
     * Sets free_boolean1
     *
     * @param bool $free_boolean1 free_boolean1
     *
     * @return self
     */
