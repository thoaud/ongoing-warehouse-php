...
/**
 * PostProductionOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostProductionOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostProductionOrderLine';
    ...
    protected static $openAPITypes = [
        'production_order_line_number' => 'string',
        'article_number' => 'string',
        'to_produce_number_of_items' => 'float',
        'comment' => 'string',
        'to_produce_batch_number' => 'string',
        'to_produce_serial' => 'string',
        'min_days_to_expiry_date' => 'int',
        'production_order_line_specification' => '\OngoingAPI\Model\PostProductionOrderLineProductionOrderLineSpecification'
    ];
    ...
    protected static $openAPIFormats = [
        'production_order_line_number' => null,
        'article_number' => null,
        'to_produce_number_of_items' => 'decimal',
        'comment' => null,
        'to_produce_batch_number' => null,
        'to_produce_serial' => null,
        'min_days_to_expiry_date' => 'int32',
        'production_order_line_specification' => null
    ];
    ...
    protected static array $openAPINullables = [
        'production_order_line_number' => false,
        'article_number' => false,
        'to_produce_number_of_items' => false,
        'comment' => true,
        'to_produce_batch_number' => true,
        'to_produce_serial' => true,
        'min_days_to_expiry_date' => false,
        'production_order_line_specification' => true
    ];
    ...
    protected static $attributeMap = [
        'production_order_line_number' => 'productionOrderLineNumber',
        'article_number' => 'articleNumber',
        'to_produce_number_of_items' => 'toProduceNumberOfItems',
        'comment' => 'comment',
        'to_produce_batch_number' => 'toProduceBatchNumber',
        'to_produce_serial' => 'toProduceSerial',
        'min_days_to_expiry_date' => 'minDaysToExpiryDate',
        'production_order_line_specification' => 'productionOrderLineSpecification'
    ];
    ...
    protected static $setters = [
        'production_order_line_number' => 'setProductionOrderLineNumber',
        'article_number' => 'setArticleNumber',
        'to_produce_number_of_items' => 'setToProduceNumberOfItems',
        'comment' => 'setComment',
        'to_produce_batch_number' => 'setToProduceBatchNumber',
        'to_produce_serial' => 'setToProduceSerial',
        'min_days_to_expiry_date' => 'setMinDaysToExpiryDate',
        'production_order_line_specification' => 'setProductionOrderLineSpecification'
    ];
    ...
    protected static $getters = [
        'production_order_line_number' => 'getProductionOrderLineNumber',
        'article_number' => 'getArticleNumber',
        'to_produce_number_of_items' => 'getToProduceNumberOfItems',
        'comment' => 'getComment',
        'to_produce_batch_number' => 'getToProduceBatchNumber',
        'to_produce_serial' => 'getToProduceSerial',
        'min_days_to_expiry_date' => 'getMinDaysToExpiryDate',
        'production_order_line_specification' => 'getProductionOrderLineSpecification'
    ];
    ...
    {
        $this->setIfExists('production_order_line_number', $data ?? [], null);
        $this->setIfExists('article_number', $data ?? [], null);
        $this->setIfExists('to_produce_number_of_items', $data ?? [], null);
        $this->setIfExists('comment', $data ?? [], null);
        $this->setIfExists('to_produce_batch_number', $data ?? [], null);
        $this->setIfExists('to_produce_serial', $data ?? [], null);
        $this->setIfExists('min_days_to_expiry_date', $data ?? [], null);
        $this->setIfExists('production_order_line_specification', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['production_order_line_number'] === null) {
            $invalidProperties[] = "'production_order_line_number' can't be null";
        }
        if ((mb_strlen($this->container['production_order_line_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'production_order_line_number', the character length must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['to_produce_number_of_items'] === null) {
            $invalidProperties[] = "'to_produce_number_of_items' can't be null";
        }
    ...
    /**
     * Gets production_order_line_number
     *
     * @return string
     */
    public function getProductionOrderLineNumber()
    {
        return $this->container['production_order_line_number'];
    }

    /**
     * Sets production_order_line_number
     *
     * @param string $production_order_line_number production_order_line_number
     *
     * @return self
     */
    public function setProductionOrderLineNumber($production_order_line_number)
    {
        if (is_null($production_order_line_number)) {
            throw new \InvalidArgumentException('non-nullable production_order_line_number cannot be null');
        }

        if ((mb_strlen($production_order_line_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $production_order_line_number when calling PostProductionOrderLine., must be bigger than or equal to 1.');
        }

        $this->container['production_order_line_number'] = $production_order_line_number;
    ...
    public function setArticleNumber($article_number)
    {
        ...
        if ((mb_strlen($article_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $article_number when calling PostProductionOrderLine., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets to_produce_number_of_items
     *
     * @return float
     */
    public function getToProduceNumberOfItems()
    {
        return $this->container['to_produce_number_of_items'];
    }

    /**
     * Sets to_produce_number_of_items
     *
     * @param float $to_produce_number_of_items to_produce_number_of_items
     *
     * @return self
     */
    public function setToProduceNumberOfItems($to_produce_number_of_items)
    {
        if (is_null($to_produce_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable to_produce_number_of_items cannot be null');
        }
        $this->container['to_produce_number_of_items'] = $to_produce_number_of_items;
    ...
    /**
     * Gets to_produce_batch_number
     *
     * @return string|null
     */
    public function getToProduceBatchNumber()
    {
        return $this->container['to_produce_batch_number'];
    }

    /**
     * Sets to_produce_batch_number
     *
     * @param string|null $to_produce_batch_number to_produce_batch_number
     *
     * @return self
     */
    public function setToProduceBatchNumber($to_produce_batch_number)
    {
        if (is_null($to_produce_batch_number)) {
            array_push($this->openAPINullablesSetToNull, 'to_produce_batch_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_produce_batch_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['to_produce_batch_number'] = $to_produce_batch_number;

        return $this;
    }

    /**
     * Gets to_produce_serial
     *
     * @return string|null
     */
    public function getToProduceSerial()
    {
        return $this->container['to_produce_serial'];
    }

    /**
     * Sets to_produce_serial
     *
     * @param string|null $to_produce_serial to_produce_serial
     *
     * @return self
     */
    public function setToProduceSerial($to_produce_serial)
    {
        if (is_null($to_produce_serial)) {
            array_push($this->openAPINullablesSetToNull, 'to_produce_serial');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_produce_serial', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['to_produce_serial'] = $to_produce_serial;
    ...
    public function setMinDaysToExpiryDate($min_days_to_expiry_date)
    {
        if (is_null($min_days_to_expiry_date)) {
            throw new \InvalidArgumentException('non-nullable min_days_to_expiry_date cannot be null');
        }
    ...
    /**
     * Gets production_order_line_specification
     *
     * @return \OngoingAPI\Model\PostProductionOrderLineProductionOrderLineSpecification|null
     */
    public function getProductionOrderLineSpecification()
    {
        return $this->container['production_order_line_specification'];
    }

    /**
     * Sets production_order_line_specification
     *
     * @param \OngoingAPI\Model\PostProductionOrderLineProductionOrderLineSpecification|null $production_order_line_specification production_order_line_specification
     *
     * @return self
     */
    public function setProductionOrderLineSpecification($production_order_line_specification)
    {
        if (is_null($production_order_line_specification)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_line_specification');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_line_specification', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['production_order_line_specification'] = $production_order_line_specification;
