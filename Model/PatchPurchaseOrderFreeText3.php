...
/**
 * PatchPurchaseOrderFreeText3 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderFreeText3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderFreeText3';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_text3'] === null) {
            $invalidProperties[] = "'free_text3' can't be null";
        }
     ...
     * Sets free_text3
     *
     * @param string $free_text3 free_text3
     *
     * @return self
     */
    public function setFreeText3($free_text3)
    {
        if (is_null($free_text3)) {
            throw new \InvalidArgumentException('non-nullable free_text3 cannot be null');
        }
