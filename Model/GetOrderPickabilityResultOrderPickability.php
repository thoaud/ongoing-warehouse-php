<?php
/**
 * GetOrderPickabilityResultOrderPickability
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderPickabilityResultOrderPickability Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickabilityResultOrderPickability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickabilityResult_orderPickability';
