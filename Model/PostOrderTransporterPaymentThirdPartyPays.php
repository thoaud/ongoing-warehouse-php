<?php
/**
 * PostOrderTransporterPaymentThirdPartyPays
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderTransporterPaymentThirdPartyPays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderTransporterPaymentThirdPartyPays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderTransporterPayment_thirdPartyPays';
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling PostOrderTransporterPaymentThirdPartyPays., must be bigger than or equal to 1.');
        }
