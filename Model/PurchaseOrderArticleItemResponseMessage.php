...
/**
 * PurchaseOrderArticleItemResponseMessage Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderArticleItemResponseMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrderArticleItemResponseMessage';
    ...
    */
    ...
    public function setArticleItemId($article_item_id)
    {
        if (is_null($article_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
