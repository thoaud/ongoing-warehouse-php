...
/**
 * PostArticleDangerousGoodsByArticleNumberModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleDangerousGoodsByArticleNumberModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleDangerousGoodsByArticleNumberModel';
    ...
    protected static $openAPITypes = [
        ...
        'dangerous_goods' => '\OngoingAPI\Model\PostArticleDangerousGoodsModel'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dangerous_goods'] === null) {
            $invalidProperties[] = "'dangerous_goods' can't be null";
        }
    ...
    public function setArticleNumber($article_number)
    {
        ...
        if ((mb_strlen($article_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $article_number when calling PostArticleDangerousGoodsByArticleNumberModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OngoingAPI\Model\PostArticleDangerousGoodsModel
     */
     ...
     *
     * @param \OngoingAPI\Model\PostArticleDangerousGoodsModel $dangerous_goods dangerous_goods
     *
     * @return self
     */
