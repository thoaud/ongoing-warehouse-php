<?php
/**
 * PostPurchaseOrderArticleItemParcelModelParcelType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderArticleItemParcelModelParcelType Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemParcelModelParcelType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemParcelModel_parcelType';
