...
/**
 * PostArticleModelBarCodeInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelBarCodeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_barCodeInfo';
    ...
    protected static $openAPITypes = [
        'bar_code' => 'string',
        'bar_code_package' => 'string',
        'bar_code_pallet' => 'string',
        'alternative_bar_codes' => '\OngoingAPI\Model\PostArticleAlternativeBarCode[]'
    ];
    ...
    protected static $openAPIFormats = [
        'bar_code' => null,
        'bar_code_package' => null,
        'bar_code_pallet' => null,
        'alternative_bar_codes' => null
    ];
    ...
    protected static array $openAPINullables = [
        'bar_code' => true,
        'bar_code_package' => true,
        'bar_code_pallet' => true,
        'alternative_bar_codes' => true
    ];
    ...
    protected static $attributeMap = [
        'bar_code' => 'barCode',
        'bar_code_package' => 'barCodePackage',
        'bar_code_pallet' => 'barCodePallet',
        'alternative_bar_codes' => 'alternativeBarCodes'
    ];
    ...
    protected static $setters = [
        'bar_code' => 'setBarCode',
        'bar_code_package' => 'setBarCodePackage',
        'bar_code_pallet' => 'setBarCodePallet',
        'alternative_bar_codes' => 'setAlternativeBarCodes'
    ];
    ...
    protected static $getters = [
        'bar_code' => 'getBarCode',
        'bar_code_package' => 'getBarCodePackage',
        'bar_code_pallet' => 'getBarCodePallet',
        'alternative_bar_codes' => 'getAlternativeBarCodes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('bar_code_package', $data ?? [], null);
        $this->setIfExists('bar_code_pallet', $data ?? [], null);
        $this->setIfExists('alternative_bar_codes', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($bar_code)) {
            array_push($this->openAPINullablesSetToNull, 'bar_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bar_code', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets bar_code_package
     *
     * @return string|null
     */
    public function getBarCodePackage()
    {
        return $this->container['bar_code_package'];
    }

    /**
     * Sets bar_code_package
     *
     * @param string|null $bar_code_package bar_code_package
     *
     * @return self
     */
    public function setBarCodePackage($bar_code_package)
    {
        if (is_null($bar_code_package)) {
            array_push($this->openAPINullablesSetToNull, 'bar_code_package');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bar_code_package', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['bar_code_package'] = $bar_code_package;

        return $this;
    }

    /**
     * Gets bar_code_pallet
     *
     * @return string|null
     */
    public function getBarCodePallet()
    {
        return $this->container['bar_code_pallet'];
    }

    /**
     * Sets bar_code_pallet
     *
     * @param string|null $bar_code_pallet bar_code_pallet
     *
     * @return self
     */
    public function setBarCodePallet($bar_code_pallet)
    {
        if (is_null($bar_code_pallet)) {
            array_push($this->openAPINullablesSetToNull, 'bar_code_pallet');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bar_code_pallet', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['bar_code_pallet'] = $bar_code_pallet;

        return $this;
    }

    /**
     * Gets alternative_bar_codes
     *
     * @return \OngoingAPI\Model\PostArticleAlternativeBarCode[]|null
     */
    public function getAlternativeBarCodes()
    {
        return $this->container['alternative_bar_codes'];
    }

    /**
     * Sets alternative_bar_codes
     *
     * @param \OngoingAPI\Model\PostArticleAlternativeBarCode[]|null $alternative_bar_codes alternative_bar_codes
     *
     * @return self
     */
    public function setAlternativeBarCodes($alternative_bar_codes)
    {
        if (is_null($alternative_bar_codes)) {
            array_push($this->openAPINullablesSetToNull, 'alternative_bar_codes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('alternative_bar_codes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['alternative_bar_codes'] = $alternative_bar_codes;
