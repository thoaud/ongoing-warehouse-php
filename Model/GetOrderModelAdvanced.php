...
/**
 * GetOrderModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderModel_advanced';
    ...
    protected static $openAPITypes = [
        'order_text_lines' => '\OngoingAPI\Model\GetOrderTextLine[]'
    ];
    ...
    */
     ...
     *
     * @return \OngoingAPI\Model\GetOrderTextLine[]|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetOrderTextLine[]|null $order_text_lines order_text_lines
     *
     * @return self
     */
