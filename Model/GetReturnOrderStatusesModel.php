...
/**
 * GetReturnOrderStatusesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnOrderStatusesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnOrderStatusesModel';
    ...
    protected static $openAPITypes = [
        'return_order_statuses' => '\OngoingAPI\Model\GetReturnOrderStatusModel[]'
    ];
    ...
    protected static $attributeMap = [
        'return_order_statuses' => 'returnOrderStatuses'
    ];
    ...
    protected static $setters = [
        'return_order_statuses' => 'setReturnOrderStatuses'
    ];
    ...
    protected static $getters = [
        'return_order_statuses' => 'getReturnOrderStatuses'
    ];
    ...
    {
        $this->setIfExists('return_order_statuses', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets return_order_statuses
     *
     * @return \OngoingAPI\Model\GetReturnOrderStatusModel[]|null
     */
    public function getReturnOrderStatuses()
    {
        return $this->container['return_order_statuses'];
    }

    /**
     * Sets return_order_statuses
     *
     * @param \OngoingAPI\Model\GetReturnOrderStatusModel[]|null $return_order_statuses return_order_statuses
     *
     * @return self
     */
    public function setReturnOrderStatuses($return_order_statuses)
    {
        if (is_null($return_order_statuses)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_statuses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_statuses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_statuses'] = $return_order_statuses;
