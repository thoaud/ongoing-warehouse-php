...
/**
 * PatchOrderDeliveryDate Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderDeliveryDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderDeliveryDate';
    ...
    */
    ...
    public function setDeliveryDate($delivery_date)
    {
        ...
        if ((mb_strlen($delivery_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date when calling PatchOrderDeliveryDate., must be bigger than or equal to 1.');
        }
