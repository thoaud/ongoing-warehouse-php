...
/**
 * PatchInventoryAdjustmentArticlesReportedItems Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchInventoryAdjustmentArticlesReportedItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchInventoryAdjustmentArticlesReportedItems';
    ...
    protected static $openAPIFormats = [
        'inventory_article_item_id' => 'int32',
    ...
    protected static array $openAPINullables = [
        'inventory_article_item_id' => false,
    ...
    protected static $attributeMap = [
        'inventory_article_item_id' => 'inventoryArticleItemId',
    ...
    protected static $setters = [
        'inventory_article_item_id' => 'setInventoryArticleItemId',
    ...
    protected static $getters = [
        'inventory_article_item_id' => 'getInventoryArticleItemId',
    ...
    {
        $this->setIfExists('inventory_article_item_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets inventory_article_item_id
     *
     * @return int|null
     */
    public function getInventoryArticleItemId()
    {
        return $this->container['inventory_article_item_id'];
    }

    /**
     * Sets inventory_article_item_id
     *
     * @param int|null $inventory_article_item_id inventory_article_item_id
     *
     * @return self
     */
    public function setInventoryArticleItemId($inventory_article_item_id)
    {
        if (is_null($inventory_article_item_id)) {
            throw new \InvalidArgumentException('non-nullable inventory_article_item_id cannot be null');
        }
        $this->container['inventory_article_item_id'] = $inventory_article_item_id;
