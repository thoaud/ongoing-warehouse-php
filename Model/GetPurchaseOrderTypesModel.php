...
/**
 * GetPurchaseOrderTypesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPurchaseOrderTypesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPurchaseOrderTypesModel';
    ...
    protected static $openAPITypes = [
        'purchase_order_types' => '\OngoingAPI\Model\GetPurchaseOrderTypeModel[]'
    ];
    ...
    protected static $setters = [
        'purchase_order_types' => 'setPurchaseOrderTypes'
    ];
    ...
    protected static $getters = [
        'purchase_order_types' => 'getPurchaseOrderTypes'
    ];
    ...
    {
        $this->setIfExists('purchase_order_types', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets purchase_order_types
     *
     * @return \OngoingAPI\Model\GetPurchaseOrderTypeModel[]|null
     */
    public function getPurchaseOrderTypes()
    {
        return $this->container['purchase_order_types'];
    }

    /**
     * Sets purchase_order_types
     *
     * @param \OngoingAPI\Model\GetPurchaseOrderTypeModel[]|null $purchase_order_types purchase_order_types
     *
     * @return self
     */
    public function setPurchaseOrderTypes($purchase_order_types)
    {
        if (is_null($purchase_order_types)) {
            array_push($this->openAPINullablesSetToNull, 'purchase_order_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('purchase_order_types', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['purchase_order_types'] = $purchase_order_types;
