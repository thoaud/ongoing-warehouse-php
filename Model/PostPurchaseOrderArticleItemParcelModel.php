...
/**
 * PostPurchaseOrderArticleItemParcelModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemParcelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemParcelModel';
    ...
    */
    ...
    public function setParcelNumber($parcel_number)
    {
        ...
        if ((mb_strlen($parcel_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcel_number when calling PostPurchaseOrderArticleItemParcelModel., must be bigger than or equal to 1.');
        }
