...
/**
 * PostReturnCauseModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostReturnCauseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostReturnCauseModel';
    ...
    protected static $openAPIFormats = [
        ...
        'code' => null,
        'name' => null,
        'is_remove_cause' => null,
        'is_change_cause' => null,
        'is_return_comment_mandatory' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'code' => false,
        'name' => false,
        'is_remove_cause' => true,
        'is_change_cause' => true,
        'is_return_comment_mandatory' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'code' => 'code',
        'name' => 'name',
        'is_remove_cause' => 'isRemoveCause',
        'is_change_cause' => 'isChangeCause',
        'is_return_comment_mandatory' => 'isReturnCommentMandatory'
    ];
    ...
    protected static $setters = [
        ...
        'code' => 'setCode',
        'name' => 'setName',
        'is_remove_cause' => 'setIsRemoveCause',
        'is_change_cause' => 'setIsChangeCause',
        'is_return_comment_mandatory' => 'setIsReturnCommentMandatory'
    ];
    ...
    protected static $getters = [
        ...
        'code' => 'getCode',
        'name' => 'getName',
        'is_remove_cause' => 'getIsRemoveCause',
        'is_change_cause' => 'getIsChangeCause',
        'is_return_comment_mandatory' => 'getIsReturnCommentMandatory'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_remove_cause', $data ?? [], null);
        $this->setIfExists('is_change_cause', $data ?? [], null);
        $this->setIfExists('is_return_comment_mandatory', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PostReturnCauseModel., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostReturnCauseModel., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets is_remove_cause
     *
     * @return bool|null
     */
    public function getIsRemoveCause()
    {
        return $this->container['is_remove_cause'];
    }

    /**
     * Sets is_remove_cause
     *
     * @param bool|null $is_remove_cause is_remove_cause
     *
     * @return self
     */
    public function setIsRemoveCause($is_remove_cause)
    {
        if (is_null($is_remove_cause)) {
            array_push($this->openAPINullablesSetToNull, 'is_remove_cause');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_remove_cause', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_remove_cause'] = $is_remove_cause;

        return $this;
    }

    /**
     * Gets is_change_cause
     *
     * @return bool|null
     */
    public function getIsChangeCause()
    {
        return $this->container['is_change_cause'];
    }

    /**
     * Sets is_change_cause
     *
     * @param bool|null $is_change_cause is_change_cause
     *
     * @return self
     */
    public function setIsChangeCause($is_change_cause)
    {
        if (is_null($is_change_cause)) {
            array_push($this->openAPINullablesSetToNull, 'is_change_cause');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_change_cause', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_change_cause'] = $is_change_cause;

        return $this;
    }

    /**
     * Gets is_return_comment_mandatory
     *
     * @return bool|null
     */
    public function getIsReturnCommentMandatory()
    {
        return $this->container['is_return_comment_mandatory'];
    }

    /**
     * Sets is_return_comment_mandatory
     *
     * @param bool|null $is_return_comment_mandatory is_return_comment_mandatory
     *
     * @return self
     */
    public function setIsReturnCommentMandatory($is_return_comment_mandatory)
    {
        if (is_null($is_return_comment_mandatory)) {
            array_push($this->openAPINullablesSetToNull, 'is_return_comment_mandatory');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_return_comment_mandatory', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_return_comment_mandatory'] = $is_return_comment_mandatory;
