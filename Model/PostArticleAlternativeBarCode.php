...
/**
 * PostArticleAlternativeBarCode Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleAlternativeBarCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleAlternativeBarCode';
    ...
    protected static $openAPITypes = [
        'bar_code' => 'string',
        'quantity_per_bar_code' => 'float',
        'bar_code_type' => '\OngoingAPI\Model\GetArticleItemInfoStatus'
    ];
    ...
    protected static $attributeMap = [
        'bar_code' => 'barCode',
        'quantity_per_bar_code' => 'quantityPerBarCode',
    ...
    protected static $setters = [
        'bar_code' => 'setBarCode',
        'quantity_per_bar_code' => 'setQuantityPerBarCode',
    ...
    protected static $getters = [
        'bar_code' => 'getBarCode',
        'quantity_per_bar_code' => 'getQuantityPerBarCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('quantity_per_bar_code', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets quantity_per_bar_code
     *
     * @return float|null
     */
    public function getQuantityPerBarCode()
    {
        return $this->container['quantity_per_bar_code'];
    }

    /**
     * Sets quantity_per_bar_code
     *
     * @param float|null $quantity_per_bar_code quantity_per_bar_code
     *
     * @return self
     */
    public function setQuantityPerBarCode($quantity_per_bar_code)
    {
        if (is_null($quantity_per_bar_code)) {
            array_push($this->openAPINullablesSetToNull, 'quantity_per_bar_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('quantity_per_bar_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['quantity_per_bar_code'] = $quantity_per_bar_code;
     ...
     * Sets bar_code_type
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $bar_code_type bar_code_type
     *
     * @return self
     */
    public function setBarCodeType($bar_code_type)
    {
        if (is_null($bar_code_type)) {
            array_push($this->openAPINullablesSetToNull, 'bar_code_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bar_code_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
