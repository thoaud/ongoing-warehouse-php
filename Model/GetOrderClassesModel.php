...
/**
 * GetOrderClassesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderClassesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderClassesModel';
    ...
    protected static $openAPITypes = [
        'order_classes' => '\OngoingAPI\Model\GetOrderClassModel[]'
    ];
    ...
    {
        $this->setIfExists('order_classes', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets order_classes
     *
     * @return \OngoingAPI\Model\GetOrderClassModel[]|null
     */
    public function getOrderClasses()
    {
        return $this->container['order_classes'];
    }

    /**
     * Sets order_classes
     *
     * @param \OngoingAPI\Model\GetOrderClassModel[]|null $order_classes order_classes
     *
     * @return self
     */
    public function setOrderClasses($order_classes)
    {
        if (is_null($order_classes)) {
            array_push($this->openAPINullablesSetToNull, 'order_classes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_classes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['order_classes'] = $order_classes;
