...
/**
 * GetOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderModel';
    ...
    protected static $openAPITypes = [
        'goods_owner' => '\OngoingAPI\Model\GetOrderModelGoodsOwner',
        'order_info' => '\OngoingAPI\Model\GetOrderModelOrderInfo',
        'consignee' => '\OngoingAPI\Model\GetOrderModelConsignee',
        'parcels' => '\OngoingAPI\Model\GetOrderParcel[]',
        'order_lines' => '\OngoingAPI\Model\GetOrderLine[]',
        'transporter' => '\OngoingAPI\Model\GetOrderModelTransporter',
        'return_transporter' => '\OngoingAPI\Model\GetOrderModelTransporter',
        'tracking' => '\OngoingAPI\Model\GetOrderTracking[]',
        'classes' => '\OngoingAPI\Model\GetOrderClass[]',
        'shipment_info' => '\OngoingAPI\Model\GetOrderModelShipmentInfo',
        'return_tracking' => '\OngoingAPI\Model\GetOrderTracking[]',
        'advanced' => '\OngoingAPI\Model\GetOrderModelAdvanced'
    ];
    ...
    */
     ...
     * Gets goods_owner
     *
     * @return \OngoingAPI\Model\GetOrderModelGoodsOwner|null
     */
     ...
     * Sets goods_owner
     *
     * @param \OngoingAPI\Model\GetOrderModelGoodsOwner|null $goods_owner goods_owner
     *
     * @return self
     */
     ...
     * Gets order_info
     *
     * @return \OngoingAPI\Model\GetOrderModelOrderInfo|null
     */
     ...
     * Sets order_info
     *
     * @param \OngoingAPI\Model\GetOrderModelOrderInfo|null $order_info order_info
     *
     * @return self
     */
    public function setOrderInfo($order_info)
    {
        if (is_null($order_info)) {
            array_push($this->openAPINullablesSetToNull, 'order_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets consignee
     *
     * @return \OngoingAPI\Model\GetOrderModelConsignee|null
     */
     ...
     * Sets consignee
     *
     * @param \OngoingAPI\Model\GetOrderModelConsignee|null $consignee consignee
     *
     * @return self
     */
     ...
     * Gets parcels
     *
     * @return \OngoingAPI\Model\GetOrderParcel[]|null
     */
     ...
     * Sets parcels
     *
     * @param \OngoingAPI\Model\GetOrderParcel[]|null $parcels parcels
     *
     * @return self
     */
     ...
     * Sets order_lines
     *
     * @param \OngoingAPI\Model\GetOrderLine[]|null $order_lines order_lines
     *
     * @return self
     */
     ...
     * Gets transporter
     *
     * @return \OngoingAPI\Model\GetOrderModelTransporter|null
     */
     ...
     * Sets transporter
     *
     * @param \OngoingAPI\Model\GetOrderModelTransporter|null $transporter transporter
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\GetOrderModelTransporter|null $return_transporter return_transporter
     *
     * @return self
     */
     ...
     * Gets tracking
     *
     * @return \OngoingAPI\Model\GetOrderTracking[]|null
     */
     ...
     * Sets tracking
     *
     * @param \OngoingAPI\Model\GetOrderTracking[]|null $tracking tracking
     *
     * @return self
     */
     ...
     * Gets classes
     *
     * @return \OngoingAPI\Model\GetOrderClass[]|null
     */
     ...
     * Sets classes
     *
     * @param \OngoingAPI\Model\GetOrderClass[]|null $classes classes
     *
     * @return self
     */
     ...
     * Gets shipment_info
     *
     * @return \OngoingAPI\Model\GetOrderModelShipmentInfo|null
     */
     ...
     * Sets shipment_info
     *
     * @param \OngoingAPI\Model\GetOrderModelShipmentInfo|null $shipment_info shipment_info
     *
     * @return self
     */
    public function setShipmentInfo($shipment_info)
    {
        if (is_null($shipment_info)) {
            array_push($this->openAPINullablesSetToNull, 'shipment_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipment_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \OngoingAPI\Model\GetOrderTracking[]|null $return_tracking return_tracking
     *
     * @return self
     */
    public function setReturnTracking($return_tracking)
    {
        if (is_null($return_tracking)) {
            array_push($this->openAPINullablesSetToNull, 'return_tracking');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_tracking', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\GetOrderModelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\GetOrderModelAdvanced|null $advanced advanced
     *
     * @return self
     */
