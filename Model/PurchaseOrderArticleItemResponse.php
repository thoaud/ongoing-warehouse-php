...
/**
 * PurchaseOrderArticleItemResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PurchaseOrderArticleItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PurchaseOrderArticleItemResponse';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'messages' => '\OngoingAPI\Model\PurchaseOrderArticleItemResponseMessage[]'
    ];
    ...
    */
     ...
     * Gets messages
     *
     * @return \OngoingAPI\Model\PurchaseOrderArticleItemResponseMessage[]|null
     */
     ...
     * Sets messages
     *
     * @param \OngoingAPI\Model\PurchaseOrderArticleItemResponseMessage[]|null $messages messages
     *
     * @return self
     */
