...
/**
 * GetPurchaseOrderStatusesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPurchaseOrderStatusesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPurchaseOrderStatusesModel';
    ...
    protected static $openAPITypes = [
        'order_statuses' => '\OngoingAPI\Model\GetPurchaseOrderStatusModel[]'
    ];
    ...
    {
        $this->setIfExists('order_statuses', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets order_statuses
     *
     * @return \OngoingAPI\Model\GetPurchaseOrderStatusModel[]|null
     */
     ...
     * Sets order_statuses
     *
     * @param \OngoingAPI\Model\GetPurchaseOrderStatusModel[]|null $order_statuses order_statuses
     *
     * @return self
     */
    public function setOrderStatuses($order_statuses)
    {
        if (is_null($order_statuses)) {
            array_push($this->openAPINullablesSetToNull, 'order_statuses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_statuses', $nullablesSetToNull);
            if ($index !== FALSE) {
