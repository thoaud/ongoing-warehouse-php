...
/**
 * PostArticleSupplierInfoAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleSupplierInfoAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleSupplierInfo_advanced';
    ...
    protected static $openAPITypes = [
        'supplier_address' => '\OngoingAPI\Model\PostArticleSupplierInfoAdvancedSupplierAddress',
        'manufacturers_identification_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'manufacturers_identification_code' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'manufacturers_identification_code' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'manufacturers_identification_code' => 'manufacturersIdentificationCode'
    ];
    ...
    protected static $setters = [
        ...
        'manufacturers_identification_code' => 'setManufacturersIdentificationCode'
    ];
    ...
    protected static $getters = [
        ...
        'manufacturers_identification_code' => 'getManufacturersIdentificationCode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('manufacturers_identification_code', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OngoingAPI\Model\PostArticleSupplierInfoAdvancedSupplierAddress|null
     */
     ...
     *
     * @param \OngoingAPI\Model\PostArticleSupplierInfoAdvancedSupplierAddress|null $supplier_address supplier_address
     *
     * @return self
     */
    public function setSupplierAddress($supplier_address)
    {
        if (is_null($supplier_address)) {
            array_push($this->openAPINullablesSetToNull, 'supplier_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('supplier_address', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets manufacturers_identification_code
     *
     * @return string|null
     */
    public function getManufacturersIdentificationCode()
    {
        return $this->container['manufacturers_identification_code'];
    }

    /**
     * Sets manufacturers_identification_code
     *
     * @param string|null $manufacturers_identification_code manufacturers_identification_code
     *
     * @return self
     */
    public function setManufacturersIdentificationCode($manufacturers_identification_code)
    {
        if (is_null($manufacturers_identification_code)) {
            array_push($this->openAPINullablesSetToNull, 'manufacturers_identification_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('manufacturers_identification_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['manufacturers_identification_code'] = $manufacturers_identification_code;
