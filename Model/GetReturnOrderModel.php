...
/**
 * GetReturnOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnOrderModel';
    ...
    protected static $openAPITypes = [
        'return_order_info' => '\OngoingAPI\Model\GetReturnOrderModelReturnOrderInfo',
        'customer_order_info' => '\OngoingAPI\Model\GetReturnOrderModelCustomerOrderInfo',
        'return_order_lines' => '\OngoingAPI\Model\GetReturnOrderLine[]'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'customer_order_info' => true,
        'return_order_lines' => true
    ];
    ...
    protected static $attributeMap = [
        'return_order_info' => 'returnOrderInfo',
    ...
    protected static $setters = [
        'return_order_info' => 'setReturnOrderInfo',
        'customer_order_info' => 'setCustomerOrderInfo',
    ...
    protected static $getters = [
        'return_order_info' => 'getReturnOrderInfo',
        'customer_order_info' => 'getCustomerOrderInfo',
    ...
    {
        $this->setIfExists('return_order_info', $data ?? [], null);
        $this->setIfExists('customer_order_info', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets return_order_info
     *
     * @return \OngoingAPI\Model\GetReturnOrderModelReturnOrderInfo|null
     */
    public function getReturnOrderInfo()
    {
        return $this->container['return_order_info'];
    }

    /**
     * Sets return_order_info
     *
     * @param \OngoingAPI\Model\GetReturnOrderModelReturnOrderInfo|null $return_order_info return_order_info
     *
     * @return self
     */
    public function setReturnOrderInfo($return_order_info)
    {
        if (is_null($return_order_info)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_info'] = $return_order_info;

        return $this;
    }

    /**
     * Gets customer_order_info
     *
     * @return \OngoingAPI\Model\GetReturnOrderModelCustomerOrderInfo|null
     */
    public function getCustomerOrderInfo()
    {
        return $this->container['customer_order_info'];
    }

    /**
     * Sets customer_order_info
     *
     * @param \OngoingAPI\Model\GetReturnOrderModelCustomerOrderInfo|null $customer_order_info customer_order_info
     *
     * @return self
     */
    public function setCustomerOrderInfo($customer_order_info)
    {
        if (is_null($customer_order_info)) {
            array_push($this->openAPINullablesSetToNull, 'customer_order_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_order_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['customer_order_info'] = $customer_order_info;
     ...
     *
     * @return \OngoingAPI\Model\GetReturnOrderLine[]|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetReturnOrderLine[]|null $return_order_lines return_order_lines
     *
     * @return self
     */
    public function setReturnOrderLines($return_order_lines)
    {
        if (is_null($return_order_lines)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
