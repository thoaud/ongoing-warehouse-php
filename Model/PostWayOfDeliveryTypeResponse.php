...
/**
 * PostWayOfDeliveryTypeResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostWayOfDeliveryTypeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostWayOfDeliveryTypeResponse';
    ...
    protected static $attributeMap = [
        'way_of_delivery_type_id' => 'wayOfDeliveryTypeId',
        'success' => 'success',
        'message' => 'message'
    ];
    ...
    protected static $setters = [
        'way_of_delivery_type_id' => 'setWayOfDeliveryTypeId',
        'success' => 'setSuccess',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        'way_of_delivery_type_id' => 'getWayOfDeliveryTypeId',
        'success' => 'getSuccess',
        'message' => 'getMessage'
    ];
    ...
    {
        $this->setIfExists('way_of_delivery_type_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets way_of_delivery_type_id
     *
     * @return int|null
     */
    public function getWayOfDeliveryTypeId()
    {
        return $this->container['way_of_delivery_type_id'];
    }

    /**
     * Sets way_of_delivery_type_id
     *
     * @param int|null $way_of_delivery_type_id way_of_delivery_type_id
     *
     * @return self
     */
    public function setWayOfDeliveryTypeId($way_of_delivery_type_id)
    {
        if (is_null($way_of_delivery_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'way_of_delivery_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('way_of_delivery_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['way_of_delivery_type_id'] = $way_of_delivery_type_id;
