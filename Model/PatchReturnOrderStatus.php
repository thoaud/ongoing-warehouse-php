...
/**
 * PatchReturnOrderStatus Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchReturnOrderStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchReturnOrderStatus';
    ...
    protected static $openAPITypes = [
        'return_order_status_number' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'return_order_status_number' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        'return_order_status_number' => false
    ];
    ...
    protected static $setters = [
        'return_order_status_number' => 'setReturnOrderStatusNumber'
    ];
    ...
    protected static $getters = [
        'return_order_status_number' => 'getReturnOrderStatusNumber'
    ];
    ...
    {
        $this->setIfExists('return_order_status_number', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['return_order_status_number'] === null) {
            $invalidProperties[] = "'return_order_status_number' can't be null";
        }
    ...
    /**
     * Gets return_order_status_number
     *
     * @return int
     */
    public function getReturnOrderStatusNumber()
    {
        return $this->container['return_order_status_number'];
    }

    /**
     * Sets return_order_status_number
     *
     * @param int $return_order_status_number return_order_status_number
     *
     * @return self
     */
    public function setReturnOrderStatusNumber($return_order_status_number)
    {
        if (is_null($return_order_status_number)) {
            throw new \InvalidArgumentException('non-nullable return_order_status_number cannot be null');
        }
        $this->container['return_order_status_number'] = $return_order_status_number;
