...
/**
 * PatchOrderReportedReturnedNumberOfItemsModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderReportedReturnedNumberOfItemsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderReportedReturnedNumberOfItemsModel';
    ...
    protected static array $openAPINullables = [
        'reported_returned_number_of_items' => false
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reported_returned_number_of_items'] === null) {
            $invalidProperties[] = "'reported_returned_number_of_items' can't be null";
        }
     ...
     *
     * @param float $reported_returned_number_of_items reported_returned_number_of_items
     *
     * @return self
     */
    public function setReportedReturnedNumberOfItems($reported_returned_number_of_items)
    {
        if (is_null($reported_returned_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable reported_returned_number_of_items cannot be null');
        }
