...
/**
 * PatchPurchaseOrderNumber Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderNumber';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['purchase_order_number']) > 50)) {
            $invalidProperties[] = "invalid value for 'purchase_order_number', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setPurchaseOrderNumber($purchase_order_number)
    {
        ...
        if ((mb_strlen($purchase_order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_number when calling PatchPurchaseOrderNumber., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($purchase_order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_number when calling PatchPurchaseOrderNumber., must be bigger than or equal to 1.');
        }
