...
/**
 * GetReturnOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnOrderLine';
    ...
    protected static $openAPITypes = [
        ...
        'return_order_row_number' => 'string',
        'customer_order_line' => '\OngoingAPI\Model\GetReturnOrderLineCustomerOrderLine',
        'article' => '\OngoingAPI\Model\GetReturnOrderLineArticle',
        ...
        'returned_removed_by_inventory_number_of_items' => 'float',
        'returned_article_items' => '\OngoingAPI\Model\GetReturnedArticleItem[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'return_order_row_number' => null,
        'customer_order_line' => null,
        'article' => null,
        'return_cause' => null,
        'returned_number_of_items' => 'decimal',
        'picked_number_of_items' => 'decimal',
        'to_be_returned_number_of_items' => 'decimal',
        'returned_removed_by_inventory_number_of_items' => 'decimal',
        'returned_article_items' => null
    ];
    ...
    protected static array $openAPINullables = [
        'return_order_line_id' => false,
        'return_order_row_number' => true,
        'customer_order_line' => true,
        'article' => true,
        'return_cause' => true,
        'returned_number_of_items' => false,
        'picked_number_of_items' => false,
        'to_be_returned_number_of_items' => false,
        'returned_removed_by_inventory_number_of_items' => false,
        'returned_article_items' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'return_order_row_number' => 'returnOrderRowNumber',
        ...
        'to_be_returned_number_of_items' => 'toBeReturnedNumberOfItems',
        'returned_removed_by_inventory_number_of_items' => 'returnedRemovedByInventoryNumberOfItems',
        'returned_article_items' => 'returnedArticleItems'
    ];
    ...
    protected static $setters = [
        ...
        'return_order_row_number' => 'setReturnOrderRowNumber',
        ...
        'to_be_returned_number_of_items' => 'setToBeReturnedNumberOfItems',
        'returned_removed_by_inventory_number_of_items' => 'setReturnedRemovedByInventoryNumberOfItems',
        'returned_article_items' => 'setReturnedArticleItems'
    ];
    ...
    protected static $getters = [
        ...
        'return_order_row_number' => 'getReturnOrderRowNumber',
        ...
        'to_be_returned_number_of_items' => 'getToBeReturnedNumberOfItems',
        'returned_removed_by_inventory_number_of_items' => 'getReturnedRemovedByInventoryNumberOfItems',
        'returned_article_items' => 'getReturnedArticleItems'
    ];
    ...
    {
        $this->setIfExists('return_order_line_id', $data ?? [], null);
        $this->setIfExists('return_order_row_number', $data ?? [], null);
        ...
        $this->setIfExists('to_be_returned_number_of_items', $data ?? [], null);
        $this->setIfExists('returned_removed_by_inventory_number_of_items', $data ?? [], null);
        $this->setIfExists('returned_article_items', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $return_order_line_id return_order_line_id
     *
     * @return self
     */
    public function setReturnOrderLineId($return_order_line_id)
    {
        if (is_null($return_order_line_id)) {
            throw new \InvalidArgumentException('non-nullable return_order_line_id cannot be null');
        }
    ...
    /**
     * Gets return_order_row_number
     *
     * @return string|null
     */
    public function getReturnOrderRowNumber()
    {
        return $this->container['return_order_row_number'];
    }

    /**
     * Sets return_order_row_number
     *
     * @param string|null $return_order_row_number return_order_row_number
     *
     * @return self
     */
    public function setReturnOrderRowNumber($return_order_row_number)
    {
        if (is_null($return_order_row_number)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_row_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_row_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_row_number'] = $return_order_row_number;
     ...
     *
     * @return \OngoingAPI\Model\GetReturnOrderLineCustomerOrderLine|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetReturnOrderLineCustomerOrderLine|null $customer_order_line customer_order_line
     *
     * @return self
     */
    public function setCustomerOrderLine($customer_order_line)
    {
        if (is_null($customer_order_line)) {
            array_push($this->openAPINullablesSetToNull, 'customer_order_line');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_order_line', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetReturnOrderLineArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetReturnOrderLineArticle|null $article article
     *
     * @return self
     */
    ...
    /**
     * Gets to_be_returned_number_of_items
     *
     * @return float|null
     */
    public function getToBeReturnedNumberOfItems()
    {
        return $this->container['to_be_returned_number_of_items'];
    }

    /**
     * Sets to_be_returned_number_of_items
     *
     * @param float|null $to_be_returned_number_of_items to_be_returned_number_of_items
     *
     * @return self
     */
    public function setToBeReturnedNumberOfItems($to_be_returned_number_of_items)
    {
        if (is_null($to_be_returned_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable to_be_returned_number_of_items cannot be null');
        }
        $this->container['to_be_returned_number_of_items'] = $to_be_returned_number_of_items;

        return $this;
    }

    /**
     * Gets returned_removed_by_inventory_number_of_items
     *
     * @return float|null
     */
    public function getReturnedRemovedByInventoryNumberOfItems()
    {
        return $this->container['returned_removed_by_inventory_number_of_items'];
    }

    /**
     * Sets returned_removed_by_inventory_number_of_items
     *
     * @param float|null $returned_removed_by_inventory_number_of_items returned_removed_by_inventory_number_of_items
     *
     * @return self
     */
    public function setReturnedRemovedByInventoryNumberOfItems($returned_removed_by_inventory_number_of_items)
    {
        if (is_null($returned_removed_by_inventory_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable returned_removed_by_inventory_number_of_items cannot be null');
        }
        $this->container['returned_removed_by_inventory_number_of_items'] = $returned_removed_by_inventory_number_of_items;

        return $this;
    }

    /**
     * Gets returned_article_items
     *
     * @return \OngoingAPI\Model\GetReturnedArticleItem[]|null
     */
    public function getReturnedArticleItems()
    {
        return $this->container['returned_article_items'];
    }

    /**
     * Sets returned_article_items
     *
     * @param \OngoingAPI\Model\GetReturnedArticleItem[]|null $returned_article_items returned_article_items
     *
     * @return self
     */
    public function setReturnedArticleItems($returned_article_items)
    {
        if (is_null($returned_article_items)) {
            array_push($this->openAPINullablesSetToNull, 'returned_article_items');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('returned_article_items', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['returned_article_items'] = $returned_article_items;
