...
class LocationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'barcode' => 'string',
        'position' => '\OngoingAPI\Model\LocationModelPosition',
        'location_type_id' => 'int',
        'picking_priority' => 'int',
        'is_picking_location' => 'bool',
        'is_locked' => 'bool',
        'is_locked_for_sale' => 'bool',
        'dimensions' => '\OngoingAPI\Model\LocationModelDimensions'
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_picking_location' => 'isPickingLocation',
        'is_locked' => 'isLocked',
    ...
    protected static $setters = [
        ...
        'is_picking_location' => 'setIsPickingLocation',
    ...
    protected static $getters = [
        ...
        'is_picking_location' => 'getIsPickingLocation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('location_type_id', $data ?? [], null);
        $this->setIfExists('picking_priority', $data ?? [], null);
        $this->setIfExists('is_picking_location', $data ?? [], null);
    ...
    */
     ...
     * Gets position
     *
     * @return \OngoingAPI\Model\LocationModelPosition|null
     */
     ...
     * Sets position
     *
     * @param \OngoingAPI\Model\LocationModelPosition|null $position position
     *
     * @return self
     */
     ...
     *
     * @param int|null $location_type_id location_type_id
     *
     * @return self
     */
    public function setLocationTypeId($location_type_id)
    {
        if (is_null($location_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'location_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('location_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPickingPriority($picking_priority)
    {
        if (is_null($picking_priority)) {
            throw new \InvalidArgumentException('non-nullable picking_priority cannot be null');
        }
    ...
    /**
     * Gets is_picking_location
     *
     * @return bool|null
     */
    public function getIsPickingLocation()
    {
        return $this->container['is_picking_location'];
    }

    /**
     * Sets is_picking_location
     *
     * @param bool|null $is_picking_location is_picking_location
     *
     * @return self
     */
    public function setIsPickingLocation($is_picking_location)
    {
        if (is_null($is_picking_location)) {
            throw new \InvalidArgumentException('non-nullable is_picking_location cannot be null');
        }
        $this->container['is_picking_location'] = $is_picking_location;
     ...
     * Gets dimensions
     *
     * @return \OngoingAPI\Model\LocationModelDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \OngoingAPI\Model\LocationModelDimensions|null $dimensions dimensions
     *
     * @return self
     */
