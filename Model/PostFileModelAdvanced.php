...
/**
 * PostFileModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostFileModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFileModel_advanced';
    ...
    protected static $openAPITypes = [
        'printing_info' => '\OngoingAPI\Model\PostFileAdvancedPrintingInfo'
    ];
    ...
    {
        $this->setIfExists('printing_info', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets printing_info
     *
     * @return \OngoingAPI\Model\PostFileAdvancedPrintingInfo|null
     */
    public function getPrintingInfo()
    {
        return $this->container['printing_info'];
    }

    /**
     * Sets printing_info
     *
     * @param \OngoingAPI\Model\PostFileAdvancedPrintingInfo|null $printing_info printing_info
     *
     * @return self
     */
    public function setPrintingInfo($printing_info)
    {
        if (is_null($printing_info)) {
            array_push($this->openAPINullablesSetToNull, 'printing_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('printing_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['printing_info'] = $printing_info;
