<?php
/**
 * PostPurchaseOrderArticleItemParcelModelDimensions
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderArticleItemParcelModelDimensions Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemParcelModelDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemParcelModel_dimensions';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tare_weight', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['tare_weight'];
    }

    /**
     * Sets tare_weight
     *
     * @param float|null $tare_weight tare_weight
     *
     * @return self
     */
    public function setTareWeight($tare_weight)
    {
        if (is_null($tare_weight)) {
            array_push($this->openAPINullablesSetToNull, 'tare_weight');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tare_weight', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tare_weight'] = $tare_weight;
