...
/**
 * WarehouseModelAddress Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class WarehouseModelAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarehouseModel_address';
    ...
    protected static $openAPITypes = [
        ...
        'address_free_text1' => 'string',
        'telephone_notification' => '\OngoingAPI\Model\WarehouseAddressModelTelephoneNotification',
        'email_notification' => '\OngoingAPI\Model\WarehouseAddressModelTelephoneNotification',
        'sms_notification' => '\OngoingAPI\Model\WarehouseAddressModelTelephoneNotification',
        'address_free_text2' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'address_free_text1' => null,
        'telephone_notification' => null,
        'email_notification' => null,
        'sms_notification' => null,
        'address_free_text2' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'address_free_text1' => true,
        'telephone_notification' => true,
        'email_notification' => true,
        'sms_notification' => true,
        'address_free_text2' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'address_free_text1' => 'addressFreeText1',
        'telephone_notification' => 'telephoneNotification',
        'email_notification' => 'emailNotification',
        'sms_notification' => 'smsNotification',
        'address_free_text2' => 'addressFreeText2'
    ];
    ...
    protected static $setters = [
        ...
        'address_free_text1' => 'setAddressFreeText1',
        ...
        'address_free_text2' => 'setAddressFreeText2'
    ];
    ...
    protected static $getters = [
        ...
        'address_free_text1' => 'getAddressFreeText1',
        ...
        'address_free_text2' => 'getAddressFreeText2'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('address_free_text1', $data ?? [], null);
        ...
        $this->setIfExists('address_free_text2', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets address_free_text1
     *
     * @return string|null
     */
    public function getAddressFreeText1()
    {
        return $this->container['address_free_text1'];
    }

    /**
     * Sets address_free_text1
     *
     * @param string|null $address_free_text1 address_free_text1
     *
     * @return self
     */
    public function setAddressFreeText1($address_free_text1)
    {
        if (is_null($address_free_text1)) {
            array_push($this->openAPINullablesSetToNull, 'address_free_text1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_free_text1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['address_free_text1'] = $address_free_text1;
     ...
     *
     * @return \OngoingAPI\Model\WarehouseAddressModelTelephoneNotification|null
     */
     ...
     *
     * @param \OngoingAPI\Model\WarehouseAddressModelTelephoneNotification|null $telephone_notification telephone_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\WarehouseAddressModelTelephoneNotification|null $email_notification email_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\WarehouseAddressModelTelephoneNotification|null $sms_notification sms_notification
     *
     * @return self
     */
    ...
    /**
     * Gets address_free_text2
     *
     * @return string|null
     */
    public function getAddressFreeText2()
    {
        return $this->container['address_free_text2'];
    }

    /**
     * Sets address_free_text2
     *
     * @param string|null $address_free_text2 address_free_text2
     *
     * @return self
     */
    public function setAddressFreeText2($address_free_text2)
    {
        if (is_null($address_free_text2)) {
            array_push($this->openAPINullablesSetToNull, 'address_free_text2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_free_text2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['address_free_text2'] = $address_free_text2;
