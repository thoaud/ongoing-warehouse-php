...
/**
 * PatchPurchaseOrderFreeBool1 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderFreeBool1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderFreeBool1';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_bool1'] === null) {
            $invalidProperties[] = "'free_bool1' can't be null";
        }
     ...
     * Sets free_bool1
     *
     * @param bool $free_bool1 free_bool1
     *
     * @return self
     */
    public function setFreeBool1($free_bool1)
    {
        if (is_null($free_bool1)) {
            throw new \InvalidArgumentException('non-nullable free_bool1 cannot be null');
        }
