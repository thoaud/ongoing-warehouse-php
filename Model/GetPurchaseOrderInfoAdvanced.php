...
/**
 * GetPurchaseOrderInfoAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPurchaseOrderInfoAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPurchaseOrderInfo_advanced';
    ...
    protected static array $openAPINullables = [
        ...
        'order_date' => true,
        'container' => true,
        'purchase_order_is_return_type' => false,
        'advised_date' => true
    ];
    ...
    */
    ...
    public function setPurchaseOrderIsReturnType($purchase_order_is_return_type)
    {
        if (is_null($purchase_order_is_return_type)) {
            throw new \InvalidArgumentException('non-nullable purchase_order_is_return_type cannot be null');
        }
