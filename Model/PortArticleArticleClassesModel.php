...
/**
 * PortArticleArticleClassesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PortArticleArticleClassesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortArticleArticleClassesModel';
    ...
    protected static $attributeMap = [
        'article_class_ids' => 'articleClassIds'
    ];
    ...
    protected static $setters = [
        'article_class_ids' => 'setArticleClassIds'
    ];
    ...
    protected static $getters = [
        'article_class_ids' => 'getArticleClassIds'
    ];
    ...
    {
        $this->setIfExists('article_class_ids', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['article_class_ids'] === null) {
            $invalidProperties[] = "'article_class_ids' can't be null";
        }
    ...
    /**
     * Gets article_class_ids
     *
     * @return int[]
     */
    public function getArticleClassIds()
    {
        return $this->container['article_class_ids'];
    }

    /**
     * Sets article_class_ids
     *
     * @param int[] $article_class_ids article_class_ids
     *
     * @return self
     */
    public function setArticleClassIds($article_class_ids)
    {
        if (is_null($article_class_ids)) {
            throw new \InvalidArgumentException('non-nullable article_class_ids cannot be null');
        }
        $this->container['article_class_ids'] = $article_class_ids;
