 ...
 */
class WarehouseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarehouseModel';
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'string',
        'name' => 'string',
        'address' => '\OngoingAPI\Model\WarehouseModelAddress'
    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OngoingAPI\Model\WarehouseModelAddress|null
     */
     ...
     * Sets address
     *
     * @param \OngoingAPI\Model\WarehouseModelAddress|null $address address
     *
     * @return self
     */
