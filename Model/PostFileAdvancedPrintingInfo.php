...
/**
 * PostFileAdvancedPrintingInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostFileAdvancedPrintingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFileAdvanced_printingInfo';
    ...
    protected static $openAPITypes = [
        'report_id' => 'int',
        'print_as_user' => '\OngoingAPI\Model\PostFilePrintingInfoPrintAsUser',
        'print_as_workstation' => '\OngoingAPI\Model\PostFilePrintingInfoPrintAsWorkstation'
    ];
    ...
    protected static $attributeMap = [
        'report_id' => 'reportId',
        'print_as_user' => 'printAsUser',
        'print_as_workstation' => 'printAsWorkstation'
    ];
    ...
    protected static $setters = [
        ...
        'print_as_user' => 'setPrintAsUser',
        'print_as_workstation' => 'setPrintAsWorkstation'
    ];
    ...
    protected static $getters = [
        ...
        'print_as_user' => 'getPrintAsUser',
        'print_as_workstation' => 'getPrintAsWorkstation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('print_as_user', $data ?? [], null);
        $this->setIfExists('print_as_workstation', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets print_as_user
     *
     * @return \OngoingAPI\Model\PostFilePrintingInfoPrintAsUser|null
     */
    public function getPrintAsUser()
    {
        return $this->container['print_as_user'];
    }

    /**
     * Sets print_as_user
     *
     * @param \OngoingAPI\Model\PostFilePrintingInfoPrintAsUser|null $print_as_user print_as_user
     *
     * @return self
     */
    public function setPrintAsUser($print_as_user)
    {
        if (is_null($print_as_user)) {
            array_push($this->openAPINullablesSetToNull, 'print_as_user');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('print_as_user', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['print_as_user'] = $print_as_user;

        return $this;
    }

    /**
     * Gets print_as_workstation
     *
     * @return \OngoingAPI\Model\PostFilePrintingInfoPrintAsWorkstation|null
     */
    public function getPrintAsWorkstation()
    {
        return $this->container['print_as_workstation'];
    }

    /**
     * Sets print_as_workstation
     *
     * @param \OngoingAPI\Model\PostFilePrintingInfoPrintAsWorkstation|null $print_as_workstation print_as_workstation
     *
     * @return self
     */
    public function setPrintAsWorkstation($print_as_workstation)
    {
        if (is_null($print_as_workstation)) {
            array_push($this->openAPINullablesSetToNull, 'print_as_workstation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('print_as_workstation', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['print_as_workstation'] = $print_as_workstation;
