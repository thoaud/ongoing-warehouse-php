...
/**
 * PatchServicePointCode Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchServicePointCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchServicePointCode';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_point_code'] === null) {
            $invalidProperties[] = "'service_point_code' can't be null";
        }
        if ((mb_strlen($this->container['service_point_code']) > 50)) {
            $invalidProperties[] = "invalid value for 'service_point_code', the character length must be smaller than or equal to 50.";
        }

        if ((mb_strlen($this->container['service_point_code']) < 1)) {
            $invalidProperties[] = "invalid value for 'service_point_code', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $service_point_code service_point_code
     *
     * @return self
     */
    public function setServicePointCode($service_point_code)
    {
        if (is_null($service_point_code)) {
            throw new \InvalidArgumentException('non-nullable service_point_code cannot be null');
        }
        if ((mb_strlen($service_point_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $service_point_code when calling PatchServicePointCode., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($service_point_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $service_point_code when calling PatchServicePointCode., must be bigger than or equal to 1.');
        }
