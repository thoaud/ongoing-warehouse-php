...
/**
 * GetArticleModelSupplierInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleModelSupplierInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel_supplierInfo';
    ...
    protected static $openAPITypes = [
        ...
        'alternative_suppliers' => '\OngoingAPI\Model\GetArticleAlternativeSupplier[]'
    ];
    ...
    protected static $setters = [
        ...
        'alternative_suppliers' => 'setAlternativeSuppliers'
    ];
    ...
    protected static $getters = [
        ...
        'alternative_suppliers' => 'getAlternativeSuppliers'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('alternative_suppliers', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets alternative_suppliers
     *
     * @return \OngoingAPI\Model\GetArticleAlternativeSupplier[]|null
     */
    public function getAlternativeSuppliers()
    {
        return $this->container['alternative_suppliers'];
    }

    /**
     * Sets alternative_suppliers
     *
     * @param \OngoingAPI\Model\GetArticleAlternativeSupplier[]|null $alternative_suppliers alternative_suppliers
     *
     * @return self
     */
    public function setAlternativeSuppliers($alternative_suppliers)
    {
        if (is_null($alternative_suppliers)) {
            array_push($this->openAPINullablesSetToNull, 'alternative_suppliers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('alternative_suppliers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['alternative_suppliers'] = $alternative_suppliers;
    ...
    public function getPurchasePrice() {
        return $this->container['purchase_price'] ?? null;
    }

    public function getPurchaseCurrencyCode() {
        return $this->container['purcase_currency_code'] ?? null; // Note spelling error
    }
    public function getCountryOfOriginCode() {
        return $this->container['country_of_origin_code'] ?? null; // Note spelling error
    }
}
