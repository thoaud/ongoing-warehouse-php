...
/**
 * PostArticleClassResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleClassResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleClassResponse';
    ...
    protected static $setters = [
        'article_class_id' => 'setArticleClassId',
        'success' => 'setSuccess',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        'article_class_id' => 'getArticleClassId',
        'success' => 'getSuccess',
        'message' => 'getMessage'
    ];
    ...
    {
        $this->setIfExists('article_class_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets article_class_id
     *
     * @return int|null
     */
    public function getArticleClassId()
    {
        return $this->container['article_class_id'];
    }

    /**
     * Sets article_class_id
     *
     * @param int|null $article_class_id article_class_id
     *
     * @return self
     */
    public function setArticleClassId($article_class_id)
    {
        if (is_null($article_class_id)) {
            array_push($this->openAPINullablesSetToNull, 'article_class_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_class_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_class_id'] = $article_class_id;
