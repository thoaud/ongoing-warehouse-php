...
/**
 * GetOrderPickabilityResult Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickabilityResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickabilityResult';
    ...
    protected static $openAPITypes = [
        'order_info' => '\OngoingAPI\Model\GetOrderPickabilityResultOrderInfo',
        'order_pickability' => '\OngoingAPI\Model\GetOrderPickabilityResultOrderPickability',
        'order_lines' => '\OngoingAPI\Model\GetOrderPickabilityOrderLineInfo[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'order_pickability' => 'orderPickability',
    ...
    protected static $setters = [
        ...
        'order_pickability' => 'setOrderPickability',
    ...
    protected static $getters = [
        ...
        'order_pickability' => 'getOrderPickability',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('order_pickability', $data ?? [], null);
    ...
    */
     ...
     * Gets order_info
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityResultOrderInfo|null
     */
     ...
     * Sets order_info
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityResultOrderInfo|null $order_info order_info
     *
     * @return self
     */
    ...
    /**
     * Gets order_pickability
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityResultOrderPickability|null
     */
    public function getOrderPickability()
    {
        return $this->container['order_pickability'];
    }

    /**
     * Sets order_pickability
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityResultOrderPickability|null $order_pickability order_pickability
     *
     * @return self
     */
    public function setOrderPickability($order_pickability)
    {
        if (is_null($order_pickability)) {
            array_push($this->openAPINullablesSetToNull, 'order_pickability');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_pickability', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['order_pickability'] = $order_pickability;
     ...
     * Gets order_lines
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityOrderLineInfo[]|null
     */
     ...
     * Sets order_lines
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityOrderLineInfo[]|null $order_lines order_lines
     *
     * @return self
     */
