<?php
/**
 * PostOrderTransporterPaymentConsigneePays
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderTransporterPaymentConsigneePays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderTransporterPaymentConsigneePays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderTransporterPayment_consigneePays';
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling PostOrderTransporterPaymentConsigneePays., must be bigger than or equal to 1.');
        }
