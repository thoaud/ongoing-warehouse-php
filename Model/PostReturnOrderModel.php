...
/**
 * PostReturnOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostReturnOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostReturnOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'customer_order' => '\OngoingAPI\Model\PostReturnOrderCustomerOrder',
        'comment' => 'string',
        'in_date' => '\DateTime',
        'return_order_lines' => '\OngoingAPI\Model\PostReturnOrderLine[]',
        'warehouse_id' => 'int',
        'tracking' => '\OngoingAPI\Model\PostReturnOrderTracking[]',
        'return_order_handling_comment' => 'string',
        'free_values' => '\OngoingAPI\Model\PostReturnOrderModelFreeValues'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'return_order_number' => false,
        'customer_order' => false,
        'comment' => true,
        'in_date' => true,
        'return_order_lines' => false,
        'warehouse_id' => true,
        'tracking' => true,
    ...
    protected static $attributeMap = [
        ...
        'comment' => 'comment',
        'in_date' => 'inDate',
        'return_order_lines' => 'returnOrderLines',
    ...
    protected static $setters = [
        ...
        'comment' => 'setComment',
        'in_date' => 'setInDate',
        'return_order_lines' => 'setReturnOrderLines',
    ...
    protected static $getters = [
        ...
        'comment' => 'getComment',
        'in_date' => 'getInDate',
        'return_order_lines' => 'getReturnOrderLines',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_order_lines', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['return_order_number'] === null) {
            $invalidProperties[] = "'return_order_number' can't be null";
        }
        if ((mb_strlen($this->container['return_order_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'return_order_number', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['customer_order'] === null) {
            $invalidProperties[] = "'customer_order' can't be null";
        }
        if ($this->container['return_order_lines'] === null) {
            $invalidProperties[] = "'return_order_lines' can't be null";
        }
     ...
     *
     * @param string $return_order_number return_order_number
     *
     * @return self
     */
    public function setReturnOrderNumber($return_order_number)
    {
        if (is_null($return_order_number)) {
            throw new \InvalidArgumentException('non-nullable return_order_number cannot be null');
        }

        if ((mb_strlen($return_order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_order_number when calling PostReturnOrderModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets customer_order
     *
     * @return \OngoingAPI\Model\PostReturnOrderCustomerOrder
     */
     ...
     * Sets customer_order
     *
     * @param \OngoingAPI\Model\PostReturnOrderCustomerOrder $customer_order customer_order
     *
     * @return self
     */
    ...
    /**
     * Gets return_order_lines
     *
     * @return \OngoingAPI\Model\PostReturnOrderLine[]
     */
    public function getReturnOrderLines()
    {
        return $this->container['return_order_lines'];
    }

    /**
     * Sets return_order_lines
     *
     * @param \OngoingAPI\Model\PostReturnOrderLine[] $return_order_lines return_order_lines
     *
     * @return self
     */
    public function setReturnOrderLines($return_order_lines)
    {
        if (is_null($return_order_lines)) {
            throw new \InvalidArgumentException('non-nullable return_order_lines cannot be null');
        }
        $this->container['return_order_lines'] = $return_order_lines;
     ...
     * Gets tracking
     *
     * @return \OngoingAPI\Model\PostReturnOrderTracking[]|null
     */
     ...
     * Sets tracking
     *
     * @param \OngoingAPI\Model\PostReturnOrderTracking[]|null $tracking tracking
     *
     * @return self
     */
     ...
     * Gets free_values
     *
     * @return \OngoingAPI\Model\PostReturnOrderModelFreeValues|null
     */
     ...
     * Sets free_values
     *
     * @param \OngoingAPI\Model\PostReturnOrderModelFreeValues|null $free_values free_values
     *
     * @return self
     */
