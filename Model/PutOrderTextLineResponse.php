...
/**
 * PutOrderTextLineResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PutOrderTextLineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutOrderTextLineResponse';
    ...
    protected static $attributeMap = [
        'order_text_line_id' => 'orderTextLineId',
        'success' => 'success',
        'message' => 'message'
    ];
    ...
    protected static $setters = [
        'order_text_line_id' => 'setOrderTextLineId',
        'success' => 'setSuccess',
        'message' => 'setMessage'
    ];
    ...
    protected static $getters = [
        'order_text_line_id' => 'getOrderTextLineId',
        'success' => 'getSuccess',
        'message' => 'getMessage'
    ];
    ...
    {
        $this->setIfExists('order_text_line_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets order_text_line_id
     *
     * @return int|null
     */
    public function getOrderTextLineId()
    {
        return $this->container['order_text_line_id'];
    }

    /**
     * Sets order_text_line_id
     *
     * @param int|null $order_text_line_id order_text_line_id
     *
     * @return self
     */
    public function setOrderTextLineId($order_text_line_id)
    {
        if (is_null($order_text_line_id)) {
            throw new \InvalidArgumentException('non-nullable order_text_line_id cannot be null');
        }
        $this->container['order_text_line_id'] = $order_text_line_id;
