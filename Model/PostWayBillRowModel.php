...
/**
 * PostWayBillRowModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostWayBillRowModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostWayBillRowModel';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'category' => 'string',
        'parcel_type' => '\OngoingAPI\Model\PostWaybillParcelParcelType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('load_meters', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['number_of_packages'] === null) {
            $invalidProperties[] = "'number_of_packages' can't be null";
        }
     ...
     *
     * @param int $number_of_packages number_of_packages
     *
     * @return self
     */
    ...
    {
        return $this->container['load_meters'];
    }

    /**
     * Sets load_meters
     *
     * @param float|null $load_meters load_meters
     *
     * @return self
     */
    public function setLoadMeters($load_meters)
    {
        if (is_null($load_meters)) {
            array_push($this->openAPINullablesSetToNull, 'load_meters');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('load_meters', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['load_meters'] = $load_meters;
     ...
     * Gets parcel_type
     *
     * @return \OngoingAPI\Model\PostWaybillParcelParcelType
     */
     ...
     * Sets parcel_type
     *
     * @param \OngoingAPI\Model\PostWaybillParcelParcelType $parcel_type parcel_type
     *
     * @return self
     */
