...
/**
 * PostOrderTextLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderTextLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderTextLine';
    ...
    */
    ...
    public function setRowNumber($row_number)
    {
        ...
        if ((mb_strlen($row_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $row_number when calling PostOrderTextLine., must be bigger than or equal to 1.');
        }
