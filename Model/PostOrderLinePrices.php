...
/**
 * PostOrderLinePrices Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderLinePrices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderLine_prices';
    ...
    protected static $attributeMap = [
        ...
        'customer_line_price' => 'customerLinePrice',
    ...
    protected static $setters = [
        ...
        'customer_line_price' => 'setCustomerLinePrice',
    ...
    protected static $getters = [
        ...
        'customer_line_price' => 'getCustomerLinePrice',
    ...
    {
        $this->setIfExists('line_price', $data ?? [], null);
        $this->setIfExists('customer_line_price', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($line_price)) {
            array_push($this->openAPINullablesSetToNull, 'line_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('line_price', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets customer_line_price
     *
     * @return float|null
     */
    public function getCustomerLinePrice()
    {
        return $this->container['customer_line_price'];
    }

    /**
     * Sets customer_line_price
     *
     * @param float|null $customer_line_price customer_line_price
     *
     * @return self
     */
    public function setCustomerLinePrice($customer_line_price)
    {
        if (is_null($customer_line_price)) {
            array_push($this->openAPINullablesSetToNull, 'customer_line_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_line_price', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['customer_line_price'] = $customer_line_price;
