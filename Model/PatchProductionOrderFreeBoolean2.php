...
/**
 * PatchProductionOrderFreeBoolean2 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchProductionOrderFreeBoolean2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchProductionOrderFreeBoolean2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_boolean2'] === null) {
            $invalidProperties[] = "'free_boolean2' can't be null";
        }
     ...
     * Sets free_boolean2
     *
     * @param bool $free_boolean2 free_boolean2
     *
     * @return self
     */
