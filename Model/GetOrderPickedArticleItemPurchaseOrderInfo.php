<?php
/**
 * GetOrderPickedArticleItemPurchaseOrderInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderPickedArticleItemPurchaseOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickedArticleItemPurchaseOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickedArticleItem_purchaseOrderInfo';
    ...
    protected static $openAPITypes = [
        ...
        'purchase_order_pallet_item_id' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'purchase_order_line_id' => 'int32',
        'purchase_order_pallet_item_id' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'purchase_order_pallet_item_id' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'purchase_order_pallet_item_id' => 'purchaseOrderPalletItemId'
    ];
    ...
    protected static $setters = [
        ...
        'purchase_order_pallet_item_id' => 'setPurchaseOrderPalletItemId'
    ];
    ...
    protected static $getters = [
        ...
        'purchase_order_pallet_item_id' => 'getPurchaseOrderPalletItemId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('purchase_order_line_id', $data ?? [], null);
        $this->setIfExists('purchase_order_pallet_item_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $purchase_order_line_id purchase_order_line_id
     *
     * @return self
     */
    public function setPurchaseOrderLineId($purchase_order_line_id)
    {
        if (is_null($purchase_order_line_id)) {
            throw new \InvalidArgumentException('non-nullable purchase_order_line_id cannot be null');
        }
    ...
    /**
     * Gets purchase_order_pallet_item_id
     *
     * @return int|null
     */
    public function getPurchaseOrderPalletItemId()
    {
        return $this->container['purchase_order_pallet_item_id'];
    }

    /**
     * Sets purchase_order_pallet_item_id
     *
     * @param int|null $purchase_order_pallet_item_id purchase_order_pallet_item_id
     *
     * @return self
     */
    public function setPurchaseOrderPalletItemId($purchase_order_pallet_item_id)
    {
        if (is_null($purchase_order_pallet_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'purchase_order_pallet_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('purchase_order_pallet_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['purchase_order_pallet_item_id'] = $purchase_order_pallet_item_id;
