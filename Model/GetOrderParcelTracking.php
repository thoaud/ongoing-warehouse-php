...
/**
 * GetOrderParcelTracking Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderParcelTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderParcel_tracking';
    ...
    protected static $openAPITypes = [
        'freight_price' => '\OngoingAPI\Model\GetOrderParcelTrackingFreightPrice',
        'tracking_url' => 'string'
    ];
    ...
    */
     ...
     * Gets freight_price
     *
     * @return \OngoingAPI\Model\GetOrderParcelTrackingFreightPrice|null
     */
     ...
     * Sets freight_price
     *
     * @param \OngoingAPI\Model\GetOrderParcelTrackingFreightPrice|null $freight_price freight_price
     *
     * @return self
     */
