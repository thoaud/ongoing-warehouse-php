...
/**
 * PatchInventoryAdjustmentArticlesReportedResponse Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchInventoryAdjustmentArticlesReportedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchInventoryAdjustmentArticlesReportedResponse';
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'items' => '\OngoingAPI\Model\PatchInventoryAdjustmentArticlesReportedItems[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OngoingAPI\Model\PatchInventoryAdjustmentArticlesReportedItems[]|null
     */
     ...
     * Sets items
     *
     * @param \OngoingAPI\Model\PatchInventoryAdjustmentArticlesReportedItems[]|null $items items
     *
     * @return self
     */
