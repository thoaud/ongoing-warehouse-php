<?php
/**
 * GetPurchaseOrderInfoFreeValues
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetPurchaseOrderInfoFreeValues Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPurchaseOrderInfoFreeValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPurchaseOrderInfo_freeValues';
    ...
    protected static $attributeMap = [
        ...
        'free_bool1' => 'freeBool1',
        'free_bool2' => 'freeBool2'
    ];
    ...
    protected static $setters = [
        ...
        'free_bool1' => 'setFreeBool1',
        'free_bool2' => 'setFreeBool2'
    ];
    ...
    protected static $getters = [
        ...
        'free_bool1' => 'getFreeBool1',
        'free_bool2' => 'getFreeBool2'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('free_bool1', $data ?? [], null);
        $this->setIfExists('free_bool2', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getFreeBool1()
    {
        return $this->container['free_bool1'];
    }

    /**
     * Sets free_bool1
     *
     * @param bool|null $free_bool1 free_bool1
     *
     * @return self
     */
    public function setFreeBool1($free_bool1)
    {
        if (is_null($free_bool1)) {
            array_push($this->openAPINullablesSetToNull, 'free_bool1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_bool1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_bool1'] = $free_bool1;
     ...
     * @return bool|null
     */
    public function getFreeBool2()
    {
        return $this->container['free_bool2'];
    }

    /**
     * Sets free_bool2
     *
     * @param bool|null $free_bool2 free_bool2
     *
     * @return self
     */
    public function setFreeBool2($free_bool2)
    {
        if (is_null($free_bool2)) {
            array_push($this->openAPINullablesSetToNull, 'free_bool2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_bool2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_bool2'] = $free_bool2;
