<?php
/**
 * GetArticleInventoryPerWarehouseInfoReported
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetArticleInventoryPerWarehouseInfoReported Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleInventoryPerWarehouseInfoReported implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleInventoryPerWarehouseInfo_reported';
    ...
    protected static $openAPITypes = [
        'picked_to_be_reported_number_of_items' => 'float',
        'returned_to_be_reported_number_of_items' => 'float',
        'received_to_be_reported_number_of_items' => 'float'
    ];
    ...
    protected static $openAPIFormats = [
        'picked_to_be_reported_number_of_items' => 'decimal',
        'returned_to_be_reported_number_of_items' => 'decimal',
        'received_to_be_reported_number_of_items' => 'decimal'
    ];
    ...
    protected static array $openAPINullables = [
        'picked_to_be_reported_number_of_items' => false,
        'returned_to_be_reported_number_of_items' => false,
        'received_to_be_reported_number_of_items' => false
    ];
    ...
    protected static $attributeMap = [
        'picked_to_be_reported_number_of_items' => 'pickedToBeReportedNumberOfItems',
        'returned_to_be_reported_number_of_items' => 'returnedToBeReportedNumberOfItems',
        'received_to_be_reported_number_of_items' => 'receivedToBeReportedNumberOfItems'
    ];
    ...
    protected static $setters = [
        'picked_to_be_reported_number_of_items' => 'setPickedToBeReportedNumberOfItems',
        'returned_to_be_reported_number_of_items' => 'setReturnedToBeReportedNumberOfItems',
        'received_to_be_reported_number_of_items' => 'setReceivedToBeReportedNumberOfItems'
    ];
    ...
    protected static $getters = [
        'picked_to_be_reported_number_of_items' => 'getPickedToBeReportedNumberOfItems',
        'returned_to_be_reported_number_of_items' => 'getReturnedToBeReportedNumberOfItems',
        'received_to_be_reported_number_of_items' => 'getReceivedToBeReportedNumberOfItems'
    ];
    ...
    {
        $this->setIfExists('picked_to_be_reported_number_of_items', $data ?? [], null);
        $this->setIfExists('returned_to_be_reported_number_of_items', $data ?? [], null);
        $this->setIfExists('received_to_be_reported_number_of_items', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets picked_to_be_reported_number_of_items
     *
     * @return float|null
     */
    public function getPickedToBeReportedNumberOfItems()
    {
        return $this->container['picked_to_be_reported_number_of_items'];
    }

    /**
     * Sets picked_to_be_reported_number_of_items
     *
     * @param float|null $picked_to_be_reported_number_of_items picked_to_be_reported_number_of_items
     *
     * @return self
     */
    public function setPickedToBeReportedNumberOfItems($picked_to_be_reported_number_of_items)
    {
        if (is_null($picked_to_be_reported_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable picked_to_be_reported_number_of_items cannot be null');
        }
        $this->container['picked_to_be_reported_number_of_items'] = $picked_to_be_reported_number_of_items;

        return $this;
    }

    /**
     * Gets returned_to_be_reported_number_of_items
     *
     * @return float|null
     */
    public function getReturnedToBeReportedNumberOfItems()
    {
        return $this->container['returned_to_be_reported_number_of_items'];
    }

    /**
     * Sets returned_to_be_reported_number_of_items
     *
     * @param float|null $returned_to_be_reported_number_of_items returned_to_be_reported_number_of_items
     *
     * @return self
     */
    public function setReturnedToBeReportedNumberOfItems($returned_to_be_reported_number_of_items)
    {
        if (is_null($returned_to_be_reported_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable returned_to_be_reported_number_of_items cannot be null');
        }
        $this->container['returned_to_be_reported_number_of_items'] = $returned_to_be_reported_number_of_items;

        return $this;
    }

    /**
     * Gets received_to_be_reported_number_of_items
     *
     * @return float|null
     */
    public function getReceivedToBeReportedNumberOfItems()
    {
        return $this->container['received_to_be_reported_number_of_items'];
    }

    /**
     * Sets received_to_be_reported_number_of_items
     *
     * @param float|null $received_to_be_reported_number_of_items received_to_be_reported_number_of_items
     *
     * @return self
     */
    public function setReceivedToBeReportedNumberOfItems($received_to_be_reported_number_of_items)
    {
        if (is_null($received_to_be_reported_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable received_to_be_reported_number_of_items cannot be null');
        }
        $this->container['received_to_be_reported_number_of_items'] = $received_to_be_reported_number_of_items;
