...
/**
 * PostOrderModelTransporter Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderModelTransporter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderModel_transporter';
    ...
    protected static $openAPITypes = [
        ...
        'payment_advanced' => '\OngoingAPI\Model\PostOrderTransporterPaymentAdvanced'
    ];
    ...
    protected static $attributeMap = [
        ...
        'payment_advanced' => 'paymentAdvanced'
    ];
    ...
    protected static $setters = [
        ...
        'payment_advanced' => 'setPaymentAdvanced'
    ];
    ...
    protected static $getters = [
        ...
        'payment_advanced' => 'getPaymentAdvanced'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payment_advanced', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets payment_advanced
     *
     * @return \OngoingAPI\Model\PostOrderTransporterPaymentAdvanced|null
     */
    public function getPaymentAdvanced()
    {
        return $this->container['payment_advanced'];
    }

    /**
     * Sets payment_advanced
     *
     * @param \OngoingAPI\Model\PostOrderTransporterPaymentAdvanced|null $payment_advanced payment_advanced
     *
     * @return self
     */
    public function setPaymentAdvanced($payment_advanced)
    {
        if (is_null($payment_advanced)) {
            array_push($this->openAPINullablesSetToNull, 'payment_advanced');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_advanced', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payment_advanced'] = $payment_advanced;
