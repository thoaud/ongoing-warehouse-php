...
/**
 * GetReturnOrderLineCustomerOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnOrderLineCustomerOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnOrderLine_customerOrderLine';
    ...
    protected static $openAPITypes = [
        'order_line_id' => 'int',
        'customer_order_row_number' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'order_line_id' => 'int32',
        'customer_order_row_number' => null
    ];
    ...
    protected static array $openAPINullables = [
        'order_line_id' => false,
        'customer_order_row_number' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'customer_order_row_number' => 'customerOrderRowNumber'
    ];
    ...
    protected static $setters = [
        ...
        'customer_order_row_number' => 'setCustomerOrderRowNumber'
    ];
    ...
    protected static $getters = [
        ...
        'customer_order_row_number' => 'getCustomerOrderRowNumber'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customer_order_row_number', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets order_line_id
     *
     * @param int|null $order_line_id order_line_id
     *
     * @return self
     */
    ...
    /**
     * Gets customer_order_row_number
     *
     * @return string|null
     */
    public function getCustomerOrderRowNumber()
    {
        return $this->container['customer_order_row_number'];
    }

    /**
     * Sets customer_order_row_number
     *
     * @param string|null $customer_order_row_number customer_order_row_number
     *
     * @return self
     */
    public function setCustomerOrderRowNumber($customer_order_row_number)
    {
        if (is_null($customer_order_row_number)) {
            array_push($this->openAPINullablesSetToNull, 'customer_order_row_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_order_row_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['customer_order_row_number'] = $customer_order_row_number;
