...
/**
 * PostProductionOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostProductionOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostProductionOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'production_order_type' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'production_date' => '\DateTime',
        'free_values' => '\OngoingAPI\Model\PostProductionOrderModelFreeValues',
        'production_order_lines' => '\OngoingAPI\Model\PostProductionOrderLine[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'comment' => null,
        'production_order_type' => null,
        'production_date' => 'date-time',
        'free_values' => null,
        'production_order_lines' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'comment' => true,
        'production_order_type' => true,
        'production_date' => true,
        'free_values' => true,
        'production_order_lines' => false
    ];
    ...
    protected static $setters = [
        ...
        'comment' => 'setComment',
        'production_order_type' => 'setProductionOrderType',
        'production_date' => 'setProductionDate',
        'free_values' => 'setFreeValues',
        'production_order_lines' => 'setProductionOrderLines'
    ];
    ...
    protected static $getters = [
        ...
        'comment' => 'getComment',
        'production_order_type' => 'getProductionOrderType',
        'production_date' => 'getProductionDate',
        'free_values' => 'getFreeValues',
        'production_order_lines' => 'getProductionOrderLines'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('production_order_type', $data ?? [], null);
        $this->setIfExists('production_date', $data ?? [], null);
        $this->setIfExists('free_values', $data ?? [], null);
        $this->setIfExists('production_order_lines', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['production_order_number'] === null) {
            $invalidProperties[] = "'production_order_number' can't be null";
        }
        if ((mb_strlen($this->container['production_order_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'production_order_number', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['production_order_lines'] === null) {
            $invalidProperties[] = "'production_order_lines' can't be null";
        }
     ...
     *
     * @param string $production_order_number production_order_number
     *
     * @return self
     */
    public function setProductionOrderNumber($production_order_number)
    {
        ...
        if ((mb_strlen($production_order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $production_order_number when calling PostProductionOrderModel., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets production_order_type
     *
     * @return \OngoingAPI\Model\GetArticleItemInfoStatus|null
     */
    public function getProductionOrderType()
    {
        return $this->container['production_order_type'];
    }

    /**
     * Sets production_order_type
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $production_order_type production_order_type
     *
     * @return self
     */
    public function setProductionOrderType($production_order_type)
    {
        if (is_null($production_order_type)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['production_order_type'] = $production_order_type;
     ...
     * Gets free_values
     *
     * @return \OngoingAPI\Model\PostProductionOrderModelFreeValues|null
     */
     ...
     * Sets free_values
     *
     * @param \OngoingAPI\Model\PostProductionOrderModelFreeValues|null $free_values free_values
     *
     * @return self
     */
    ...
    /**
     * Gets production_order_lines
     *
     * @return \OngoingAPI\Model\PostProductionOrderLine[]
     */
    public function getProductionOrderLines()
    {
        return $this->container['production_order_lines'];
    }

    /**
     * Sets production_order_lines
     *
     * @param \OngoingAPI\Model\PostProductionOrderLine[] $production_order_lines production_order_lines
     *
     * @return self
     */
    public function setProductionOrderLines($production_order_lines)
    {
        if (is_null($production_order_lines)) {
            throw new \InvalidArgumentException('non-nullable production_order_lines cannot be null');
        }
        $this->container['production_order_lines'] = $production_order_lines;
