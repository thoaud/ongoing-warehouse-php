...
/**
 * ArticleItemStatusModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class ArticleItemStatusModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleItemStatusModel';
    ...
    protected static $openAPITypes = [
        'article_item_statuses' => '\OngoingAPI\Model\GetArticleItemStatusModel[]'
    ];
    ...
    protected static $attributeMap = [
        'article_item_statuses' => 'articleItemStatuses'
    ];
    ...
    protected static $setters = [
        'article_item_statuses' => 'setArticleItemStatuses'
    ];
    ...
    protected static $getters = [
        'article_item_statuses' => 'getArticleItemStatuses'
    ];
    ...
    {
        $this->setIfExists('article_item_statuses', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets article_item_statuses
     *
     * @return \OngoingAPI\Model\GetArticleItemStatusModel[]|null
     */
    public function getArticleItemStatuses()
    {
        return $this->container['article_item_statuses'];
    }

    /**
     * Sets article_item_statuses
     *
     * @param \OngoingAPI\Model\GetArticleItemStatusModel[]|null $article_item_statuses article_item_statuses
     *
     * @return self
     */
    public function setArticleItemStatuses($article_item_statuses)
    {
        if (is_null($article_item_statuses)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_statuses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_statuses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_item_statuses'] = $article_item_statuses;
