<?php
/**
 * GetArticleModelStorageProperties
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetArticleModelStorageProperties Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleModelStorageProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel_storageProperties';
    ...
    protected static array $openAPINullables = [
        'is_obsolete' => false,
        'is_serial_number_article' => false,
        'is_batch_article' => false,
        'is_expiry_date_article' => false
    ];
    ...
    */
    ...
    public function setIsSerialNumberArticle($is_serial_number_article)
    {
        if (is_null($is_serial_number_article)) {
            throw new \InvalidArgumentException('non-nullable is_serial_number_article cannot be null');
        }
    ...
    public function setIsBatchArticle($is_batch_article)
    {
        if (is_null($is_batch_article)) {
            throw new \InvalidArgumentException('non-nullable is_batch_article cannot be null');
        }
    ...
    public function setIsExpiryDateArticle($is_expiry_date_article)
    {
        if (is_null($is_expiry_date_article)) {
            throw new \InvalidArgumentException('non-nullable is_expiry_date_article cannot be null');
        }
