...
/**
 * GetProductionOrderLineConsumedInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderLineConsumedInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderLineConsumedInfo';
    ...
    protected static $openAPITypes = [
        'produced_article_item_id' => 'int',
        'article' => '\OngoingAPI\Model\GetProductionOrderLineConsumedInfoArticle',
        'number_of_items' => 'float',
        'expiry_date' => '\DateTime',
        'serial' => 'string',
        'batch_number' => 'string',
        'weight' => 'float',
        'purchase_order_info' => '\OngoingAPI\Model\GetProductionOrderLineConsumedInfoPurchaseOrderInfo'
    ];
    ...
    protected static $openAPIFormats = [
        'produced_article_item_id' => 'int32',
        'article' => null,
    ...
    protected static $attributeMap = [
        'produced_article_item_id' => 'producedArticleItemId',
        'article' => 'article',
    ...
    protected static $setters = [
        'produced_article_item_id' => 'setProducedArticleItemId',
        'article' => 'setArticle',
    ...
    protected static $getters = [
        'produced_article_item_id' => 'getProducedArticleItemId',
        'article' => 'getArticle',
    ...
    {
        $this->setIfExists('produced_article_item_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets produced_article_item_id
     *
     * @return int|null
     */
    public function getProducedArticleItemId()
    {
        return $this->container['produced_article_item_id'];
    }

    /**
     * Sets produced_article_item_id
     *
     * @param int|null $produced_article_item_id produced_article_item_id
     *
     * @return self
     */
    public function setProducedArticleItemId($produced_article_item_id)
    {
        if (is_null($produced_article_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'produced_article_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('produced_article_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['produced_article_item_id'] = $produced_article_item_id;
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetProductionOrderLineConsumedInfoArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetProductionOrderLineConsumedInfoArticle|null $article article
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetProductionOrderLineConsumedInfoPurchaseOrderInfo|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetProductionOrderLineConsumedInfoPurchaseOrderInfo|null $purchase_order_info purchase_order_info
     *
     * @return self
     */
