...
/**
 * PatchPurchaseOrderReportedNumberOfItemsModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderReportedNumberOfItemsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderReportedNumberOfItemsModel';
    ...
    protected static array $openAPINullables = [
        'reported_number_of_items' => false
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reported_number_of_items'] === null) {
            $invalidProperties[] = "'reported_number_of_items' can't be null";
        }
     ...
     *
     * @param float $reported_number_of_items reported_number_of_items
     *
     * @return self
     */
    public function setReportedNumberOfItems($reported_number_of_items)
    {
        if (is_null($reported_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable reported_number_of_items cannot be null');
        }
