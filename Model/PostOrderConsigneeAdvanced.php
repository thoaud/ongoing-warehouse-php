...
/**
 * PostOrderConsigneeAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderConsigneeAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderConsignee_advanced';
    ...
    protected static $openAPITypes = [
        'telephone_notification' => '\OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification',
        'email_notification' => '\OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification',
        'sms_notification' => '\OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification',
    ...
    protected static $setters = [
        ...
        'external_customer_code' => 'setExternalCustomerCode'
    ];
    ...
    protected static $getters = [
        ...
        'external_customer_code' => 'getExternalCustomerCode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('external_customer_code', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification|null
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification|null $telephone_notification telephone_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification|null $email_notification email_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderConsigneeAddressAdvancedTelephoneNotification|null $sms_notification sms_notification
     *
     * @return self
     */
    ...
    /**
     * Gets external_customer_code
     *
     * @return string|null
     */
    public function getExternalCustomerCode()
    {
        return $this->container['external_customer_code'];
    }

    /**
     * Sets external_customer_code
     *
     * @param string|null $external_customer_code external_customer_code
     *
     * @return self
     */
    public function setExternalCustomerCode($external_customer_code)
    {
        if (is_null($external_customer_code)) {
            array_push($this->openAPINullablesSetToNull, 'external_customer_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_customer_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['external_customer_code'] = $external_customer_code;
