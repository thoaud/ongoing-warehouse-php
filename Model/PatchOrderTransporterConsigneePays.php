...
/**
 * PatchOrderTransporterConsigneePays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderTransporterConsigneePays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderTransporterConsigneePays';
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling PatchOrderTransporterConsigneePays., must be bigger than or equal to 1.');
        }
