<?php
/**
 * PostOrderConsigneeAddressAdvancedTelephoneNotification
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderConsigneeAddressAdvancedTelephoneNotification Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderConsigneeAddressAdvancedTelephoneNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderConsigneeAddressAdvanced_telephoneNotification';
    ...
    protected static $setters = [
        'to_be_notified' => 'setToBeNotified',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'to_be_notified' => 'getToBeNotified',
        'value' => 'getValue'
    ];
    ...
    {
        $this->setIfExists('to_be_notified', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['to_be_notified'];
    }

    /**
     * Sets to_be_notified
     *
     * @param bool|null $to_be_notified to_be_notified
     *
     * @return self
     */
    public function setToBeNotified($to_be_notified)
    {
        if (is_null($to_be_notified)) {
            throw new \InvalidArgumentException('non-nullable to_be_notified cannot be null');
        }
        $this->container['to_be_notified'] = $to_be_notified;
