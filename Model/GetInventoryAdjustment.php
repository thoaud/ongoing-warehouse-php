...
/**
 * GetInventoryAdjustment Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInventoryAdjustment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInventoryAdjustment';
    ...
    protected static $openAPITypes = [
        ...
        'article_item_comment' => 'string',
        'inventory_item_comment' => 'string',
        'inventory_adjustment_cause' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'location' => 'string',
        'batch_number' => 'string',
        'serial' => 'string',
        'article_item_status' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'expiry_date' => '\DateTime',
        'warehouse' => '\OngoingAPI\Model\GetInventoryAdjustmentWarehouse'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'inventory_time' => 'date-time',
        'article_item_comment' => null,
        'inventory_item_comment' => null,
        'inventory_adjustment_cause' => null,
        'location' => null,
        'batch_number' => null,
        'serial' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'article_item_comment' => true,
        'inventory_item_comment' => true,
        'inventory_adjustment_cause' => true,
        'location' => true,
        'batch_number' => true,
        'serial' => true,
    ...
    protected static $attributeMap = [
        ...
        'article_item_comment' => 'articleItemComment',
        'inventory_item_comment' => 'inventoryItemComment',
        'inventory_adjustment_cause' => 'inventoryAdjustmentCause',
        'location' => 'location',
    ...
    protected static $setters = [
        ...
        'inventory_time' => 'setInventoryTime',
        'article_item_comment' => 'setArticleItemComment',
        'inventory_item_comment' => 'setInventoryItemComment',
        'inventory_adjustment_cause' => 'setInventoryAdjustmentCause',
    ...
    protected static $getters = [
        ...
        'inventory_time' => 'getInventoryTime',
        'article_item_comment' => 'getArticleItemComment',
        'inventory_item_comment' => 'getInventoryItemComment',
        'inventory_adjustment_cause' => 'getInventoryAdjustmentCause',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inventory_time', $data ?? [], null);
        $this->setIfExists('article_item_comment', $data ?? [], null);
        $this->setIfExists('inventory_item_comment', $data ?? [], null);
        $this->setIfExists('inventory_adjustment_cause', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['inventory_time'];
    }

    /**
     * Sets inventory_time
     *
     * @param \DateTime|null $inventory_time inventory_time
     *
     * @return self
     */
    public function setInventoryTime($inventory_time)
    {
        if (is_null($inventory_time)) {
            throw new \InvalidArgumentException('non-nullable inventory_time cannot be null');
        }
        $this->container['inventory_time'] = $inventory_time;

        return $this;
    }

    /**
     * Gets article_item_comment
     *
     * @return string|null
     */
    public function getArticleItemComment()
    {
        return $this->container['article_item_comment'];
    }

    /**
     * Sets article_item_comment
     *
     * @param string|null $article_item_comment article_item_comment
     *
     * @return self
     */
    public function setArticleItemComment($article_item_comment)
    {
        if (is_null($article_item_comment)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_item_comment'] = $article_item_comment;

        return $this;
    }

    /**
     * Gets inventory_item_comment
     *
     * @return string|null
     */
    public function getInventoryItemComment()
    {
        return $this->container['inventory_item_comment'];
    }

    /**
     * Sets inventory_item_comment
     *
     * @param string|null $inventory_item_comment inventory_item_comment
     *
     * @return self
     */
    public function setInventoryItemComment($inventory_item_comment)
    {
        if (is_null($inventory_item_comment)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_item_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_item_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['inventory_item_comment'] = $inventory_item_comment;

        return $this;
    }

    /**
     * Gets inventory_adjustment_cause
     *
     * @return \OngoingAPI\Model\GetArticleItemInfoStatus|null
     */
    public function getInventoryAdjustmentCause()
    {
        return $this->container['inventory_adjustment_cause'];
    }

    /**
     * Sets inventory_adjustment_cause
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $inventory_adjustment_cause inventory_adjustment_cause
     *
     * @return self
     */
    public function setInventoryAdjustmentCause($inventory_adjustment_cause)
    {
        if (is_null($inventory_adjustment_cause)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_adjustment_cause');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_adjustment_cause', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['inventory_adjustment_cause'] = $inventory_adjustment_cause;
     ...
     * Gets warehouse
     *
     * @return \OngoingAPI\Model\GetInventoryAdjustmentWarehouse|null
     */
     ...
     * Sets warehouse
     *
     * @param \OngoingAPI\Model\GetInventoryAdjustmentWarehouse|null $warehouse warehouse
     *
     * @return self
     */
