...
/**
 * PostParcelUsingIdTypeModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostParcelUsingIdTypeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostParcelUsingIdTypeModel';
    ...
    protected static array $openAPINullables = [
        'parcel_number' => true,
        'transport_administration_type' => true,
        'advanced' => true,
        'tracking' => true
    ];
    ...
    */
     ...
     * Sets parcel_number
     *
     * @param string|null $parcel_number parcel_number
     *
     * @return self
     */
    public function setParcelNumber($parcel_number)
    {
        if (is_null($parcel_number)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_number', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $transport_administration_type transport_administration_type
     *
     * @return self
     */
    public function setTransportAdministrationType($transport_administration_type)
    {
        if (is_null($transport_administration_type)) {
            array_push($this->openAPINullablesSetToNull, 'transport_administration_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transport_administration_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
