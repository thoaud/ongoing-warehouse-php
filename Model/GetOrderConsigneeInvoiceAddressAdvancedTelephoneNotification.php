<?php
/**
 * GetOrderConsigneeInvoiceAddressAdvancedTelephoneNotification
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderConsigneeInvoiceAddressAdvancedTelephoneNotification Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderConsigneeInvoiceAddressAdvancedTelephoneNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderConsigneeInvoiceAddressAdvanced_telephoneNotification';
