...
/**
 * GetOrderInfoAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderInfoAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderInfo_advanced';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_date_with_time' => '\DateTime',
        'back_order_info' => '\OngoingAPI\Model\GetOrderInfoAdvancedBackOrderInfo',
        'order_header_updated' => '\DateTime',
        'transport_payment_type' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'delivery_date_with_time' => 'date-time',
        'back_order_info' => null,
        'order_header_updated' => 'date-time',
        'transport_payment_type' => null
    ];
    ...
    protected static array $openAPINullables = [
        'invoice_number' => true,
        'arrival_date' => true,
        'delivery_date_with_time' => false,
        'back_order_info' => true,
        'order_header_updated' => true,
        'transport_payment_type' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'delivery_date_with_time' => 'deliveryDateWithTime',
        'back_order_info' => 'backOrderInfo',
        'order_header_updated' => 'orderHeaderUpdated',
        'transport_payment_type' => 'transportPaymentType'
    ];
    ...
    protected static $setters = [
        ...
        'delivery_date_with_time' => 'setDeliveryDateWithTime',
        'back_order_info' => 'setBackOrderInfo',
        'order_header_updated' => 'setOrderHeaderUpdated',
        'transport_payment_type' => 'setTransportPaymentType'
    ];
    ...
    protected static $getters = [
        ...
        'delivery_date_with_time' => 'getDeliveryDateWithTime',
        'back_order_info' => 'getBackOrderInfo',
        'order_header_updated' => 'getOrderHeaderUpdated',
        'transport_payment_type' => 'getTransportPaymentType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delivery_date_with_time', $data ?? [], null);
        $this->setIfExists('back_order_info', $data ?? [], null);
        $this->setIfExists('order_header_updated', $data ?? [], null);
        $this->setIfExists('transport_payment_type', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets delivery_date_with_time
     *
     * @return \DateTime|null
     */
    public function getDeliveryDateWithTime()
    {
        return $this->container['delivery_date_with_time'];
    }

    /**
     * Sets delivery_date_with_time
     *
     * @param \DateTime|null $delivery_date_with_time delivery_date_with_time
     *
     * @return self
     */
    public function setDeliveryDateWithTime($delivery_date_with_time)
    {
        if (is_null($delivery_date_with_time)) {
            throw new \InvalidArgumentException('non-nullable delivery_date_with_time cannot be null');
        }
        $this->container['delivery_date_with_time'] = $delivery_date_with_time;

        return $this;
    }

    /**
     * Gets back_order_info
     *
     * @return \OngoingAPI\Model\GetOrderInfoAdvancedBackOrderInfo|null
     */
    public function getBackOrderInfo()
    {
        return $this->container['back_order_info'];
    }

    /**
     * Sets back_order_info
     *
     * @param \OngoingAPI\Model\GetOrderInfoAdvancedBackOrderInfo|null $back_order_info back_order_info
     *
     * @return self
     */
    public function setBackOrderInfo($back_order_info)
    {
        if (is_null($back_order_info)) {
            array_push($this->openAPINullablesSetToNull, 'back_order_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('back_order_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['back_order_info'] = $back_order_info;

        return $this;
    }

    /**
     * Gets order_header_updated
     *
     * @return \DateTime|null
     */
    public function getOrderHeaderUpdated()
    {
        return $this->container['order_header_updated'];
    }

    /**
     * Sets order_header_updated
     *
     * @param \DateTime|null $order_header_updated order_header_updated
     *
     * @return self
     */
    public function setOrderHeaderUpdated($order_header_updated)
    {
        if (is_null($order_header_updated)) {
            array_push($this->openAPINullablesSetToNull, 'order_header_updated');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_header_updated', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['order_header_updated'] = $order_header_updated;

        return $this;
    }

    /**
     * Gets transport_payment_type
     *
     * @return string|null
     */
    public function getTransportPaymentType()
    {
        return $this->container['transport_payment_type'];
    }

    /**
     * Sets transport_payment_type
     *
     * @param string|null $transport_payment_type transport_payment_type
     *
     * @return self
     */
    public function setTransportPaymentType($transport_payment_type)
    {
        if (is_null($transport_payment_type)) {
            array_push($this->openAPINullablesSetToNull, 'transport_payment_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transport_payment_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transport_payment_type'] = $transport_payment_type;
