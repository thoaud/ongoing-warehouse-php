...
/**
 * PostOrderConsignee Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderConsignee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderConsignee';
    ...
    protected static $openAPITypes = [
        ...
        'remark' => 'string',
        'door_code' => 'string',
        'advanced' => '\OngoingAPI\Model\PostOrderConsigneeAdvanced',
        'invoice_address' => '\OngoingAPI\Model\PostOrderConsigneeInvoiceAddress',
        'organisation_number' => 'string',
        'vat_number' => 'string',
        'customer_group' => '\OngoingAPI\Model\GetArticleItemInfoStatus'
    ];
    ...
    */
    ...
    public function setDoorCode($door_code)
    {
        if (is_null($door_code)) {
            array_push($this->openAPINullablesSetToNull, 'door_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('door_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\PostOrderConsigneeAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\PostOrderConsigneeAdvanced|null $advanced advanced
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\PostOrderConsigneeInvoiceAddress|null
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderConsigneeInvoiceAddress|null $invoice_address invoice_address
     *
     * @return self
     */
    ...
    public function setOrganisationNumber($organisation_number)
    {
        if (is_null($organisation_number)) {
            array_push($this->openAPINullablesSetToNull, 'organisation_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('organisation_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets customer_group
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $customer_group customer_group
     *
     * @return self
     */
