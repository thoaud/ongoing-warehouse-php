...
/**
 * PostParcelTypeModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostParcelTypeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostParcelTypeModel';
    ...
    protected static $openAPITypes = [
        ...
        'transport_administration_type' => 'string',
        'advanced' => '\OngoingAPI\Model\PostParcelTypeModelAdvanced',
        'tracking' => '\OngoingAPI\Model\PostParcelTypeModelTracking'
    ];
    ...
    protected static $openAPIFormats = [
        'parcel_number' => null,
        'transport_administration_type' => null,
        'advanced' => null,
        'tracking' => null
    ];
    ...
    protected static array $openAPINullables = [
        'parcel_number' => false,
        'transport_administration_type' => false,
        'advanced' => true,
        'tracking' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'transport_administration_type' => 'transportAdministrationType',
        'advanced' => 'advanced',
        'tracking' => 'tracking'
    ];
    ...
    protected static $setters = [
        ...
        'transport_administration_type' => 'setTransportAdministrationType',
    ...
    protected static $getters = [
        ...
        'transport_administration_type' => 'getTransportAdministrationType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transport_administration_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['parcel_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'parcel_number', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['transport_administration_type'] === null) {
            $invalidProperties[] = "'transport_administration_type' can't be null";
        }
        if ((mb_strlen($this->container['transport_administration_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'transport_administration_type', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets parcel_number
     *
     * @param string $parcel_number parcel_number
     *
     * @return self
     */
    public function setParcelNumber($parcel_number)
    {
        ...
        if ((mb_strlen($parcel_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcel_number when calling PostParcelTypeModel., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets transport_administration_type
     *
     * @return string
     */
    public function getTransportAdministrationType()
    {
        return $this->container['transport_administration_type'];
    }

    /**
     * Sets transport_administration_type
     *
     * @param string $transport_administration_type transport_administration_type
     *
     * @return self
     */
    public function setTransportAdministrationType($transport_administration_type)
    {
        if (is_null($transport_administration_type)) {
            throw new \InvalidArgumentException('non-nullable transport_administration_type cannot be null');
        }

        if ((mb_strlen($transport_administration_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transport_administration_type when calling PostParcelTypeModel., must be bigger than or equal to 1.');
        }

        $this->container['transport_administration_type'] = $transport_administration_type;
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\PostParcelTypeModelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\PostParcelTypeModelAdvanced|null $advanced advanced
     *
     * @return self
     */
     ...
     * Gets tracking
     *
     * @return \OngoingAPI\Model\PostParcelTypeModelTracking|null
     */
     ...
     * Sets tracking
     *
     * @param \OngoingAPI\Model\PostParcelTypeModelTracking|null $tracking tracking
     *
     * @return self
     */
