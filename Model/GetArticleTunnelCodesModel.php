...
/**
 * GetArticleTunnelCodesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleTunnelCodesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleTunnelCodesModel';
    ...
    protected static $setters = [
        'un_tunnel_code' => 'setUnTunnelCode'
    ];
    ...
    protected static $getters = [
        'un_tunnel_code' => 'getUnTunnelCode'
    ];
    ...
    {
        $this->setIfExists('un_tunnel_code', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['un_tunnel_code'];
    }

    /**
     * Sets un_tunnel_code
     *
     * @param string|null $un_tunnel_code un_tunnel_code
     *
     * @return self
     */
    public function setUnTunnelCode($un_tunnel_code)
    {
        if (is_null($un_tunnel_code)) {
            array_push($this->openAPINullablesSetToNull, 'un_tunnel_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('un_tunnel_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['un_tunnel_code'] = $un_tunnel_code;
