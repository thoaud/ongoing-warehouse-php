...
/**
 * PostPurchaseOrderArticleItemModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemModel';
    ...
    protected static $openAPITypes = [
        ...
        'advanced' => '\OngoingAPI\Model\PostPurchaseOrderArticleItemModelAdvanced'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['purchase_order_line_id'] === null) {
            $invalidProperties[] = "'purchase_order_line_id' can't be null";
        }
     ...
     *
     * @param int $purchase_order_line_id purchase_order_line_id
     *
     * @return self
     */
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderArticleItemModelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderArticleItemModelAdvanced|null $advanced advanced
     *
     * @return self
     */
