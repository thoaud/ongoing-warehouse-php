...
/**
 * PatchOrderNumberModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderNumberModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderNumberModel';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['order_number']) > 50)) {
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if ((mb_strlen($order_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling PatchOrderNumberModel., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling PatchOrderNumberModel., must be bigger than or equal to 1.');
        }
