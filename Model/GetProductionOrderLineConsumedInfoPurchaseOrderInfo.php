<?php
/**
 * GetProductionOrderLineConsumedInfoPurchaseOrderInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetProductionOrderLineConsumedInfoPurchaseOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderLineConsumedInfoPurchaseOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderLineConsumedInfo_purchaseOrderInfo';
