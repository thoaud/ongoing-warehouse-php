...
/**
 * GetMovementModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetMovementModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetMovementModel';
    ...
    protected static $openAPITypes = [
        'article' => '\OngoingAPI\Model\GetMovementModelArticle',
        'number_of_items' => 'float',
        'serial' => 'string',
        'batch_number' => 'string',
        'expiry_date' => '\DateTime',
        'purchase_order_info' => '\OngoingAPI\Model\GetMovementModelPurchaseOrderInfo',
        'move_time' => '\DateTime',
        'from_location' => '\OngoingAPI\Model\GetMovementModelFromLocation',
        'to_location' => '\OngoingAPI\Model\GetMovementModelFromLocation',
        'from_warehouse' => '\OngoingAPI\Model\GetMovementModelFromWarehouse',
        'to_warehouse' => '\OngoingAPI\Model\GetMovementModelFromWarehouse',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('from_location', $data ?? [], null);
    ...
    */
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetMovementModelArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetMovementModelArticle|null $article article
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetMovementModelPurchaseOrderInfo|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetMovementModelPurchaseOrderInfo|null $purchase_order_info purchase_order_info
     *
     * @return self
     */
     ...
     * Sets move_time
     *
     * @param \DateTime|null $move_time move_time
     *
     * @return self
     */
    public function setMoveTime($move_time)
    {
        if (is_null($move_time)) {
            array_push($this->openAPINullablesSetToNull, 'move_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('move_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets from_location
     *
     * @return \OngoingAPI\Model\GetMovementModelFromLocation|null
     */
    public function getFromLocation()
    {
        return $this->container['from_location'];
    }

    /**
     * Sets from_location
     *
     * @param \OngoingAPI\Model\GetMovementModelFromLocation|null $from_location from_location
     *
     * @return self
     */
    public function setFromLocation($from_location)
    {
        if (is_null($from_location)) {
            array_push($this->openAPINullablesSetToNull, 'from_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('from_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['from_location'] = $from_location;
     ...
     * Sets to_location
     *
     * @param \OngoingAPI\Model\GetMovementModelFromLocation|null $to_location to_location
     *
     * @return self
     */
    public function setToLocation($to_location)
    {
        if (is_null($to_location)) {
            array_push($this->openAPINullablesSetToNull, 'to_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets from_warehouse
     *
     * @return \OngoingAPI\Model\GetMovementModelFromWarehouse|null
     */
     ...
     * Sets from_warehouse
     *
     * @param \OngoingAPI\Model\GetMovementModelFromWarehouse|null $from_warehouse from_warehouse
     *
     * @return self
     */
    public function setFromWarehouse($from_warehouse)
    {
        if (is_null($from_warehouse)) {
            array_push($this->openAPINullablesSetToNull, 'from_warehouse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('from_warehouse', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets to_warehouse
     *
     * @param \OngoingAPI\Model\GetMovementModelFromWarehouse|null $to_warehouse to_warehouse
     *
     * @return self
     */
    public function setToWarehouse($to_warehouse)
    {
        if (is_null($to_warehouse)) {
            array_push($this->openAPINullablesSetToNull, 'to_warehouse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_warehouse', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
