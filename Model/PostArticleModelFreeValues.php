...
/**
 * PostArticleModelFreeValues Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelFreeValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_freeValues';
    ...
    protected static $openAPIFormats = [
        'free_decimal1' => 'decimal',
        'free_decimal2' => 'decimal',
        'free_decimal3' => 'decimal',
        'free_boolean1' => null,
        'free_boolean2' => null,
        'free_boolean3' => null,
        'free_text1' => null,
    ...
    protected static $attributeMap = [
        'free_decimal1' => 'freeDecimal1',
        'free_decimal2' => 'freeDecimal2',
        'free_decimal3' => 'freeDecimal3',
        'free_boolean1' => 'freeBoolean1',
        'free_boolean2' => 'freeBoolean2',
        'free_boolean3' => 'freeBoolean3',
        'free_text1' => 'freeText1',
        'free_text2' => 'freeText2',
        'free_text3' => 'freeText3',
        'free_text4' => 'freeText4',
        'free_text5' => 'freeText5',
        'free_text6' => 'freeText6',
        'free_text7' => 'freeText7',
        'free_text8' => 'freeText8',
        'free_date_time1' => 'freeDateTime1'
    ];
    ...
    protected static $setters = [
        'free_decimal1' => 'setFreeDecimal1',
        'free_decimal2' => 'setFreeDecimal2',
        'free_decimal3' => 'setFreeDecimal3',
        'free_boolean1' => 'setFreeBoolean1',
        'free_boolean2' => 'setFreeBoolean2',
        'free_boolean3' => 'setFreeBoolean3',
        'free_text1' => 'setFreeText1',
        'free_text2' => 'setFreeText2',
        'free_text3' => 'setFreeText3',
        'free_text4' => 'setFreeText4',
        'free_text5' => 'setFreeText5',
        'free_text6' => 'setFreeText6',
        'free_text7' => 'setFreeText7',
        'free_text8' => 'setFreeText8',
        'free_date_time1' => 'setFreeDateTime1'
    ];
    ...
    protected static $getters = [
        'free_decimal1' => 'getFreeDecimal1',
        'free_decimal2' => 'getFreeDecimal2',
        'free_decimal3' => 'getFreeDecimal3',
        'free_boolean1' => 'getFreeBoolean1',
        'free_boolean2' => 'getFreeBoolean2',
        'free_boolean3' => 'getFreeBoolean3',
        'free_text1' => 'getFreeText1',
        'free_text2' => 'getFreeText2',
        'free_text3' => 'getFreeText3',
        'free_text4' => 'getFreeText4',
        'free_text5' => 'getFreeText5',
        'free_text6' => 'getFreeText6',
        'free_text7' => 'getFreeText7',
        'free_text8' => 'getFreeText8',
        'free_date_time1' => 'getFreeDateTime1'
    ];
    ...
    {
        $this->setIfExists('free_decimal1', $data ?? [], null);
        $this->setIfExists('free_decimal2', $data ?? [], null);
        $this->setIfExists('free_decimal3', $data ?? [], null);
        $this->setIfExists('free_boolean1', $data ?? [], null);
        $this->setIfExists('free_boolean2', $data ?? [], null);
        $this->setIfExists('free_boolean3', $data ?? [], null);
        $this->setIfExists('free_text1', $data ?? [], null);
        $this->setIfExists('free_text2', $data ?? [], null);
        $this->setIfExists('free_text3', $data ?? [], null);
        $this->setIfExists('free_text4', $data ?? [], null);
        $this->setIfExists('free_text5', $data ?? [], null);
        $this->setIfExists('free_text6', $data ?? [], null);
        $this->setIfExists('free_text7', $data ?? [], null);
        $this->setIfExists('free_text8', $data ?? [], null);
        $this->setIfExists('free_date_time1', $data ?? [], null);
    }
    ...
    */
     ...
     * @return float|null
     */
    public function getFreeDecimal1()
    {
        return $this->container['free_decimal1'];
    }

    /**
     * Sets free_decimal1
     *
     * @param float|null $free_decimal1 free_decimal1
     *
     * @return self
     */
    public function setFreeDecimal1($free_decimal1)
    {
        if (is_null($free_decimal1)) {
            array_push($this->openAPINullablesSetToNull, 'free_decimal1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_decimal1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_decimal1'] = $free_decimal1;
     ...
     * @return float|null
     */
    public function getFreeDecimal2()
    {
        return $this->container['free_decimal2'];
    }

    /**
     * Sets free_decimal2
     *
     * @param float|null $free_decimal2 free_decimal2
     *
     * @return self
     */
    public function setFreeDecimal2($free_decimal2)
    {
        if (is_null($free_decimal2)) {
            array_push($this->openAPINullablesSetToNull, 'free_decimal2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_decimal2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_decimal2'] = $free_decimal2;
     ...
     * @return float|null
     */
    public function getFreeDecimal3()
    {
        return $this->container['free_decimal3'];
    }

    /**
     * Sets free_decimal3
     *
     * @param float|null $free_decimal3 free_decimal3
     *
     * @return self
     */
    public function setFreeDecimal3($free_decimal3)
    {
        if (is_null($free_decimal3)) {
            array_push($this->openAPINullablesSetToNull, 'free_decimal3');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_decimal3', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_decimal3'] = $free_decimal3;
     ...
     * @return bool|null
     */
    public function getFreeBoolean1()
    {
        return $this->container['free_boolean1'];
    }

    /**
     * Sets free_boolean1
     *
     * @param bool|null $free_boolean1 free_boolean1
     *
     * @return self
     */
    public function setFreeBoolean1($free_boolean1)
    {
        if (is_null($free_boolean1)) {
            array_push($this->openAPINullablesSetToNull, 'free_boolean1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_boolean1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_boolean1'] = $free_boolean1;
     ...
     * @return bool|null
     */
    public function getFreeBoolean2()
    {
        return $this->container['free_boolean2'];
    }

    /**
     * Sets free_boolean2
     *
     * @param bool|null $free_boolean2 free_boolean2
     *
     * @return self
     */
    public function setFreeBoolean2($free_boolean2)
    {
        if (is_null($free_boolean2)) {
            array_push($this->openAPINullablesSetToNull, 'free_boolean2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_boolean2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_boolean2'] = $free_boolean2;
     ...
     * @return bool|null
     */
    public function getFreeBoolean3()
    {
        return $this->container['free_boolean3'];
    }

    /**
     * Sets free_boolean3
     *
     * @param bool|null $free_boolean3 free_boolean3
     *
     * @return self
     */
    public function setFreeBoolean3($free_boolean3)
    {
        if (is_null($free_boolean3)) {
            array_push($this->openAPINullablesSetToNull, 'free_boolean3');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_boolean3', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_boolean3'] = $free_boolean3;
    ...
    {
        return $this->container['free_text4'];
    }

    /**
     * Sets free_text4
     *
     * @param string|null $free_text4 free_text4
     *
     * @return self
     */
    public function setFreeText4($free_text4)
    {
        if (is_null($free_text4)) {
            array_push($this->openAPINullablesSetToNull, 'free_text4');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_text4', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_text4'] = $free_text4;
    ...
    {
        return $this->container['free_text5'];
    }

    /**
     * Sets free_text5
     *
     * @param string|null $free_text5 free_text5
     *
     * @return self
     */
    public function setFreeText5($free_text5)
    {
        if (is_null($free_text5)) {
            array_push($this->openAPINullablesSetToNull, 'free_text5');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_text5', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_text5'] = $free_text5;
     ...
     * @return string|null
     */
    public function getFreeText6()
    {
        return $this->container['free_text6'];
    }

    /**
     * Sets free_text6
     *
     * @param string|null $free_text6 free_text6
     *
     * @return self
     */
    public function setFreeText6($free_text6)
    {
        if (is_null($free_text6)) {
            array_push($this->openAPINullablesSetToNull, 'free_text6');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_text6', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_text6'] = $free_text6;
     ...
     * @return string|null
     */
    public function getFreeText7()
    {
        return $this->container['free_text7'];
    }

    /**
     * Sets free_text7
     *
     * @param string|null $free_text7 free_text7
     *
     * @return self
     */
    public function setFreeText7($free_text7)
    {
        if (is_null($free_text7)) {
            array_push($this->openAPINullablesSetToNull, 'free_text7');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_text7', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_text7'] = $free_text7;
     ...
     * @return string|null
     */
    public function getFreeText8()
    {
        return $this->container['free_text8'];
    }

    /**
     * Sets free_text8
     *
     * @param string|null $free_text8 free_text8
     *
     * @return self
     */
    public function setFreeText8($free_text8)
    {
        if (is_null($free_text8)) {
            array_push($this->openAPINullablesSetToNull, 'free_text8');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_text8', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_text8'] = $free_text8;

        return $this;
    }

    /**
     * Gets free_date_time1
     *
     * @return \DateTime|null
     */
    public function getFreeDateTime1()
    {
        return $this->container['free_date_time1'];
    }

    /**
     * Sets free_date_time1
     *
     * @param \DateTime|null $free_date_time1 free_date_time1
     *
     * @return self
     */
    public function setFreeDateTime1($free_date_time1)
    {
        if (is_null($free_date_time1)) {
            array_push($this->openAPINullablesSetToNull, 'free_date_time1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('free_date_time1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['free_date_time1'] = $free_date_time1;
