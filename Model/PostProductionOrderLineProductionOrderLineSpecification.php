<?php
/**
 * PostProductionOrderLineProductionOrderLineSpecification
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostProductionOrderLineProductionOrderLineSpecification Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostProductionOrderLineProductionOrderLineSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostProductionOrderLine_productionOrderLineSpecification';
    ...
    protected static $openAPITypes = [
        'to_consume' => '\OngoingAPI\Model\PostProductionOrderLineSpecificationArticleLine[]'
    ];
    ...
    {
        $this->setIfExists('to_consume', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets to_consume
     *
     * @return \OngoingAPI\Model\PostProductionOrderLineSpecificationArticleLine[]|null
     */
    public function getToConsume()
    {
        return $this->container['to_consume'];
    }

    /**
     * Sets to_consume
     *
     * @param \OngoingAPI\Model\PostProductionOrderLineSpecificationArticleLine[]|null $to_consume to_consume
     *
     * @return self
     */
    public function setToConsume($to_consume)
    {
        if (is_null($to_consume)) {
            array_push($this->openAPINullablesSetToNull, 'to_consume');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_consume', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['to_consume'] = $to_consume;
