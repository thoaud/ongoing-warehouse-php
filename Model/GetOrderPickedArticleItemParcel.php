<?php
/**
 * GetOrderPickedArticleItemParcel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderPickedArticleItemParcel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickedArticleItemParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickedArticleItem_parcel';
    ...
    protected static $openAPITypes = [
        ...
        'parcel_type' => '\OngoingAPI\Model\GetPickedArticleItemParcelParcelType',
        'advanced' => '\OngoingAPI\Model\GetPickedArticleItemParcelAdvanced',
        'parent_parcel' => '\OngoingAPI\Model\GetPickedArticleItemParcelParentParcel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parent_parcel', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets parcel_type
     *
     * @return \OngoingAPI\Model\GetPickedArticleItemParcelParcelType|null
     */
     ...
     * Sets parcel_type
     *
     * @param \OngoingAPI\Model\GetPickedArticleItemParcelParcelType|null $parcel_type parcel_type
     *
     * @return self
     */
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\GetPickedArticleItemParcelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\GetPickedArticleItemParcelAdvanced|null $advanced advanced
     *
     * @return self
     */
     ...
     * Gets parent_parcel
     *
     * @return \OngoingAPI\Model\GetPickedArticleItemParcelParentParcel|null
     */
    public function getParentParcel()
    {
        return $this->container['parent_parcel'];
    }

    /**
     * Sets parent_parcel
     *
     * @param \OngoingAPI\Model\GetPickedArticleItemParcelParentParcel|null $parent_parcel parent_parcel
     *
     * @return self
     */
    public function setParentParcel($parent_parcel)
    {
        if (is_null($parent_parcel)) {
            array_push($this->openAPINullablesSetToNull, 'parent_parcel');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parent_parcel', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parent_parcel'] = $parent_parcel;
