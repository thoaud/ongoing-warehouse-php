...
/**
 * PatchOrderReturnWaybill Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderReturnWaybill implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderReturnWaybill';
    ...
    protected static $setters = [
        'return_waybill' => 'setReturnWaybill'
    ];
    ...
    protected static $getters = [
        'return_waybill' => 'getReturnWaybill'
    ];
    ...
    {
        $this->setIfExists('return_waybill', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['return_waybill'] === null) {
            $invalidProperties[] = "'return_waybill' can't be null";
        }
        if ((mb_strlen($this->container['return_waybill']) > 50)) {
            $invalidProperties[] = "invalid value for 'return_waybill', the character length must be smaller than or equal to 50.";
        }

        if ((mb_strlen($this->container['return_waybill']) < 1)) {
            $invalidProperties[] = "invalid value for 'return_waybill', the character length must be bigger than or equal to 1.";
        }
    ...
    {
        return $this->container['return_waybill'];
    }

    /**
     * Sets return_waybill
     *
     * @param string $return_waybill return_waybill
     *
     * @return self
     */
    public function setReturnWaybill($return_waybill)
    {
        if (is_null($return_waybill)) {
            throw new \InvalidArgumentException('non-nullable return_waybill cannot be null');
        }
        if ((mb_strlen($return_waybill) > 50)) {
            throw new \InvalidArgumentException('invalid length for $return_waybill when calling PatchOrderReturnWaybill., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($return_waybill) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_waybill when calling PatchOrderReturnWaybill., must be bigger than or equal to 1.');
        }

        $this->container['return_waybill'] = $return_waybill;
