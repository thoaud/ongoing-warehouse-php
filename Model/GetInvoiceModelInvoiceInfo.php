...
/**
 * GetInvoiceModelInvoiceInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceModelInvoiceInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceModel_invoiceInfo';
    ...
    protected static $openAPITypes = [
        ...
        'is_exported' => 'bool',
        'invoice_your_order_number' => 'string',
        'invoice_your_reference' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'invoice_period_start' => 'date-time',
        'invoice_period_end' => 'date-time',
        'invoice_amount' => 'decimal',
        'is_exported' => null,
        'invoice_your_order_number' => null,
        'invoice_your_reference' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'is_exported' => false,
        'invoice_your_order_number' => true,
        'invoice_your_reference' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'invoice_your_order_number' => 'invoiceYourOrderNumber',
        'invoice_your_reference' => 'invoiceYourReference'
    ];
    ...
    protected static $setters = [
        ...
        'invoice_your_order_number' => 'setInvoiceYourOrderNumber',
        'invoice_your_reference' => 'setInvoiceYourReference'
    ];
    ...
    protected static $getters = [
        ...
        'invoice_your_order_number' => 'getInvoiceYourOrderNumber',
        'invoice_your_reference' => 'getInvoiceYourReference'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_exported', $data ?? [], null);
        $this->setIfExists('invoice_your_order_number', $data ?? [], null);
        $this->setIfExists('invoice_your_reference', $data ?? [], null);
    }
    ...
    */
    ...
    public function setInvoicePeriodStart($invoice_period_start)
    {
        if (is_null($invoice_period_start)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_period_start');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_period_start', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setInvoicePeriodEnd($invoice_period_end)
    {
        if (is_null($invoice_period_end)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_period_end');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_period_end', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_exported
     *
     * @param bool|null $is_exported is_exported
     *
     * @return self
     */
    public function setIsExported($is_exported)
    {
        if (is_null($is_exported)) {
            throw new \InvalidArgumentException('non-nullable is_exported cannot be null');
        }
    ...
    /**
     * Gets invoice_your_order_number
     *
     * @return string|null
     */
    public function getInvoiceYourOrderNumber()
    {
        return $this->container['invoice_your_order_number'];
    }

    /**
     * Sets invoice_your_order_number
     *
     * @param string|null $invoice_your_order_number invoice_your_order_number
     *
     * @return self
     */
    public function setInvoiceYourOrderNumber($invoice_your_order_number)
    {
        if (is_null($invoice_your_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_your_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_your_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['invoice_your_order_number'] = $invoice_your_order_number;

        return $this;
    }

    /**
     * Gets invoice_your_reference
     *
     * @return string|null
     */
    public function getInvoiceYourReference()
    {
        return $this->container['invoice_your_reference'];
    }

    /**
     * Sets invoice_your_reference
     *
     * @param string|null $invoice_your_reference invoice_your_reference
     *
     * @return self
     */
    public function setInvoiceYourReference($invoice_your_reference)
    {
        if (is_null($invoice_your_reference)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_your_reference');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_your_reference', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['invoice_your_reference'] = $invoice_your_reference;
