...
/**
 * GetPurchaseOrderArticleItem Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPurchaseOrderArticleItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPurchaseOrderArticleItem';
    ...
    protected static $openAPITypes = [
        ...
        'received_by_user' => '\OngoingAPI\Model\GetPurchaseOrderArticleItemReceivedByUser',
        'is_locked' => 'bool',
        'is_locked_for_sale' => 'bool',
        'article_item_free_text1' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'article_item_free_text1' => 'articleItemFreeText1'
    ];
    ...
    protected static $setters = [
        ...
        'received_by_user' => 'setReceivedByUser',
        'is_locked' => 'setIsLocked',
        'is_locked_for_sale' => 'setIsLockedForSale',
        'article_item_free_text1' => 'setArticleItemFreeText1'
    ];
    ...
    protected static $getters = [
        ...
        'received_by_user' => 'getReceivedByUser',
        'is_locked' => 'getIsLocked',
        'is_locked_for_sale' => 'getIsLockedForSale',
        'article_item_free_text1' => 'getArticleItemFreeText1'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('received_by_user', $data ?? [], null);
        $this->setIfExists('is_locked', $data ?? [], null);
        $this->setIfExists('is_locked_for_sale', $data ?? [], null);
        $this->setIfExists('article_item_free_text1', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets received_by_user
     *
     * @return \OngoingAPI\Model\GetPurchaseOrderArticleItemReceivedByUser|null
     */
    public function getReceivedByUser()
    {
        return $this->container['received_by_user'];
    }

    /**
     * Sets received_by_user
     *
     * @param \OngoingAPI\Model\GetPurchaseOrderArticleItemReceivedByUser|null $received_by_user received_by_user
     *
     * @return self
     */
    public function setReceivedByUser($received_by_user)
    {
        if (is_null($received_by_user)) {
            array_push($this->openAPINullablesSetToNull, 'received_by_user');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('received_by_user', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['received_by_user'] = $received_by_user;
    ...
    /**
     * Gets article_item_free_text1
     *
     * @return string|null
     */
    public function getArticleItemFreeText1()
    {
        return $this->container['article_item_free_text1'];
    }

    /**
     * Sets article_item_free_text1
     *
     * @param string|null $article_item_free_text1 article_item_free_text1
     *
     * @return self
     */
    public function setArticleItemFreeText1($article_item_free_text1)
    {
        if (is_null($article_item_free_text1)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_free_text1');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_free_text1', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_item_free_text1'] = $article_item_free_text1;
