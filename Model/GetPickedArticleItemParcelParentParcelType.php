<?php
/**
 * GetPickedArticleItemParcelParentParcelType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetPickedArticleItemParcelParentParcelType Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPickedArticleItemParcelParentParcelType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPickedArticleItemParcelParent_parcelType';
