<?php
/**
 * PostOrderConsigneeInvoiceAddressAdvancedTelephoneNotification
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderConsigneeInvoiceAddressAdvancedTelephoneNotification Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderConsigneeInvoiceAddressAdvancedTelephoneNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderConsigneeInvoiceAddressAdvanced_telephoneNotification';
