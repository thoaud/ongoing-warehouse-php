<?php
/**
 * GetReturnOrderModelReturnOrderInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetReturnOrderModelReturnOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnOrderModelReturnOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnOrderModel_returnOrderInfo';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'in_date' => '\DateTime',
        'return_order_status' => '\OngoingAPI\Model\GetReturnOrderInfoReturnOrderStatus',
        'warehouse' => '\OngoingAPI\Model\GetReturnOrderInfoWarehouse',
        'return_order_handling_comment' => 'string',
        'free_values' => '\OngoingAPI\Model\GetReturnOrderInfoFreeValues',
        'created_date' => '\DateTime',
        'return_order_arrival_time' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'warehouse' => null,
        'return_order_handling_comment' => null,
        'free_values' => null,
        'created_date' => 'date-time',
        'return_order_arrival_time' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'return_order_number' => true,
        'comment' => true,
        'in_date' => true,
        'return_order_status' => true,
        'warehouse' => true,
        'return_order_handling_comment' => true,
        'free_values' => true,
        'created_date' => false,
        'return_order_arrival_time' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'warehouse' => 'warehouse',
        'return_order_handling_comment' => 'returnOrderHandlingComment',
        'free_values' => 'freeValues',
        'created_date' => 'createdDate',
        'return_order_arrival_time' => 'returnOrderArrivalTime'
    ];
    ...
    protected static $setters = [
        ...
        'return_order_handling_comment' => 'setReturnOrderHandlingComment',
        'free_values' => 'setFreeValues',
        'created_date' => 'setCreatedDate',
        'return_order_arrival_time' => 'setReturnOrderArrivalTime'
    ];
    ...
    protected static $getters = [
        ...
        'return_order_handling_comment' => 'getReturnOrderHandlingComment',
        'free_values' => 'getFreeValues',
        'created_date' => 'getCreatedDate',
        'return_order_arrival_time' => 'getReturnOrderArrivalTime'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_order_number', $data ?? [], null);
        $this->setIfExists('comment', $data ?? [], null);
        $this->setIfExists('in_date', $data ?? [], null);
        $this->setIfExists('return_order_status', $data ?? [], null);
        $this->setIfExists('warehouse', $data ?? [], null);
        $this->setIfExists('return_order_handling_comment', $data ?? [], null);
        $this->setIfExists('free_values', $data ?? [], null);
        $this->setIfExists('created_date', $data ?? [], null);
        $this->setIfExists('return_order_arrival_time', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $return_order_id return_order_id
     *
     * @return self
     */
     ...
     *
     * @param string|null $return_order_number return_order_number
     *
     * @return self
     */
    public function setReturnOrderNumber($return_order_number)
    {
        if (is_null($return_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @return \OngoingAPI\Model\GetReturnOrderInfoReturnOrderStatus|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetReturnOrderInfoReturnOrderStatus|null $return_order_status return_order_status
     *
     * @return self
     */
    public function setReturnOrderStatus($return_order_status)
    {
        if (is_null($return_order_status)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets warehouse
     *
     * @return \OngoingAPI\Model\GetReturnOrderInfoWarehouse|null
     */
     ...
     * Sets warehouse
     *
     * @param \OngoingAPI\Model\GetReturnOrderInfoWarehouse|null $warehouse warehouse
     *
     * @return self
     */
    ...
    /**
     * Gets return_order_handling_comment
     *
     * @return string|null
     */
    public function getReturnOrderHandlingComment()
    {
        return $this->container['return_order_handling_comment'];
    }

    /**
     * Sets return_order_handling_comment
     *
     * @param string|null $return_order_handling_comment return_order_handling_comment
     *
     * @return self
     */
    public function setReturnOrderHandlingComment($return_order_handling_comment)
    {
        if (is_null($return_order_handling_comment)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_handling_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_handling_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_handling_comment'] = $return_order_handling_comment;
     ...
     * Gets free_values
     *
     * @return \OngoingAPI\Model\GetReturnOrderInfoFreeValues|null
     */
     ...
     * Sets free_values
     *
     * @param \OngoingAPI\Model\GetReturnOrderInfoFreeValues|null $free_values free_values
     *
     * @return self
     */
    ...
    /**
     * Gets return_order_arrival_time
     *
     * @return \DateTime|null
     */
    public function getReturnOrderArrivalTime()
    {
        return $this->container['return_order_arrival_time'];
    }

    /**
     * Sets return_order_arrival_time
     *
     * @param \DateTime|null $return_order_arrival_time return_order_arrival_time
     *
     * @return self
     */
    public function setReturnOrderArrivalTime($return_order_arrival_time)
    {
        if (is_null($return_order_arrival_time)) {
            array_push($this->openAPINullablesSetToNull, 'return_order_arrival_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_order_arrival_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_order_arrival_time'] = $return_order_arrival_time;
