...
/**
 * GetOrderTracking Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderTracking';
    ...
    protected static $openAPITypes = [
        'freight_price' => '\OngoingAPI\Model\GetOrderTrackingFreightPrice',
        'tracking_url' => 'string',
        'waybill' => 'string',
        'created' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets freight_price
     *
     * @return \OngoingAPI\Model\GetOrderTrackingFreightPrice|null
     */
     ...
     * Sets freight_price
     *
     * @param \OngoingAPI\Model\GetOrderTrackingFreightPrice|null $freight_price freight_price
     *
     * @return self
     */
    ...
    {
        if (is_null($waybill)) {
            array_push($this->openAPINullablesSetToNull, 'waybill');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('waybill', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
