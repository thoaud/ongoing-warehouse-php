...
/**
 * GetArticleModelInventoryInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleModelInventoryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel_inventoryInfo';
    ...
    protected static $openAPITypes = [
        ...
        'number_of_booked_items' => 'float',
        'number_of_locked_items' => 'float',
        'to_receive_number_of_items' => 'float',
        'allocated_number_of_items' => 'float',
        'locked_for_sale_number_of_items' => 'float',
        'picked_to_be_collected_number_of_items' => 'float',
        'received_to_be_finished_number_of_items' => 'float',
        'last_in_date' => '\DateTime',
        'sellable_number_of_items' => 'float',
        'total_stock_value' => 'float',
        'reported' => '\OngoingAPI\Model\GetArticleInventoryInfoReported'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'number_of_booked_items' => 'decimal',
        'number_of_locked_items' => 'decimal',
        'to_receive_number_of_items' => 'decimal',
        'allocated_number_of_items' => 'decimal',
        'locked_for_sale_number_of_items' => 'decimal',
        'picked_to_be_collected_number_of_items' => 'decimal',
        'received_to_be_finished_number_of_items' => 'decimal',
        'last_in_date' => 'date-time',
        'sellable_number_of_items' => 'decimal',
    ...
    protected static array $openAPINullables = [
        ...
        'number_of_booked_items' => false,
        'number_of_locked_items' => false,
        'to_receive_number_of_items' => false,
        'allocated_number_of_items' => false,
        'locked_for_sale_number_of_items' => false,
        'picked_to_be_collected_number_of_items' => false,
        'received_to_be_finished_number_of_items' => false,
        'last_in_date' => true,
        'sellable_number_of_items' => false,
    ...
    protected static $attributeMap = [
        ...
        'number_of_booked_items' => 'numberOfBookedItems',
        'number_of_locked_items' => 'numberOfLockedItems',
        'to_receive_number_of_items' => 'toReceiveNumberOfItems',
        'allocated_number_of_items' => 'allocatedNumberOfItems',
        'locked_for_sale_number_of_items' => 'lockedForSaleNumberOfItems',
        'picked_to_be_collected_number_of_items' => 'pickedToBeCollectedNumberOfItems',
        'received_to_be_finished_number_of_items' => 'receivedToBeFinishedNumberOfItems',
        'last_in_date' => 'lastInDate',
        'sellable_number_of_items' => 'sellableNumberOfItems',
    ...
    protected static $setters = [
        ...
        'number_of_booked_items' => 'setNumberOfBookedItems',
        'number_of_locked_items' => 'setNumberOfLockedItems',
        'to_receive_number_of_items' => 'setToReceiveNumberOfItems',
        'allocated_number_of_items' => 'setAllocatedNumberOfItems',
        'locked_for_sale_number_of_items' => 'setLockedForSaleNumberOfItems',
        'picked_to_be_collected_number_of_items' => 'setPickedToBeCollectedNumberOfItems',
        'received_to_be_finished_number_of_items' => 'setReceivedToBeFinishedNumberOfItems',
        'last_in_date' => 'setLastInDate',
        'sellable_number_of_items' => 'setSellableNumberOfItems',
        'total_stock_value' => 'setTotalStockValue',
    ...
    protected static $getters = [
        ...
        'number_of_booked_items' => 'getNumberOfBookedItems',
        'number_of_locked_items' => 'getNumberOfLockedItems',
        'to_receive_number_of_items' => 'getToReceiveNumberOfItems',
        'allocated_number_of_items' => 'getAllocatedNumberOfItems',
        'locked_for_sale_number_of_items' => 'getLockedForSaleNumberOfItems',
        'picked_to_be_collected_number_of_items' => 'getPickedToBeCollectedNumberOfItems',
        'received_to_be_finished_number_of_items' => 'getReceivedToBeFinishedNumberOfItems',
        'last_in_date' => 'getLastInDate',
        'sellable_number_of_items' => 'getSellableNumberOfItems',
        'total_stock_value' => 'getTotalStockValue',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_booked_items', $data ?? [], null);
        $this->setIfExists('number_of_locked_items', $data ?? [], null);
        $this->setIfExists('to_receive_number_of_items', $data ?? [], null);
        $this->setIfExists('allocated_number_of_items', $data ?? [], null);
        $this->setIfExists('locked_for_sale_number_of_items', $data ?? [], null);
        $this->setIfExists('picked_to_be_collected_number_of_items', $data ?? [], null);
        $this->setIfExists('received_to_be_finished_number_of_items', $data ?? [], null);
        $this->setIfExists('last_in_date', $data ?? [], null);
        $this->setIfExists('sellable_number_of_items', $data ?? [], null);
        $this->setIfExists('total_stock_value', $data ?? [], null);
        $this->setIfExists('reported', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets number_of_booked_items
     *
     * @return float|null
     */
    public function getNumberOfBookedItems()
    {
        return $this->container['number_of_booked_items'];
    }

    /**
     * Sets number_of_booked_items
     *
     * @param float|null $number_of_booked_items number_of_booked_items
     *
     * @return self
     */
    public function setNumberOfBookedItems($number_of_booked_items)
    {
        if (is_null($number_of_booked_items)) {
            throw new \InvalidArgumentException('non-nullable number_of_booked_items cannot be null');
        }
        $this->container['number_of_booked_items'] = $number_of_booked_items;

        return $this;
    }

    /**
     * Gets number_of_locked_items
     *
     * @return float|null
     */
    public function getNumberOfLockedItems()
    {
        return $this->container['number_of_locked_items'];
    }

    /**
     * Sets number_of_locked_items
     *
     * @param float|null $number_of_locked_items number_of_locked_items
     *
     * @return self
     */
    public function setNumberOfLockedItems($number_of_locked_items)
    {
        if (is_null($number_of_locked_items)) {
            throw new \InvalidArgumentException('non-nullable number_of_locked_items cannot be null');
        }
        $this->container['number_of_locked_items'] = $number_of_locked_items;

        return $this;
    }

    /**
     * Gets to_receive_number_of_items
     *
     * @return float|null
     */
    public function getToReceiveNumberOfItems()
    {
        return $this->container['to_receive_number_of_items'];
    }

    /**
     * Sets to_receive_number_of_items
     *
     * @param float|null $to_receive_number_of_items to_receive_number_of_items
     *
     * @return self
     */
    public function setToReceiveNumberOfItems($to_receive_number_of_items)
    {
        if (is_null($to_receive_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable to_receive_number_of_items cannot be null');
        }
        $this->container['to_receive_number_of_items'] = $to_receive_number_of_items;
    ...
    /**
     * Gets locked_for_sale_number_of_items
     *
     * @return float|null
     */
    public function getLockedForSaleNumberOfItems()
    {
        return $this->container['locked_for_sale_number_of_items'];
    }

    /**
     * Sets locked_for_sale_number_of_items
     *
     * @param float|null $locked_for_sale_number_of_items locked_for_sale_number_of_items
     *
     * @return self
     */
    public function setLockedForSaleNumberOfItems($locked_for_sale_number_of_items)
    {
        if (is_null($locked_for_sale_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable locked_for_sale_number_of_items cannot be null');
        }
        $this->container['locked_for_sale_number_of_items'] = $locked_for_sale_number_of_items;

        return $this;
    }

    /**
     * Gets picked_to_be_collected_number_of_items
     *
     * @return float|null
     */
    public function getPickedToBeCollectedNumberOfItems()
    {
        return $this->container['picked_to_be_collected_number_of_items'];
    }

    /**
     * Sets picked_to_be_collected_number_of_items
     *
     * @param float|null $picked_to_be_collected_number_of_items picked_to_be_collected_number_of_items
     *
     * @return self
     */
    public function setPickedToBeCollectedNumberOfItems($picked_to_be_collected_number_of_items)
    {
        if (is_null($picked_to_be_collected_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable picked_to_be_collected_number_of_items cannot be null');
        }
        $this->container['picked_to_be_collected_number_of_items'] = $picked_to_be_collected_number_of_items;

        return $this;
    }

    /**
     * Gets received_to_be_finished_number_of_items
     *
     * @return float|null
     */
    public function getReceivedToBeFinishedNumberOfItems()
    {
        return $this->container['received_to_be_finished_number_of_items'];
    }

    /**
     * Sets received_to_be_finished_number_of_items
     *
     * @param float|null $received_to_be_finished_number_of_items received_to_be_finished_number_of_items
     *
     * @return self
     */
    public function setReceivedToBeFinishedNumberOfItems($received_to_be_finished_number_of_items)
    {
        if (is_null($received_to_be_finished_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable received_to_be_finished_number_of_items cannot be null');
        }
        $this->container['received_to_be_finished_number_of_items'] = $received_to_be_finished_number_of_items;
    ...
    {
        return $this->container['last_in_date'];
    }

    /**
     * Sets last_in_date
     *
     * @param \DateTime|null $last_in_date last_in_date
     *
     * @return self
     */
    public function setLastInDate($last_in_date)
    {
        if (is_null($last_in_date)) {
            array_push($this->openAPINullablesSetToNull, 'last_in_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_in_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['last_in_date'] = $last_in_date;

        return $this;
    }

    /**
     * Gets sellable_number_of_items
     *
     * @return float|null
     */
    public function getSellableNumberOfItems()
    {
        return $this->container['sellable_number_of_items'];
    }

    /**
     * Sets sellable_number_of_items
     *
     * @param float|null $sellable_number_of_items sellable_number_of_items
     *
     * @return self
     */
    public function setSellableNumberOfItems($sellable_number_of_items)
    {
        if (is_null($sellable_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable sellable_number_of_items cannot be null');
        }
        $this->container['sellable_number_of_items'] = $sellable_number_of_items;

        return $this;
    }

    /**
     * Gets total_stock_value
     *
     * @return float|null
     */
    public function getTotalStockValue()
    {
        return $this->container['total_stock_value'];
    }

    /**
     * Sets total_stock_value
     *
     * @param float|null $total_stock_value total_stock_value
     *
     * @return self
     */
    public function setTotalStockValue($total_stock_value)
    {
        if (is_null($total_stock_value)) {
            throw new \InvalidArgumentException('non-nullable total_stock_value cannot be null');
        }
        $this->container['total_stock_value'] = $total_stock_value;
     ...
     * Gets reported
     *
     * @return \OngoingAPI\Model\GetArticleInventoryInfoReported|null
     */
     ...
     * Sets reported
     *
     * @param \OngoingAPI\Model\GetArticleInventoryInfoReported|null $reported reported
     *
     * @return self
     */
    ...
    {
        if (is_null($reported)) {
            array_push($this->openAPINullablesSetToNull, 'reported');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reported', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
