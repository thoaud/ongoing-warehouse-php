...
/**
 * PostFileNoFilenameModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostFileNoFilenameModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFileNoFilenameModel';
    ...
    */
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling PostFileNoFilenameModel., must be bigger than or equal to 1.');
        }
    ...
    public function setFileDataBase64($file_data_base64)
    {
        ...
        if ((mb_strlen($file_data_base64) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_data_base64 when calling PostFileNoFilenameModel., must be bigger than or equal to 1.');
        }
