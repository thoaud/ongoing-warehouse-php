...
/**
 * GetArticleModelGoodsOwner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetArticleModelGoodsOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel_goodsOwner';
