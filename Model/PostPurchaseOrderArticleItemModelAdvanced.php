<?php
/**
 * PostPurchaseOrderArticleItemModelAdvanced
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderArticleItemModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemModel_advanced';
    ...
    protected static $openAPITypes = [
        'article_item_parcel' => '\OngoingAPI\Model\PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel'
    ];
    ...
    protected static $attributeMap = [
        'article_item_parcel' => 'articleItemParcel'
    ];
    ...
    protected static $setters = [
        'article_item_parcel' => 'setArticleItemParcel'
    ];
    ...
    protected static $getters = [
        'article_item_parcel' => 'getArticleItemParcel'
    ];
    ...
    {
        $this->setIfExists('article_item_parcel', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets article_item_parcel
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel|null
     */
    public function getArticleItemParcel()
    {
        return $this->container['article_item_parcel'];
    }

    /**
     * Sets article_item_parcel
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel|null $article_item_parcel article_item_parcel
     *
     * @return self
     */
    public function setArticleItemParcel($article_item_parcel)
    {
        if (is_null($article_item_parcel)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_parcel');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_parcel', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_item_parcel'] = $article_item_parcel;
