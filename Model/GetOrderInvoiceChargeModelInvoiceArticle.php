<?php
/**
 * GetOrderInvoiceChargeModelInvoiceArticle
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderInvoiceChargeModelInvoiceArticle Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderInvoiceChargeModelInvoiceArticle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderInvoiceChargeModel_invoiceArticle';
    ...
    protected static $attributeMap = [
        'invoice_article_id' => 'invoiceArticleId',
        'code' => 'code',
        'title' => 'title',
        'account' => 'account'
    ];
    ...
    protected static $setters = [
        'invoice_article_id' => 'setInvoiceArticleId',
        'code' => 'setCode',
        'title' => 'setTitle',
        'account' => 'setAccount'
    ];
    ...
    protected static $getters = [
        'invoice_article_id' => 'getInvoiceArticleId',
        'code' => 'getCode',
        'title' => 'getTitle',
        'account' => 'getAccount'
    ];
    ...
    {
        $this->setIfExists('invoice_article_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets invoice_article_id
     *
     * @return int|null
     */
    public function getInvoiceArticleId()
    {
        return $this->container['invoice_article_id'];
    }

    /**
     * Sets invoice_article_id
     *
     * @param int|null $invoice_article_id invoice_article_id
     *
     * @return self
     */
    public function setInvoiceArticleId($invoice_article_id)
    {
        if (is_null($invoice_article_id)) {
            throw new \InvalidArgumentException('non-nullable invoice_article_id cannot be null');
        }
        $this->container['invoice_article_id'] = $invoice_article_id;
