<?php
/**
 * PostPurchaseOrderModelAdvanced
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderModel_advanced';
    ...
    protected static $openAPITypes = [
        'container' => 'string',
        'order_date' => '\DateTime',
        'advised_date' => '\DateTime',
        'purchase_order_status_created' => 'int',
        'purchase_order_is_return_type' => 'bool',
        'customer' => '\OngoingAPI\Model\PostPurchaseOrderAdvancedCustomer'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'advised_date' => 'date-time',
        'purchase_order_status_created' => 'int32',
        'purchase_order_is_return_type' => null,
        'customer' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'order_date' => true,
        'advised_date' => true,
        'purchase_order_status_created' => true,
        'purchase_order_is_return_type' => true,
        'customer' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'advised_date' => 'advisedDate',
        'purchase_order_status_created' => 'purchaseOrderStatusCreated',
        'purchase_order_is_return_type' => 'purchaseOrderIsReturnType',
        'customer' => 'customer'
    ];
    ...
    protected static $setters = [
        ...
        'advised_date' => 'setAdvisedDate',
        'purchase_order_status_created' => 'setPurchaseOrderStatusCreated',
        'purchase_order_is_return_type' => 'setPurchaseOrderIsReturnType',
    ...
    protected static $getters = [
        ...
        'advised_date' => 'getAdvisedDate',
        'purchase_order_status_created' => 'getPurchaseOrderStatusCreated',
        'purchase_order_is_return_type' => 'getPurchaseOrderIsReturnType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('advised_date', $data ?? [], null);
        $this->setIfExists('purchase_order_status_created', $data ?? [], null);
        $this->setIfExists('purchase_order_is_return_type', $data ?? [], null);
    ...
    */
     ...
     * @return \DateTime|null
     */
    public function getAdvisedDate()
    {
        return $this->container['advised_date'];
    }

    /**
     * Sets advised_date
     *
     * @param \DateTime|null $advised_date advised_date
     *
     * @return self
     */
    public function setAdvisedDate($advised_date)
    {
        if (is_null($advised_date)) {
            array_push($this->openAPINullablesSetToNull, 'advised_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('advised_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['advised_date'] = $advised_date;

        return $this;
    }

    /**
     * Gets purchase_order_status_created
     *
     * @return int|null
     */
    public function getPurchaseOrderStatusCreated()
    {
        return $this->container['purchase_order_status_created'];
    }

    /**
     * Sets purchase_order_status_created
     *
     * @param int|null $purchase_order_status_created purchase_order_status_created
     *
     * @return self
     */
    public function setPurchaseOrderStatusCreated($purchase_order_status_created)
    {
        if (is_null($purchase_order_status_created)) {
            array_push($this->openAPINullablesSetToNull, 'purchase_order_status_created');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('purchase_order_status_created', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['purchase_order_status_created'] = $purchase_order_status_created;

        return $this;
    }

    /**
     * Gets purchase_order_is_return_type
     *
     * @return bool|null
     */
    public function getPurchaseOrderIsReturnType()
    {
        return $this->container['purchase_order_is_return_type'];
    }

    /**
     * Sets purchase_order_is_return_type
     *
     * @param bool|null $purchase_order_is_return_type purchase_order_is_return_type
     *
     * @return self
     */
    public function setPurchaseOrderIsReturnType($purchase_order_is_return_type)
    {
        if (is_null($purchase_order_is_return_type)) {
            array_push($this->openAPINullablesSetToNull, 'purchase_order_is_return_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('purchase_order_is_return_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['purchase_order_is_return_type'] = $purchase_order_is_return_type;
     ...
     * Gets customer
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderAdvancedCustomer|null
     */
     ...
     * Sets customer
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderAdvancedCustomer|null $customer customer
     *
     * @return self
     */
