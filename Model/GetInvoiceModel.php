...
/**
 * GetInvoiceModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceModel';
    ...
    protected static $openAPITypes = [
        'goods_owner' => '\OngoingAPI\Model\GetInvoiceModelGoodsOwner',
        'invoice_info' => '\OngoingAPI\Model\GetInvoiceModelInvoiceInfo',
        'invoice_charges' => '\OngoingAPI\Model\GetInvoiceCharge[]'
    ];
    ...
    protected static $setters = [
        ...
        'invoice_charges' => 'setInvoiceCharges'
    ];
    ...
    protected static $getters = [
        ...
        'invoice_charges' => 'getInvoiceCharges'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invoice_charges', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets goods_owner
     *
     * @return \OngoingAPI\Model\GetInvoiceModelGoodsOwner|null
     */
     ...
     * Sets goods_owner
     *
     * @param \OngoingAPI\Model\GetInvoiceModelGoodsOwner|null $goods_owner goods_owner
     *
     * @return self
     */
     ...
     * Gets invoice_info
     *
     * @return \OngoingAPI\Model\GetInvoiceModelInvoiceInfo|null
     */
     ...
     * Sets invoice_info
     *
     * @param \OngoingAPI\Model\GetInvoiceModelInvoiceInfo|null $invoice_info invoice_info
     *
     * @return self
     */
    ...
    /**
     * Gets invoice_charges
     *
     * @return \OngoingAPI\Model\GetInvoiceCharge[]|null
     */
    public function getInvoiceCharges()
    {
        return $this->container['invoice_charges'];
    }

    /**
     * Sets invoice_charges
     *
     * @param \OngoingAPI\Model\GetInvoiceCharge[]|null $invoice_charges invoice_charges
     *
     * @return self
     */
    public function setInvoiceCharges($invoice_charges)
    {
        if (is_null($invoice_charges)) {
            array_push($this->openAPINullablesSetToNull, 'invoice_charges');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invoice_charges', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['invoice_charges'] = $invoice_charges;
