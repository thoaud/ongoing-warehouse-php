<?php
/**
 * GetInvoiceOrderContextTransporter
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetInvoiceOrderContextTransporter Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceOrderContextTransporter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceOrderContext_transporter';
