<?php
/**
 * GetProductionOrderModelProductionOrderInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetProductionOrderModelProductionOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderModelProductionOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderModel_productionOrderInfo';
    ...
    protected static $openAPITypes = [
        ...
        'production_order_status' => '\OngoingAPI\Model\GetProductionOrderInfoProductionOrderStatus',
        'free_values' => '\OngoingAPI\Model\GetProductionOrderInfoFreeValues'
    ];
    ...
    protected static $openAPIFormats = [
        'production_order_id' => 'int32',
        'production_order_number' => null,
        'comment' => null,
        'production_date' => 'date-time',
        'start_production_time' => 'date-time',
        'end_production_time' => 'date-time',
    ...
    protected static array $openAPINullables = [
        ...
        'start_production_time' => true,
        'end_production_time' => true,
    ...
    protected static $attributeMap = [
        ...
        'end_production_time' => 'endProductionTime',
    ...
    protected static $setters = [
        ...
        'start_production_time' => 'setStartProductionTime',
        'end_production_time' => 'setEndProductionTime',
        'production_order_status' => 'setProductionOrderStatus',
    ...
    protected static $getters = [
        ...
        'start_production_time' => 'getStartProductionTime',
        'end_production_time' => 'getEndProductionTime',
        'production_order_status' => 'getProductionOrderStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('start_production_time', $data ?? [], null);
        $this->setIfExists('end_production_time', $data ?? [], null);
        $this->setIfExists('production_order_status', $data ?? [], null);
    ...
    */
     ...
     *
     * @param int|null $production_order_id production_order_id
     *
     * @return self
     */
    ...
    public function setProductionOrderNumber($production_order_number)
    {
        if (is_null($production_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets start_production_time
     *
     * @return \DateTime|null
     */
    public function getStartProductionTime()
    {
        return $this->container['start_production_time'];
    }

    /**
     * Sets start_production_time
     *
     * @param \DateTime|null $start_production_time start_production_time
     *
     * @return self
     */
    public function setStartProductionTime($start_production_time)
    {
        if (is_null($start_production_time)) {
            array_push($this->openAPINullablesSetToNull, 'start_production_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_production_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['start_production_time'] = $start_production_time;

        return $this;
    }

    /**
     * Gets end_production_time
     *
     * @return \DateTime|null
     */
    public function getEndProductionTime()
    {
        return $this->container['end_production_time'];
    }

    /**
     * Sets end_production_time
     *
     * @param \DateTime|null $end_production_time end_production_time
     *
     * @return self
     */
    public function setEndProductionTime($end_production_time)
    {
        if (is_null($end_production_time)) {
            array_push($this->openAPINullablesSetToNull, 'end_production_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('end_production_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['end_production_time'] = $end_production_time;

        return $this;
    }

    /**
     * Gets production_order_status
     *
     * @return \OngoingAPI\Model\GetProductionOrderInfoProductionOrderStatus|null
     */
    public function getProductionOrderStatus()
    {
        return $this->container['production_order_status'];
    }

    /**
     * Sets production_order_status
     *
     * @param \OngoingAPI\Model\GetProductionOrderInfoProductionOrderStatus|null $production_order_status production_order_status
     *
     * @return self
     */
    public function setProductionOrderStatus($production_order_status)
    {
        if (is_null($production_order_status)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['production_order_status'] = $production_order_status;
     ...
     * Gets free_values
     *
     * @return \OngoingAPI\Model\GetProductionOrderInfoFreeValues|null
     */
     ...
     * Sets free_values
     *
     * @param \OngoingAPI\Model\GetProductionOrderInfoFreeValues|null $free_values free_values
     *
     * @return self
     */
