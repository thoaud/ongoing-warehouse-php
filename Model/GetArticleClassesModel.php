...
/**
 * GetArticleClassesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleClassesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleClassesModel';
    ...
    protected static $openAPITypes = [
        'article_classes' => '\OngoingAPI\Model\GetArticleClassModel[]'
    ];
    ...
    protected static $setters = [
        'article_classes' => 'setArticleClasses'
    ];
    ...
    protected static $getters = [
        'article_classes' => 'getArticleClasses'
    ];
    ...
    {
        $this->setIfExists('article_classes', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets article_classes
     *
     * @return \OngoingAPI\Model\GetArticleClassModel[]|null
     */
    public function getArticleClasses()
    {
        return $this->container['article_classes'];
    }

    /**
     * Sets article_classes
     *
     * @param \OngoingAPI\Model\GetArticleClassModel[]|null $article_classes article_classes
     *
     * @return self
     */
    public function setArticleClasses($article_classes)
    {
        if (is_null($article_classes)) {
            array_push($this->openAPINullablesSetToNull, 'article_classes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_classes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_classes'] = $article_classes;
