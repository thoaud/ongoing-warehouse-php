...
/**
 * PatchPurchaseOrderLineFreeText1 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchPurchaseOrderLineFreeText1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchPurchaseOrderLineFreeText1';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['free_text1'] === null) {
            $invalidProperties[] = "'free_text1' can't be null";
        }
        if ((mb_strlen($this->container['free_text1']) < 1)) {
            $invalidProperties[] = "invalid value for 'free_text1', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets free_text1
     *
     * @param string $free_text1 free_text1
     *
     * @return self
     */
    public function setFreeText1($free_text1)
    {
        if (is_null($free_text1)) {
            throw new \InvalidArgumentException('non-nullable free_text1 cannot be null');
        }

        if ((mb_strlen($free_text1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $free_text1 when calling PatchPurchaseOrderLineFreeText1., must be bigger than or equal to 1.');
        }
