...
/**
 * PutOrderTextLineModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PutOrderTextLineModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutOrderTextLineModel';
    ...
    */
    ...
    public function setRowNumber($row_number)
    {
        ...
        if ((mb_strlen($row_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $row_number when calling PutOrderTextLineModel., must be bigger than or equal to 1.');
        }
