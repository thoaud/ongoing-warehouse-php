...
/**
 * GetFileModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetFileModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetFileModel';
    ...
    protected static array $openAPINullables = [
        'file_id' => false,
        'order_id' => true,
        'article_system_id' => true,
        'file_name' => true,
        'mime_type' => true,
        'file_data_base64' => true,
    ...
    */
    ...
    public function setArticleSystemId($article_system_id)
    {
        if (is_null($article_system_id)) {
            array_push($this->openAPINullablesSetToNull, 'article_system_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_system_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $file_data_base64 file_data_base64
     *
     * @return self
     */
    public function setFileDataBase64($file_data_base64)
    {
        if (is_null($file_data_base64)) {
            array_push($this->openAPINullablesSetToNull, 'file_data_base64');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('file_data_base64', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
