<?php
/**
 * OrdersPatchDeliveryDateRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrdersPatchDeliveryDateRequest Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class OrdersPatchDeliveryDateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Orders_PatchDeliveryDate_request';
    ...
    */
    ...
    public function setDeliveryDate($delivery_date)
    {
        ...
        if ((mb_strlen($delivery_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date when calling OrdersPatchDeliveryDateRequest., must be bigger than or equal to 1.');
        }
