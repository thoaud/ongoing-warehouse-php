<?php
/**
 * PatchOrderTransporterPaymentConsigneePays
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PatchOrderTransporterPaymentConsigneePays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderTransporterPaymentConsigneePays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderTransporterPayment_consigneePays';
    ...
    */
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling PatchOrderTransporterPaymentConsigneePays., must be bigger than or equal to 1.');
        }
