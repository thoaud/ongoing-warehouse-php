...
/**
 * GetArticleDangerousGoodsModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleDangerousGoodsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleDangerousGoodsModel';
    ...
    protected static $openAPITypes = [
        ...
        'dangerous_goods' => '\OngoingAPI\Model\GetArticleDangerousGoodsModelDangerousGoods'
    ];
    ...
    */
     ...
     *
     * @return \OngoingAPI\Model\GetArticleDangerousGoodsModelDangerousGoods|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetArticleDangerousGoodsModelDangerousGoods|null $dangerous_goods dangerous_goods
     *
     * @return self
     */
    public function setDangerousGoods($dangerous_goods)
    {
        if (is_null($dangerous_goods)) {
            array_push($this->openAPINullablesSetToNull, 'dangerous_goods');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dangerous_goods', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
