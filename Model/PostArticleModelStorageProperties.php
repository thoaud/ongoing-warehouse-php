<?php
/**
 * PostArticleModelStorageProperties
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostArticleModelStorageProperties Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelStorageProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_storageProperties';
    ...
    protected static $openAPITypes = [
        'is_obsolete' => 'bool',
        'is_serial_number_article' => 'bool',
        'is_batch_article' => 'bool',
        'is_expiry_date_article' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'is_obsolete' => null,
        'is_serial_number_article' => null,
        'is_batch_article' => null,
        'is_expiry_date_article' => null
    ];
    ...
    protected static array $openAPINullables = [
        'is_obsolete' => true,
        'is_serial_number_article' => true,
        'is_batch_article' => true,
        'is_expiry_date_article' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_serial_number_article' => 'isSerialNumberArticle',
        'is_batch_article' => 'isBatchArticle',
        'is_expiry_date_article' => 'isExpiryDateArticle'
    ];
    ...
    protected static $setters = [
        ...
        'is_serial_number_article' => 'setIsSerialNumberArticle',
        'is_batch_article' => 'setIsBatchArticle',
        'is_expiry_date_article' => 'setIsExpiryDateArticle'
    ];
    ...
    protected static $getters = [
        ...
        'is_serial_number_article' => 'getIsSerialNumberArticle',
        'is_batch_article' => 'getIsBatchArticle',
        'is_expiry_date_article' => 'getIsExpiryDateArticle'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_serial_number_article', $data ?? [], null);
        $this->setIfExists('is_batch_article', $data ?? [], null);
        $this->setIfExists('is_expiry_date_article', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets is_serial_number_article
     *
     * @return bool|null
     */
    public function getIsSerialNumberArticle()
    {
        return $this->container['is_serial_number_article'];
    }

    /**
     * Sets is_serial_number_article
     *
     * @param bool|null $is_serial_number_article is_serial_number_article
     *
     * @return self
     */
    public function setIsSerialNumberArticle($is_serial_number_article)
    {
        if (is_null($is_serial_number_article)) {
            array_push($this->openAPINullablesSetToNull, 'is_serial_number_article');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_serial_number_article', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_serial_number_article'] = $is_serial_number_article;

        return $this;
    }

    /**
     * Gets is_batch_article
     *
     * @return bool|null
     */
    public function getIsBatchArticle()
    {
        return $this->container['is_batch_article'];
    }

    /**
     * Sets is_batch_article
     *
     * @param bool|null $is_batch_article is_batch_article
     *
     * @return self
     */
    public function setIsBatchArticle($is_batch_article)
    {
        if (is_null($is_batch_article)) {
            array_push($this->openAPINullablesSetToNull, 'is_batch_article');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_batch_article', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_batch_article'] = $is_batch_article;

        return $this;
    }

    /**
     * Gets is_expiry_date_article
     *
     * @return bool|null
     */
    public function getIsExpiryDateArticle()
    {
        return $this->container['is_expiry_date_article'];
    }

    /**
     * Sets is_expiry_date_article
     *
     * @param bool|null $is_expiry_date_article is_expiry_date_article
     *
     * @return self
     */
    public function setIsExpiryDateArticle($is_expiry_date_article)
    {
        if (is_null($is_expiry_date_article)) {
            array_push($this->openAPINullablesSetToNull, 'is_expiry_date_article');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_expiry_date_article', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_expiry_date_article'] = $is_expiry_date_article;
