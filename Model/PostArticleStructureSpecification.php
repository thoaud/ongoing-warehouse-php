...
/**
 * PostArticleStructureSpecification Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleStructureSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleStructureSpecification';
    ...
    */
    ...
    public function setRows($rows)
    {
        ...
        if (!is_null($rows) && (count($rows) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rows when calling PostArticleStructureSpecification., number of items must be greater than or equal to 1.');
        }
