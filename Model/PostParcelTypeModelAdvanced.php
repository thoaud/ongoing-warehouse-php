...
/**
 * PostParcelTypeModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostParcelTypeModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostParcelTypeModel_advanced';
    ...
    protected static $openAPITypes = [
        'parcel_type' => '\OngoingAPI\Model\PostParcelAdvancedParcelType',
        'parcel_status' => '\OngoingAPI\Model\PostParcelAdvancedParcelStatus',
        'length' => 'float',
        'width' => 'float',
        'height' => 'float',
        'weight' => 'float'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parcel_status', $data ?? [], null);
    ...
    */
     ...
     * Gets parcel_type
     *
     * @return \OngoingAPI\Model\PostParcelAdvancedParcelType|null
     */
     ...
     * Sets parcel_type
     *
     * @param \OngoingAPI\Model\PostParcelAdvancedParcelType|null $parcel_type parcel_type
     *
     * @return self
     */
     ...
     * Gets parcel_status
     *
     * @return \OngoingAPI\Model\PostParcelAdvancedParcelStatus|null
     */
     ...
     * Sets parcel_status
     *
     * @param \OngoingAPI\Model\PostParcelAdvancedParcelStatus|null $parcel_status parcel_status
     *
     * @return self
     */
    public function setParcelStatus($parcel_status)
    {
        if (is_null($parcel_status)) {
            array_push($this->openAPINullablesSetToNull, 'parcel_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parcel_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
