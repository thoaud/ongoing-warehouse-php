...
/**
 * PostArticleModelAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_advanced';
    ...
    protected static $openAPITypes = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => null
    ];
    ...
    protected static array $openAPINullables = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => true
    ];
    ...
    protected static $attributeMap = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => 'allowChangingProductionAndStructureArticlesToStockOrNonStockArticles'
    ];
    ...
    protected static $setters = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => 'setAllowChangingProductionAndStructureArticlesToStockOrNonStockArticles'
    ];
    ...
    protected static $getters = [
        'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles' => 'getAllowChangingProductionAndStructureArticlesToStockOrNonStockArticles'
    ];
    ...
    {
        $this->setIfExists('allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles
     *
     * @return bool|null
     */
    public function getAllowChangingProductionAndStructureArticlesToStockOrNonStockArticles()
    {
        return $this->container['allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles'];
    }

    /**
     * Sets allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles
     *
     * @param bool|null $allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles
     *
     * @return self
     */
    public function setAllowChangingProductionAndStructureArticlesToStockOrNonStockArticles($allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles)
    {
        if (is_null($allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles)) {
            array_push($this->openAPINullablesSetToNull, 'allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles'] = $allow_changing_production_and_structure_articles_to_stock_or_non_stock_articles;
