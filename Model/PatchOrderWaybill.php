...
/**
 * PatchOrderWaybill Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderWaybill implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderWaybill';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['waybill']) > 50)) {
            $invalidProperties[] = "invalid value for 'waybill', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setWaybill($waybill)
    {
        ...
        if ((mb_strlen($waybill) > 50)) {
            throw new \InvalidArgumentException('invalid length for $waybill when calling PatchOrderWaybill., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($waybill) < 1)) {
            throw new \InvalidArgumentException('invalid length for $waybill when calling PatchOrderWaybill., must be bigger than or equal to 1.');
        }
