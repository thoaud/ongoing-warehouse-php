...
/**
 * PostOrderClass Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderClass implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderClass';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'comment' => 'string',
        'is_parcel_type_suggestion' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'name' => null,
        'comment' => null,
        'is_parcel_type_suggestion' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'name' => true,
        'comment' => true,
        'is_parcel_type_suggestion' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'name' => 'name',
        'comment' => 'comment',
        'is_parcel_type_suggestion' => 'isParcelTypeSuggestion'
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'comment' => 'setComment',
        'is_parcel_type_suggestion' => 'setIsParcelTypeSuggestion'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'comment' => 'getComment',
        'is_parcel_type_suggestion' => 'getIsParcelTypeSuggestion'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_parcel_type_suggestion', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets is_parcel_type_suggestion
     *
     * @return bool|null
     */
    public function getIsParcelTypeSuggestion()
    {
        return $this->container['is_parcel_type_suggestion'];
    }

    /**
     * Sets is_parcel_type_suggestion
     *
     * @param bool|null $is_parcel_type_suggestion is_parcel_type_suggestion
     *
     * @return self
     */
    public function setIsParcelTypeSuggestion($is_parcel_type_suggestion)
    {
        if (is_null($is_parcel_type_suggestion)) {
            array_push($this->openAPINullablesSetToNull, 'is_parcel_type_suggestion');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_parcel_type_suggestion', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_parcel_type_suggestion'] = $is_parcel_type_suggestion;
