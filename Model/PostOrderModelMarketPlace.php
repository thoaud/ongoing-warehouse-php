...
/**
 * PostOrderModelMarketPlace Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderModelMarketPlace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderModel_marketPlace';
    ...
    protected static $openAPITypes = [
        'market_place' => 'string',
        'market_place_order_number' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'market_place' => null,
        'market_place_order_number' => null
    ];
    ...
    protected static array $openAPINullables = [
        'market_place' => true,
        'market_place_order_number' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'market_place_order_number' => 'marketPlaceOrderNumber'
    ];
    ...
    protected static $setters = [
        ...
        'market_place_order_number' => 'setMarketPlaceOrderNumber'
    ];
    ...
    protected static $getters = [
        ...
        'market_place_order_number' => 'getMarketPlaceOrderNumber'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('market_place_order_number', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets market_place
     *
     * @param string|null $market_place market_place
     *
     * @return self
     */
    ...
    /**
     * Gets market_place_order_number
     *
     * @return string|null
     */
    public function getMarketPlaceOrderNumber()
    {
        return $this->container['market_place_order_number'];
    }

    /**
     * Sets market_place_order_number
     *
     * @param string|null $market_place_order_number market_place_order_number
     *
     * @return self
     */
    public function setMarketPlaceOrderNumber($market_place_order_number)
    {
        if (is_null($market_place_order_number)) {
            array_push($this->openAPINullablesSetToNull, 'market_place_order_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('market_place_order_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['market_place_order_number'] = $market_place_order_number;
