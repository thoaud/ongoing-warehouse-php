<?php
/**
 * PostPurchaseOrderModelSellerInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderModelSellerInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderModelSellerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderModel_sellerInfo';
    ...
    protected static $openAPITypes = [
        ...
        'seller_name' => 'string',
        'seller_address' => '\OngoingAPI\Model\PostPurchaseOrderSellerInfoSellerAddress'
    ];
    ...
    {
        $this->setIfExists('seller_number', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['seller_number'];
    }

    /**
     * Sets seller_number
     *
     * @param string|null $seller_number seller_number
     *
     * @return self
     */
    public function setSellerNumber($seller_number)
    {
        if (is_null($seller_number)) {
            array_push($this->openAPINullablesSetToNull, 'seller_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seller_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['seller_number'] = $seller_number;
     ...
     * Gets seller_address
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderSellerInfoSellerAddress|null
     */
     ...
     * Sets seller_address
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderSellerInfoSellerAddress|null $seller_address seller_address
     *
     * @return self
     */
    public function setSellerAddress($seller_address)
    {
        if (is_null($seller_address)) {
            array_push($this->openAPINullablesSetToNull, 'seller_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seller_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
