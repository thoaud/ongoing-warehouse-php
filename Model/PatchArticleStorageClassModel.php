...
/**
 * PatchArticleStorageClassModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchArticleStorageClassModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchArticleStorageClassModel';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storage_class_name'] === null) {
            $invalidProperties[] = "'storage_class_name' can't be null";
        }
        if ((mb_strlen($this->container['storage_class_name']) > 100)) {
            $invalidProperties[] = "invalid value for 'storage_class_name', the character length must be smaller than or equal to 100.";
        }

        if ((mb_strlen($this->container['storage_class_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'storage_class_name', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string $storage_class_name storage_class_name
     *
     * @return self
     */
    public function setStorageClassName($storage_class_name)
    {
        if (is_null($storage_class_name)) {
            throw new \InvalidArgumentException('non-nullable storage_class_name cannot be null');
        }
        if ((mb_strlen($storage_class_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $storage_class_name when calling PatchArticleStorageClassModel., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($storage_class_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $storage_class_name when calling PatchArticleStorageClassModel., must be bigger than or equal to 1.');
        }
