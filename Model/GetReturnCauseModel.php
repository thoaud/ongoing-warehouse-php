...
/**
 * GetReturnCauseModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnCauseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnCauseModel';
    ...
    */
    ...
    public function setIsRemoveCause($is_remove_cause)
    {
        if (is_null($is_remove_cause)) {
            throw new \InvalidArgumentException('non-nullable is_remove_cause cannot be null');
        }
    ...
    public function setIsChangeCause($is_change_cause)
    {
        if (is_null($is_change_cause)) {
            throw new \InvalidArgumentException('non-nullable is_change_cause cannot be null');
        }
    ...
    public function setIsReturnCommentMandatory($is_return_comment_mandatory)
    {
        if (is_null($is_return_comment_mandatory)) {
            throw new \InvalidArgumentException('non-nullable is_return_comment_mandatory cannot be null');
        }
