...
/**
 * PatchOrderRemark Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderRemark implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderRemark';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['order_remark']) > 500)) {
            $invalidProperties[] = "invalid value for 'order_remark', the character length must be smaller than or equal to 500.";
        }
    ...
    public function setOrderRemark($order_remark)
    {
        ...
        if ((mb_strlen($order_remark) > 500)) {
            throw new \InvalidArgumentException('invalid length for $order_remark when calling PatchOrderRemark., must be smaller than or equal to 500.');
        }
