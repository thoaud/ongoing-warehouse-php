...
/**
 * GetOrderInvoiceChargeModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderInvoiceChargeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderInvoiceChargeModel';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'profit_center' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'invoice_article' => '\OngoingAPI\Model\GetOrderInvoiceChargeModelInvoiceArticle'
    ];
    ...
    */
     ...
     * Sets profit_center
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $profit_center profit_center
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\GetOrderInvoiceChargeModelInvoiceArticle|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetOrderInvoiceChargeModelInvoiceArticle|null $invoice_article invoice_article
     *
     * @return self
     */
