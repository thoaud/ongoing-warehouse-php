...
/**
 * GetHistoricalInventoryModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetHistoricalInventoryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetHistoricalInventoryModel';
    ...
    protected static $openAPITypes = [
        'articles' => '\OngoingAPI\Model\GetHistoricalInventoryArticleModel[]'
    ];
    ...
    */
     ...
     * Gets articles
     *
     * @return \OngoingAPI\Model\GetHistoricalInventoryArticleModel[]|null
     */
     ...
     * Sets articles
     *
     * @param \OngoingAPI\Model\GetHistoricalInventoryArticleModel[]|null $articles articles
     *
     * @return self
     */
    ...
    {
        if (is_null($articles)) {
            array_push($this->openAPINullablesSetToNull, 'articles');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('articles', $nullablesSetToNull);
            if ($index !== FALSE) {
