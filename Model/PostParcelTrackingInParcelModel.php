...
/**
 * PostParcelTrackingInParcelModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostParcelTrackingInParcelModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostParcelTrackingInParcelModel';
    ...
    */
    ...
    public function setWaybill($waybill)
    {
        ...
        if ((mb_strlen($waybill) < 1)) {
            throw new \InvalidArgumentException('invalid length for $waybill when calling PostParcelTrackingInParcelModel., must be bigger than or equal to 1.');
        }
    ...
    public function setTrackingUrl($tracking_url)
    {
        ...
        if ((mb_strlen($tracking_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling PostParcelTrackingInParcelModel., must be bigger than or equal to 1.');
        }
