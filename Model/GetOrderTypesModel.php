...
/**
 * GetOrderTypesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderTypesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderTypesModel';
    ...
    protected static $openAPITypes = [
        'order_types' => '\OngoingAPI\Model\GetOrderTypeModel[]'
    ];
    ...
    */
     ...
     * Gets order_types
     *
     * @return \OngoingAPI\Model\GetOrderTypeModel[]|null
     */
     ...
     * Sets order_types
     *
     * @param \OngoingAPI\Model\GetOrderTypeModel[]|null $order_types order_types
     *
     * @return self
     */
    public function setOrderTypes($order_types)
    {
        if (is_null($order_types)) {
            array_push($this->openAPINullablesSetToNull, 'order_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_types', $nullablesSetToNull);
            if ($index !== FALSE) {
