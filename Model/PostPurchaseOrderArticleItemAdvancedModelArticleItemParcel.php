<?php
/**
 * PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderArticleItemAdvancedModel_articleItemParcel';
    ...
    protected static $openAPITypes = [
        ...
        'parcel_type' => '\OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelParcelType',
        'dimensions' => '\OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelDimensions'
    ];
    ...
    */
    ...
    public function setParcelNumber($parcel_number)
    {
        ...
        if ((mb_strlen($parcel_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcel_number when calling PostPurchaseOrderArticleItemAdvancedModelArticleItemParcel., must be bigger than or equal to 1.');
        }
     ...
     * Gets parcel_type
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelParcelType|null
     */
     ...
     * Sets parcel_type
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelParcelType|null $parcel_type parcel_type
     *
     * @return self
     */
     ...
     * Gets dimensions
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelDimensions|null
     */
     ...
     * Sets dimensions
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderArticleItemParcelModelDimensions|null $dimensions dimensions
     *
     * @return self
     */
