...
/**
 * GetOrderPickabilityOrderLineInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickabilityOrderLineInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickabilityOrderLineInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'article' => '\OngoingAPI\Model\GetOrderPickabilityOrderLineInfoArticle',
        'should_be_picked' => 'bool',
        'row_number' => 'string',
        'order_line_pickability' => '\OngoingAPI\Model\GetOrderPickabilityOrderLineInfoOrderLinePickability',
    ...
    protected static $attributeMap = [
        ...
        'order_line_pickability' => 'orderLinePickability',
    ...
    protected static $setters = [
        ...
        'order_line_pickability' => 'setOrderLinePickability',
    ...
    protected static $getters = [
        ...
        'order_line_pickability' => 'getOrderLinePickability',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('order_line_pickability', $data ?? [], null);
    ...
    */
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityOrderLineInfoArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityOrderLineInfoArticle|null $article article
     *
     * @return self
     */
    ...
    /**
     * Gets order_line_pickability
     *
     * @return \OngoingAPI\Model\GetOrderPickabilityOrderLineInfoOrderLinePickability|null
     */
    public function getOrderLinePickability()
    {
        return $this->container['order_line_pickability'];
    }

    /**
     * Sets order_line_pickability
     *
     * @param \OngoingAPI\Model\GetOrderPickabilityOrderLineInfoOrderLinePickability|null $order_line_pickability order_line_pickability
     *
     * @return self
     */
    public function setOrderLinePickability($order_line_pickability)
    {
        if (is_null($order_line_pickability)) {
            array_push($this->openAPINullablesSetToNull, 'order_line_pickability');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_line_pickability', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['order_line_pickability'] = $order_line_pickability;
