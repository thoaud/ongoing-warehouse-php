...
/**
 * GetArticleModelFreeValues Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetArticleModelFreeValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArticleModel_freeValues';
    ...
    */
    ...
    public function setFreeBoolean1($free_boolean1)
    {
        if (is_null($free_boolean1)) {
            throw new \InvalidArgumentException('non-nullable free_boolean1 cannot be null');
        }
    ...
    public function setFreeBoolean2($free_boolean2)
    {
        if (is_null($free_boolean2)) {
            throw new \InvalidArgumentException('non-nullable free_boolean2 cannot be null');
        }
    ...
    public function setFreeBoolean3($free_boolean3)
    {
        if (is_null($free_boolean3)) {
            throw new \InvalidArgumentException('non-nullable free_boolean3 cannot be null');
        }
