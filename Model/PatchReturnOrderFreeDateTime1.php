...
/**
 * PatchReturnOrderFreeDateTime1 Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchReturnOrderFreeDateTime1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchReturnOrderFreeDateTime1';
    ...
    */
    ...
    public function setFreeDateTime1($free_date_time1)
    {
        if (is_null($free_date_time1)) {
            throw new \InvalidArgumentException('non-nullable free_date_time1 cannot be null');
        }
