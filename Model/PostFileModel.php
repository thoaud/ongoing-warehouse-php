...
/**
 * PostFileModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostFileModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostFileModel';
    ...
    protected static $openAPITypes = [
        ...
        'advanced' => '\OngoingAPI\Model\PostFileModelAdvanced'
    ];
    ...
    protected static $setters = [
        ...
        'file_data_base64' => 'setFileDataBase64',
    ...
    protected static $getters = [
        ...
        'file_data_base64' => 'getFileDataBase64',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('file_data_base64', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['file_data_base64'] === null) {
            $invalidProperties[] = "'file_data_base64' can't be null";
        }
        if ((mb_strlen($this->container['file_data_base64']) < 1)) {
            $invalidProperties[] = "invalid value for 'file_data_base64', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setFileName($file_name)
    {
        ...
        if ((mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling PostFileModel., must be bigger than or equal to 1.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling PostFileModel., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets file_data_base64
     *
     * @return string
     */
    public function getFileDataBase64()
    {
        return $this->container['file_data_base64'];
    }

    /**
     * Sets file_data_base64
     *
     * @param string $file_data_base64 file_data_base64
     *
     * @return self
     */
    public function setFileDataBase64($file_data_base64)
    {
        if (is_null($file_data_base64)) {
            throw new \InvalidArgumentException('non-nullable file_data_base64 cannot be null');
        }

        if ((mb_strlen($file_data_base64) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_data_base64 when calling PostFileModel., must be bigger than or equal to 1.');
        }

        $this->container['file_data_base64'] = $file_data_base64;
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\PostFileModelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\PostFileModelAdvanced|null $advanced advanced
     *
     * @return self
     */
