<?php
/**
 * PostArticleModelStructureDefinition
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostArticleModelStructureDefinition Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelStructureDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_structureDefinition';
    ...
    protected static $openAPITypes = [
        'article_kind' => '\OngoingAPI\Model\PostArticleStructureKind',
        'rows' => '\OngoingAPI\Model\PostArticleStructureRow[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['rows']) && (count($this->container['rows']) < 1)) {
            $invalidProperties[] = "invalid value for 'rows', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets article_kind
     *
     * @return \OngoingAPI\Model\PostArticleStructureKind|null
     */
     ...
     * Sets article_kind
     *
     * @param \OngoingAPI\Model\PostArticleStructureKind|null $article_kind article_kind
     *
     * @return self
     */
    public function setArticleKind($article_kind)
    {
        if (is_null($article_kind)) {
            throw new \InvalidArgumentException('non-nullable article_kind cannot be null');
        }
     ...
     * Gets rows
     *
     * @return \OngoingAPI\Model\PostArticleStructureRow[]|null
     */
     ...
     * Sets rows
     *
     * @param \OngoingAPI\Model\PostArticleStructureRow[]|null $rows rows
     *
     * @return self
     */
    public function setRows($rows)
    {
        ...
        if (!is_null($rows) && (count($rows) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rows when calling PostArticleModelStructureDefinition., number of items must be greater than or equal to 1.');
        }
