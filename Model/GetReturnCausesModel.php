...
/**
 * GetReturnCausesModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnCausesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnCausesModel';
    ...
    protected static $openAPITypes = [
        'return_causes' => '\OngoingAPI\Model\GetReturnCauseModel[]'
    ];
    ...
    {
        $this->setIfExists('return_causes', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets return_causes
     *
     * @return \OngoingAPI\Model\GetReturnCauseModel[]|null
     */
    public function getReturnCauses()
    {
        return $this->container['return_causes'];
    }

    /**
     * Sets return_causes
     *
     * @param \OngoingAPI\Model\GetReturnCauseModel[]|null $return_causes return_causes
     *
     * @return self
     */
    public function setReturnCauses($return_causes)
    {
        if (is_null($return_causes)) {
            array_push($this->openAPINullablesSetToNull, 'return_causes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_causes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_causes'] = $return_causes;
