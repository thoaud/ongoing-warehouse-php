<?php
/**
 * PostPurchaseOrderModelCustomsInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderModelCustomsInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderModelCustomsInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderModel_customsInfo';
    ...
    protected static $openAPITypes = [
        ...
        'terms_of_delivery_type_location' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'terms_of_delivery_type_location' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'terms_of_delivery_type_location' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'terms_of_delivery_type_location' => 'termsOfDeliveryTypeLocation'
    ];
    ...
    protected static $setters = [
        ...
        'terms_of_delivery_type_location' => 'setTermsOfDeliveryTypeLocation'
    ];
    ...
    protected static $getters = [
        ...
        'terms_of_delivery_type_location' => 'getTermsOfDeliveryTypeLocation'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('terms_of_delivery_type_location', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets terms_of_delivery_type_location
     *
     * @return string|null
     */
    public function getTermsOfDeliveryTypeLocation()
    {
        return $this->container['terms_of_delivery_type_location'];
    }

    /**
     * Sets terms_of_delivery_type_location
     *
     * @param string|null $terms_of_delivery_type_location terms_of_delivery_type_location
     *
     * @return self
     */
    public function setTermsOfDeliveryTypeLocation($terms_of_delivery_type_location)
    {
        if (is_null($terms_of_delivery_type_location)) {
            array_push($this->openAPINullablesSetToNull, 'terms_of_delivery_type_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('terms_of_delivery_type_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['terms_of_delivery_type_location'] = $terms_of_delivery_type_location;
