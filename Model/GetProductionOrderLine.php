...
/**
 * GetProductionOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderLine';
    ...
    protected static $openAPITypes = [
        'production_order_line_id' => 'int',
        'production_order_line_number' => 'string',
        'production_order_line_comment' => 'string',
        'article' => '\OngoingAPI\Model\GetProductionOrderLineArticle',
        'ordered_number_of_items' => 'float',
        'produced_number_of_items' => 'float',
        'consumed' => '\OngoingAPI\Model\GetProductionOrderLineConsumedInfo[]',
        'produced' => '\OngoingAPI\Model\GetProductionOrderLineProducedInfo[]'
    ];
    ...
    protected static $openAPIFormats = [
        'production_order_line_id' => 'int32',
        'production_order_line_number' => null,
        'production_order_line_comment' => null,
        'article' => null,
        'ordered_number_of_items' => 'decimal',
        'produced_number_of_items' => 'decimal',
        'consumed' => null,
        'produced' => null
    ];
    ...
    protected static array $openAPINullables = [
        'production_order_line_id' => false,
        'production_order_line_number' => true,
        'production_order_line_comment' => true,
        'article' => true,
        'ordered_number_of_items' => false,
        'produced_number_of_items' => false,
        'consumed' => true,
        'produced' => true
    ];
    ...
    protected static $attributeMap = [
        'production_order_line_id' => 'productionOrderLineId',
        'production_order_line_number' => 'productionOrderLineNumber',
        'production_order_line_comment' => 'productionOrderLineComment',
        'article' => 'article',
        'ordered_number_of_items' => 'orderedNumberOfItems',
        'produced_number_of_items' => 'producedNumberOfItems',
        'consumed' => 'consumed',
        'produced' => 'produced'
    ];
    ...
    protected static $setters = [
        'production_order_line_id' => 'setProductionOrderLineId',
        'production_order_line_number' => 'setProductionOrderLineNumber',
        'production_order_line_comment' => 'setProductionOrderLineComment',
        'article' => 'setArticle',
        'ordered_number_of_items' => 'setOrderedNumberOfItems',
        'produced_number_of_items' => 'setProducedNumberOfItems',
        'consumed' => 'setConsumed',
        'produced' => 'setProduced'
    ];
    ...
    protected static $getters = [
        'production_order_line_id' => 'getProductionOrderLineId',
        'production_order_line_number' => 'getProductionOrderLineNumber',
        'production_order_line_comment' => 'getProductionOrderLineComment',
        'article' => 'getArticle',
        'ordered_number_of_items' => 'getOrderedNumberOfItems',
        'produced_number_of_items' => 'getProducedNumberOfItems',
    ...
    {
        $this->setIfExists('production_order_line_id', $data ?? [], null);
        $this->setIfExists('production_order_line_number', $data ?? [], null);
        $this->setIfExists('production_order_line_comment', $data ?? [], null);
        $this->setIfExists('article', $data ?? [], null);
        $this->setIfExists('ordered_number_of_items', $data ?? [], null);
        $this->setIfExists('produced_number_of_items', $data ?? [], null);
        $this->setIfExists('consumed', $data ?? [], null);
        $this->setIfExists('produced', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets production_order_line_id
     *
     * @return int|null
     */
    public function getProductionOrderLineId()
    {
        return $this->container['production_order_line_id'];
    }

    /**
     * Sets production_order_line_id
     *
     * @param int|null $production_order_line_id production_order_line_id
     *
     * @return self
     */
    public function setProductionOrderLineId($production_order_line_id)
    {
        if (is_null($production_order_line_id)) {
            throw new \InvalidArgumentException('non-nullable production_order_line_id cannot be null');
        }
        $this->container['production_order_line_id'] = $production_order_line_id;
     ...
     *
     * @param string|null $production_order_line_number production_order_line_number
     *
     * @return self
     */
    public function setProductionOrderLineNumber($production_order_line_number)
    {
        if (is_null($production_order_line_number)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_line_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_line_number', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets production_order_line_comment
     *
     * @return string|null
     */
    public function getProductionOrderLineComment()
    {
        return $this->container['production_order_line_comment'];
    }

    /**
     * Sets production_order_line_comment
     *
     * @param string|null $production_order_line_comment production_order_line_comment
     *
     * @return self
     */
    public function setProductionOrderLineComment($production_order_line_comment)
    {
        if (is_null($production_order_line_comment)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_line_comment');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_line_comment', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['production_order_line_comment'] = $production_order_line_comment;
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetProductionOrderLineArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetProductionOrderLineArticle|null $article article
     *
     * @return self
     */
    ...
    /**
     * Gets produced_number_of_items
     *
     * @return float|null
     */
    public function getProducedNumberOfItems()
    {
        return $this->container['produced_number_of_items'];
    }

    /**
     * Sets produced_number_of_items
     *
     * @param float|null $produced_number_of_items produced_number_of_items
     *
     * @return self
     */
    public function setProducedNumberOfItems($produced_number_of_items)
    {
        if (is_null($produced_number_of_items)) {
            throw new \InvalidArgumentException('non-nullable produced_number_of_items cannot be null');
        }
        $this->container['produced_number_of_items'] = $produced_number_of_items;
     ...
     * Gets consumed
     *
     * @return \OngoingAPI\Model\GetProductionOrderLineConsumedInfo[]|null
     */
     ...
     * Sets consumed
     *
     * @param \OngoingAPI\Model\GetProductionOrderLineConsumedInfo[]|null $consumed consumed
     *
     * @return self
     */
    ...
    {
        if (is_null($consumed)) {
            array_push($this->openAPINullablesSetToNull, 'consumed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('consumed', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets produced
     *
     * @return \OngoingAPI\Model\GetProductionOrderLineProducedInfo[]|null
     */
    public function getProduced()
    {
        return $this->container['produced'];
    }

    /**
     * Sets produced
     *
     * @param \OngoingAPI\Model\GetProductionOrderLineProducedInfo[]|null $produced produced
     *
     * @return self
     */
    ...
    {
        if (is_null($produced)) {
            array_push($this->openAPINullablesSetToNull, 'produced');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('produced', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['produced'] = $produced;
