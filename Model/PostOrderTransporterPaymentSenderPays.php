<?php
/**
 * PostOrderTransporterPaymentSenderPays
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderTransporterPaymentSenderPays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderTransporterPaymentSenderPays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderTransporterPayment_senderPays';
    ...
    protected static $setters = [
        'edi_code' => 'setEdiCode',
        'waybill_template' => 'setWaybillTemplate',
    ...
    protected static $getters = [
        'edi_code' => 'getEdiCode',
        'waybill_template' => 'getWaybillTemplate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('waybill_template', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets waybill_template
     *
     * @return string|null
     */
    public function getWaybillTemplate()
    {
        return $this->container['waybill_template'];
    }

    /**
     * Sets waybill_template
     *
     * @param string|null $waybill_template waybill_template
     *
     * @return self
     */
    public function setWaybillTemplate($waybill_template)
    {
        if (is_null($waybill_template)) {
            array_push($this->openAPINullablesSetToNull, 'waybill_template');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('waybill_template', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['waybill_template'] = $waybill_template;
