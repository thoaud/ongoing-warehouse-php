...
/**
 * GetTransporterService Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetTransporterService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTransporterService';
    ...
    protected static $openAPITypes = [
        'transporter_service_name' => 'string',
    ...
    protected static $attributeMap = [
        'transporter_service_name' => 'transporterServiceName',
    ...
    protected static $setters = [
        'transporter_service_name' => 'setTransporterServiceName',
    ...
    protected static $getters = [
        'transporter_service_name' => 'getTransporterServiceName',
    ...
    {
        $this->setIfExists('transporter_service_name', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets transporter_service_name
     *
     * @return string|null
     */
    public function getTransporterServiceName()
    {
        return $this->container['transporter_service_name'];
    }

    /**
     * Sets transporter_service_name
     *
     * @param string|null $transporter_service_name transporter_service_name
     *
     * @return self
     */
    public function setTransporterServiceName($transporter_service_name)
    {
        if (is_null($transporter_service_name)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_service_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_service_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transporter_service_name'] = $transporter_service_name;
