...
/**
 * GetProductionOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetProductionOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetProductionOrderModel';
    ...
    protected static $openAPITypes = [
        'production_order_info' => '\OngoingAPI\Model\GetProductionOrderModelProductionOrderInfo',
        'production_order_lines' => '\OngoingAPI\Model\GetProductionOrderLine[]'
    ];
    ...
    protected static $attributeMap = [
        'production_order_info' => 'productionOrderInfo',
    ...
    protected static $setters = [
        'production_order_info' => 'setProductionOrderInfo',
    ...
    protected static $getters = [
        'production_order_info' => 'getProductionOrderInfo',
    ...
    {
        $this->setIfExists('production_order_info', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets production_order_info
     *
     * @return \OngoingAPI\Model\GetProductionOrderModelProductionOrderInfo|null
     */
    public function getProductionOrderInfo()
    {
        return $this->container['production_order_info'];
    }

    /**
     * Sets production_order_info
     *
     * @param \OngoingAPI\Model\GetProductionOrderModelProductionOrderInfo|null $production_order_info production_order_info
     *
     * @return self
     */
    public function setProductionOrderInfo($production_order_info)
    {
        if (is_null($production_order_info)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['production_order_info'] = $production_order_info;
     ...
     *
     * @return \OngoingAPI\Model\GetProductionOrderLine[]|null
     */
     ...
     *
     * @param \OngoingAPI\Model\GetProductionOrderLine[]|null $production_order_lines production_order_lines
     *
     * @return self
     */
    public function setProductionOrderLines($production_order_lines)
    {
        if (is_null($production_order_lines)) {
            array_push($this->openAPINullablesSetToNull, 'production_order_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('production_order_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
