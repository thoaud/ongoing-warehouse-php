<?php
/**
 * PostOrderTransporterPaymentAdvanced
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrderTransporterPaymentAdvanced Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderTransporterPaymentAdvanced implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderTransporter_paymentAdvanced';
    ...
    protected static $openAPITypes = [
        'consignee_collects' => 'bool',
        'consignee_pays' => '\OngoingAPI\Model\PostOrderTransporterPaymentConsigneePays',
        'third_party_pays' => '\OngoingAPI\Model\PostOrderTransporterPaymentThirdPartyPays',
        'sender_pays' => '\OngoingAPI\Model\PostOrderTransporterPaymentSenderPays'
    ];
    ...
    protected static $openAPIFormats = [
        'consignee_collects' => null,
        'consignee_pays' => null,
        'third_party_pays' => null,
        'sender_pays' => null
    ];
    ...
    protected static $attributeMap = [
        'consignee_collects' => 'consigneeCollects',
        'consignee_pays' => 'consigneePays',
        'third_party_pays' => 'thirdPartyPays',
    ...
    protected static $setters = [
        'consignee_collects' => 'setConsigneeCollects',
        'consignee_pays' => 'setConsigneePays',
        'third_party_pays' => 'setThirdPartyPays',
        'sender_pays' => 'setSenderPays'
    ];
    ...
    protected static $getters = [
        'consignee_collects' => 'getConsigneeCollects',
        'consignee_pays' => 'getConsigneePays',
        'third_party_pays' => 'getThirdPartyPays',
        'sender_pays' => 'getSenderPays'
    ];
    ...
    {
        $this->setIfExists('consignee_collects', $data ?? [], null);
        $this->setIfExists('consignee_pays', $data ?? [], null);
        $this->setIfExists('third_party_pays', $data ?? [], null);
        $this->setIfExists('sender_pays', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets consignee_collects
     *
     * @return bool|null
     */
    public function getConsigneeCollects()
    {
        return $this->container['consignee_collects'];
    }

    /**
     * Sets consignee_collects
     *
     * @param bool|null $consignee_collects consignee_collects
     *
     * @return self
     */
    public function setConsigneeCollects($consignee_collects)
    {
        if (is_null($consignee_collects)) {
            array_push($this->openAPINullablesSetToNull, 'consignee_collects');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('consignee_collects', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['consignee_collects'] = $consignee_collects;
     ...
     * Gets consignee_pays
     *
     * @return \OngoingAPI\Model\PostOrderTransporterPaymentConsigneePays|null
     */
    public function getConsigneePays()
    {
        return $this->container['consignee_pays'];
    }

    /**
     * Sets consignee_pays
     *
     * @param \OngoingAPI\Model\PostOrderTransporterPaymentConsigneePays|null $consignee_pays consignee_pays
     *
     * @return self
     */
    public function setConsigneePays($consignee_pays)
    {
        if (is_null($consignee_pays)) {
            array_push($this->openAPINullablesSetToNull, 'consignee_pays');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('consignee_pays', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['consignee_pays'] = $consignee_pays;

        return $this;
    }

    /**
     * Gets third_party_pays
     *
     * @return \OngoingAPI\Model\PostOrderTransporterPaymentThirdPartyPays|null
     */
    public function getThirdPartyPays()
    {
        return $this->container['third_party_pays'];
    }

    /**
     * Sets third_party_pays
     *
     * @param \OngoingAPI\Model\PostOrderTransporterPaymentThirdPartyPays|null $third_party_pays third_party_pays
     *
     * @return self
     */
    public function setThirdPartyPays($third_party_pays)
    {
        if (is_null($third_party_pays)) {
            array_push($this->openAPINullablesSetToNull, 'third_party_pays');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('third_party_pays', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['third_party_pays'] = $third_party_pays;
     ...
     * Gets sender_pays
     *
     * @return \OngoingAPI\Model\PostOrderTransporterPaymentSenderPays|null
     */
    public function getSenderPays()
    {
        return $this->container['sender_pays'];
    }

    /**
     * Sets sender_pays
     *
     * @param \OngoingAPI\Model\PostOrderTransporterPaymentSenderPays|null $sender_pays sender_pays
     *
     * @return self
     */
    public function setSenderPays($sender_pays)
    {
        if (is_null($sender_pays)) {
            array_push($this->openAPINullablesSetToNull, 'sender_pays');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sender_pays', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['sender_pays'] = $sender_pays;
