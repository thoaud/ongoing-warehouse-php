...
/**
 * PostArticleTaricNumber Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleTaricNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleTaricNumber';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['taric_number'] === null) {
            $invalidProperties[] = "'taric_number' can't be null";
        }
        if ((mb_strlen($this->container['taric_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'taric_number', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling PostArticleTaricNumber., must be bigger than or equal to 1.');
        }
     ...
     * Sets taric_number
     *
     * @param string $taric_number taric_number
     *
     * @return self
     */
    public function setTaricNumber($taric_number)
    {
        ...
        if ((mb_strlen($taric_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $taric_number when calling PostArticleTaricNumber., must be bigger than or equal to 1.');
        }
