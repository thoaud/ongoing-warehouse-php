<?php
/**
 * PostPurchaseOrderAdvancedCustomer
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostPurchaseOrderAdvancedCustomer Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostPurchaseOrderAdvancedCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostPurchaseOrderAdvanced_customer';
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\OngoingAPI\Model\PostPurchaseOrderCustomerAddress'
    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OngoingAPI\Model\PostPurchaseOrderCustomerAddress|null
     */
     ...
     * Sets address
     *
     * @param \OngoingAPI\Model\PostPurchaseOrderCustomerAddress|null $address address
     *
     * @return self
     */
