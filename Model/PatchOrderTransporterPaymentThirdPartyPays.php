<?php
/**
 * PatchOrderTransporterPaymentThirdPartyPays
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PatchOrderTransporterPaymentThirdPartyPays Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderTransporterPaymentThirdPartyPays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderTransporterPayment_thirdPartyPays';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['customer_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'customer_number', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setCustomerNumber($customer_number)
    {
        ...
        if ((mb_strlen($customer_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_number when calling PatchOrderTransporterPaymentThirdPartyPays., must be bigger than or equal to 1.');
        }
