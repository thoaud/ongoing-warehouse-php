<?php
/**
 * PostArticleModelTaricNumbersInfo
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostArticleModelTaricNumbersInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostArticleModelTaricNumbersInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostArticleModel_taricNumbersInfo';
    ...
    protected static $openAPITypes = [
        'taric_numbers' => '\OngoingAPI\Model\PostArticleTaricNumber[]'
    ];
    ...
    {
        $this->setIfExists('taric_numbers', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets taric_numbers
     *
     * @return \OngoingAPI\Model\PostArticleTaricNumber[]|null
     */
    public function getTaricNumbers()
    {
        return $this->container['taric_numbers'];
    }

    /**
     * Sets taric_numbers
     *
     * @param \OngoingAPI\Model\PostArticleTaricNumber[]|null $taric_numbers taric_numbers
     *
     * @return self
     */
    public function setTaricNumbers($taric_numbers)
    {
        if (is_null($taric_numbers)) {
            array_push($this->openAPINullablesSetToNull, 'taric_numbers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('taric_numbers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['taric_numbers'] = $taric_numbers;
