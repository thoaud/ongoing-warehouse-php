...
/**
 * GetReturnedArticleItem Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetReturnedArticleItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReturnedArticleItem';
    ...
    protected static $openAPIFormats = [
        ...
        'return_comment' => null,
        'is_return_removed_by_inventory' => null,
        'return_cause' => null,
        'article_item_status' => null,
        'article_item_category' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'return_time' => true,
        'return_comment' => true,
        'is_return_removed_by_inventory' => false,
        'return_cause' => true,
        'article_item_status' => true,
        'article_item_category' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_return_removed_by_inventory' => 'isReturnRemovedByInventory',
        'return_cause' => 'returnCause',
        'article_item_status' => 'articleItemStatus',
        'article_item_category' => 'articleItemCategory'
    ];
    ...
    protected static $setters = [
        ...
        'is_return_removed_by_inventory' => 'setIsReturnRemovedByInventory',
        'return_cause' => 'setReturnCause',
        'article_item_status' => 'setArticleItemStatus',
        'article_item_category' => 'setArticleItemCategory'
    ];
    ...
    protected static $getters = [
        ...
        'is_return_removed_by_inventory' => 'getIsReturnRemovedByInventory',
        'return_cause' => 'getReturnCause',
        'article_item_status' => 'getArticleItemStatus',
        'article_item_category' => 'getArticleItemCategory'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_return_removed_by_inventory', $data ?? [], null);
        $this->setIfExists('return_cause', $data ?? [], null);
        $this->setIfExists('article_item_status', $data ?? [], null);
        $this->setIfExists('article_item_category', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets return_time
     *
     * @param \DateTime|null $return_time return_time
     *
     * @return self
     */
    public function setReturnTime($return_time)
    {
        if (is_null($return_time)) {
            array_push($this->openAPINullablesSetToNull, 'return_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets return_comment
     *
     * @param string|null $return_comment return_comment
     *
     * @return self
     */
    ...
    /**
     * Gets is_return_removed_by_inventory
     *
     * @return bool|null
     */
    public function getIsReturnRemovedByInventory()
    {
        return $this->container['is_return_removed_by_inventory'];
    }

    /**
     * Sets is_return_removed_by_inventory
     *
     * @param bool|null $is_return_removed_by_inventory is_return_removed_by_inventory
     *
     * @return self
     */
    public function setIsReturnRemovedByInventory($is_return_removed_by_inventory)
    {
        if (is_null($is_return_removed_by_inventory)) {
            throw new \InvalidArgumentException('non-nullable is_return_removed_by_inventory cannot be null');
        }
        $this->container['is_return_removed_by_inventory'] = $is_return_removed_by_inventory;
    ...
    /**
     * Gets article_item_category
     *
     * @return \OngoingAPI\Model\GetArticleItemInfoStatus|null
     */
    public function getArticleItemCategory()
    {
        return $this->container['article_item_category'];
    }

    /**
     * Sets article_item_category
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $article_item_category article_item_category
     *
     * @return self
     */
    public function setArticleItemCategory($article_item_category)
    {
        if (is_null($article_item_category)) {
            array_push($this->openAPINullablesSetToNull, 'article_item_category');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_item_category', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['article_item_category'] = $article_item_category;
