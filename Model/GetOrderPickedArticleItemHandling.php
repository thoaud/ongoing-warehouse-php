<?php
/**
 * GetOrderPickedArticleItemHandling
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderPickedArticleItemHandling Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderPickedArticleItemHandling implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderPickedArticleItem_handling';
    ...
    protected static $openAPIFormats = [
        'picked_by_user_id' => 'int32',
        'packed_by_user_id' => 'int32',
        'returned_by_user_id' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        'picked_by_user_id' => true,
        'packed_by_user_id' => true,
        'returned_by_user_id' => true
    ];
    ...
    protected static $setters = [
        'picked_by_user_id' => 'setPickedByUserId',
        'packed_by_user_id' => 'setPackedByUserId',
        'returned_by_user_id' => 'setReturnedByUserId'
    ];
    ...
    protected static $getters = [
        'picked_by_user_id' => 'getPickedByUserId',
        'packed_by_user_id' => 'getPackedByUserId',
        'returned_by_user_id' => 'getReturnedByUserId'
    ];
    ...
    {
        $this->setIfExists('picked_by_user_id', $data ?? [], null);
        $this->setIfExists('packed_by_user_id', $data ?? [], null);
        $this->setIfExists('returned_by_user_id', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets picked_by_user_id
     *
     * @return int|null
     */
    public function getPickedByUserId()
    {
        return $this->container['picked_by_user_id'];
    }

    /**
     * Sets picked_by_user_id
     *
     * @param int|null $picked_by_user_id picked_by_user_id
     *
     * @return self
     */
    public function setPickedByUserId($picked_by_user_id)
    {
        if (is_null($picked_by_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'picked_by_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('picked_by_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['picked_by_user_id'] = $picked_by_user_id;

        return $this;
    }

    /**
     * Gets packed_by_user_id
     *
     * @return int|null
     */
    public function getPackedByUserId()
    {
        return $this->container['packed_by_user_id'];
    }

    /**
     * Sets packed_by_user_id
     *
     * @param int|null $packed_by_user_id packed_by_user_id
     *
     * @return self
     */
    public function setPackedByUserId($packed_by_user_id)
    {
        if (is_null($packed_by_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'packed_by_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('packed_by_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['packed_by_user_id'] = $packed_by_user_id;

        return $this;
    }

    /**
     * Gets returned_by_user_id
     *
     * @return int|null
     */
    public function getReturnedByUserId()
    {
        return $this->container['returned_by_user_id'];
    }

    /**
     * Sets returned_by_user_id
     *
     * @param int|null $returned_by_user_id returned_by_user_id
     *
     * @return self
     */
    public function setReturnedByUserId($returned_by_user_id)
    {
        if (is_null($returned_by_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'returned_by_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('returned_by_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['returned_by_user_id'] = $returned_by_user_id;
