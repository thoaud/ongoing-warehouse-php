<?php
/**
 * GetInvoiceOrderContextConsignee
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetInvoiceOrderContextConsignee Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInvoiceOrderContextConsignee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInvoiceOrderContext_consignee';
    ...
    {
        $this->setIfExists('consignee_id', $data ?? [], null);
    ...
    */
     ...
     * Sets consignee_id
     *
     * @param int|null $consignee_id consignee_id
     *
     * @return self
     */
    public function setConsigneeId($consignee_id)
    {
        if (is_null($consignee_id)) {
            throw new \InvalidArgumentException('non-nullable consignee_id cannot be null');
        }
