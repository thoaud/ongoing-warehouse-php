...
/**
 * GetInventoryAdjustmentsLine Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetInventoryAdjustmentsLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetInventoryAdjustmentsLine';
    ...
    protected static $openAPITypes = [
        'article' => '\OngoingAPI\Model\GetInventoryAdjustmentsLineArticle',
        'inventory_adjustments' => '\OngoingAPI\Model\GetInventoryAdjustment[]'
    ];
    ...
    protected static $setters = [
        'article' => 'setArticle',
        'inventory_adjustments' => 'setInventoryAdjustments'
    ];
    ...
    protected static $getters = [
        'article' => 'getArticle',
        'inventory_adjustments' => 'getInventoryAdjustments'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('inventory_adjustments', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets article
     *
     * @return \OngoingAPI\Model\GetInventoryAdjustmentsLineArticle|null
     */
     ...
     * Sets article
     *
     * @param \OngoingAPI\Model\GetInventoryAdjustmentsLineArticle|null $article article
     *
     * @return self
     */
    ...
    /**
     * Gets inventory_adjustments
     *
     * @return \OngoingAPI\Model\GetInventoryAdjustment[]|null
     */
    public function getInventoryAdjustments()
    {
        return $this->container['inventory_adjustments'];
    }

    /**
     * Sets inventory_adjustments
     *
     * @param \OngoingAPI\Model\GetInventoryAdjustment[]|null $inventory_adjustments inventory_adjustments
     *
     * @return self
     */
    public function setInventoryAdjustments($inventory_adjustments)
    {
        if (is_null($inventory_adjustments)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_adjustments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_adjustments', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['inventory_adjustments'] = $inventory_adjustments;
