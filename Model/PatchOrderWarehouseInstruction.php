...
/**
 * PatchOrderWarehouseInstruction Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PatchOrderWarehouseInstruction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchOrderWarehouseInstruction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['warehouse_instruction'] === null) {
            $invalidProperties[] = "'warehouse_instruction' can't be null";
        }
        if ((mb_strlen($this->container['warehouse_instruction']) > 500)) {
            $invalidProperties[] = "invalid value for 'warehouse_instruction', the character length must be smaller than or equal to 500.";
        }
     ...
     *
     * @param string $warehouse_instruction warehouse_instruction
     *
     * @return self
     */
    public function setWarehouseInstruction($warehouse_instruction)
    {
        if (is_null($warehouse_instruction)) {
            throw new \InvalidArgumentException('non-nullable warehouse_instruction cannot be null');
        }
        if ((mb_strlen($warehouse_instruction) > 500)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_instruction when calling PatchOrderWarehouseInstruction., must be smaller than or equal to 500.');
        }
