...
/**
 * GetOrderLinePickOrderInfo Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderLinePickOrderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderLine_pickOrderInfo';
    ...
    protected static $openAPITypes = [
        'pick_order_id' => 'int',
        'bin_index' => 'int',
        'pick_order_type' => '\OngoingAPI\Model\GetArticleItemInfoStatus'
    ];
    ...
    protected static $setters = [
        'pick_order_id' => 'setPickOrderId',
        'bin_index' => 'setBinIndex',
        'pick_order_type' => 'setPickOrderType'
    ];
    ...
    protected static $getters = [
        'pick_order_id' => 'getPickOrderId',
        'bin_index' => 'getBinIndex',
        'pick_order_type' => 'getPickOrderType'
    ];
    ...
    {
        $this->setIfExists('pick_order_id', $data ?? [], null);
        $this->setIfExists('bin_index', $data ?? [], null);
        $this->setIfExists('pick_order_type', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['pick_order_id'];
    }

    /**
     * Sets pick_order_id
     *
     * @param int|null $pick_order_id pick_order_id
     *
     * @return self
     */
    public function setPickOrderId($pick_order_id)
    {
        if (is_null($pick_order_id)) {
            throw new \InvalidArgumentException('non-nullable pick_order_id cannot be null');
        }
        $this->container['pick_order_id'] = $pick_order_id;
     ...
     * Sets bin_index
     *
     * @param int|null $bin_index bin_index
     *
     * @return self
     */
    ...
    /**
     * Gets pick_order_type
     *
     * @return \OngoingAPI\Model\GetArticleItemInfoStatus|null
     */
    public function getPickOrderType()
    {
        return $this->container['pick_order_type'];
    }

    /**
     * Sets pick_order_type
     *
     * @param \OngoingAPI\Model\GetArticleItemInfoStatus|null $pick_order_type pick_order_type
     *
     * @return self
     */
    public function setPickOrderType($pick_order_type)
    {
        if (is_null($pick_order_type)) {
            array_push($this->openAPINullablesSetToNull, 'pick_order_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pick_order_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pick_order_type'] = $pick_order_type;
