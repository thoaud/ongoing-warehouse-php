...
/**
 * PostOrderModel Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class PostOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'consignee' => '\OngoingAPI\Model\PostOrderConsignee',
        'email_notification' => '\OngoingAPI\Model\PostOrderModelEmailNotification',
        'sms_notification' => '\OngoingAPI\Model\PostOrderModelEmailNotification',
        'telephone_notification' => '\OngoingAPI\Model\PostOrderModelEmailNotification',
        'transporter' => '\OngoingAPI\Model\PostOrderModelTransporter',
        'return_transporter' => '\OngoingAPI\Model\PostOrderModelReturnTransporter',
        'order_lines' => '\OngoingAPI\Model\PostOrderLine[]',
        'customs_info' => '\OngoingAPI\Model\PostOrderModelCustomsInfo',
        'prepared_transport_document_id' => 'string',
        'freight_price' => 'float',
        'warehouse_id' => 'int',
        'classes' => '\OngoingAPI\Model\PostOrderClass[]',
        'terms_of_delivery_type' => '\OngoingAPI\Model\GetArticleItemInfoStatus',
        'customer_price' => 'float',
        'advanced' => '\OngoingAPI\Model\PostOrderModelAdvanced',
        'consignee_order_number' => 'string',
        'warehouse_instruction' => 'string',
        'market_place' => '\OngoingAPI\Model\PostOrderModelMarketPlace',
        'picking_priority' => 'int',
        'production_code' => 'string',
        'transporter_bulk_id' => 'string',
        'invoice_url' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'transporter_bulk_id' => 'transporterBulkId',
    ...
    protected static $setters = [
        ...
        'return_transporter' => 'setReturnTransporter',
        ...
        'transporter_bulk_id' => 'setTransporterBulkId',
    ...
    protected static $getters = [
        ...
        'return_transporter' => 'getReturnTransporter',
        ...
        'transporter_bulk_id' => 'getTransporterBulkId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_transporter', $data ?? [], null);
        ...
        $this->setIfExists('transporter_bulk_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['delivery_date']) < 1)) {
            $invalidProperties[] = "invalid value for 'delivery_date', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setOrderNumber($order_number)
    {
        ...
        if ((mb_strlen($order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling PostOrderModel., must be bigger than or equal to 1.');
        }
    ...
    public function setDeliveryDate($delivery_date)
    {
        ...
        if ((mb_strlen($delivery_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date when calling PostOrderModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets consignee
     *
     * @return \OngoingAPI\Model\PostOrderConsignee
     */
     ...
     * Sets consignee
     *
     * @param \OngoingAPI\Model\PostOrderConsignee $consignee consignee
     *
     * @return self
     */
     ...
     *
     * @return \OngoingAPI\Model\PostOrderModelEmailNotification|null
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderModelEmailNotification|null $email_notification email_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderModelEmailNotification|null $sms_notification sms_notification
     *
     * @return self
     */
     ...
     *
     * @param \OngoingAPI\Model\PostOrderModelEmailNotification|null $telephone_notification telephone_notification
     *
     * @return self
     */
     ...
     * Gets transporter
     *
     * @return \OngoingAPI\Model\PostOrderModelTransporter|null
     */
     ...
     * Sets transporter
     *
     * @param \OngoingAPI\Model\PostOrderModelTransporter|null $transporter transporter
     *
     * @return self
     */
    public function setTransporter($transporter)
    {
        if (is_null($transporter)) {
            array_push($this->openAPINullablesSetToNull, 'transporter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets return_transporter
     *
     * @return \OngoingAPI\Model\PostOrderModelReturnTransporter|null
     */
    public function getReturnTransporter()
    {
        return $this->container['return_transporter'];
    }

    /**
     * Sets return_transporter
     *
     * @param \OngoingAPI\Model\PostOrderModelReturnTransporter|null $return_transporter return_transporter
     *
     * @return self
     */
    public function setReturnTransporter($return_transporter)
    {
        if (is_null($return_transporter)) {
            array_push($this->openAPINullablesSetToNull, 'return_transporter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('return_transporter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['return_transporter'] = $return_transporter;
     ...
     * Gets order_lines
     *
     * @return \OngoingAPI\Model\PostOrderLine[]|null
     */
     ...
     * Sets order_lines
     *
     * @param \OngoingAPI\Model\PostOrderLine[]|null $order_lines order_lines
     *
     * @return self
     */
    public function setOrderLines($order_lines)
    {
        if (is_null($order_lines)) {
            array_push($this->openAPINullablesSetToNull, 'order_lines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_lines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets customs_info
     *
     * @return \OngoingAPI\Model\PostOrderModelCustomsInfo|null
     */
     ...
     * Sets customs_info
     *
     * @param \OngoingAPI\Model\PostOrderModelCustomsInfo|null $customs_info customs_info
     *
     * @return self
     */
     ...
     * Gets classes
     *
     * @return \OngoingAPI\Model\PostOrderClass[]|null
     */
     ...
     * Sets classes
     *
     * @param \OngoingAPI\Model\PostOrderClass[]|null $classes classes
     *
     * @return self
     */
     ...
     * Gets advanced
     *
     * @return \OngoingAPI\Model\PostOrderModelAdvanced|null
     */
     ...
     * Sets advanced
     *
     * @param \OngoingAPI\Model\PostOrderModelAdvanced|null $advanced advanced
     *
     * @return self
     */
     ...
     * Gets market_place
     *
     * @return \OngoingAPI\Model\PostOrderModelMarketPlace|null
     */
     ...
     * Sets market_place
     *
     * @param \OngoingAPI\Model\PostOrderModelMarketPlace|null $market_place market_place
     *
     * @return self
     */
    ...
    /**
     * Gets transporter_bulk_id
     *
     * @return string|null
     */
    public function getTransporterBulkId()
    {
        return $this->container['transporter_bulk_id'];
    }

    /**
     * Sets transporter_bulk_id
     *
     * @param string|null $transporter_bulk_id transporter_bulk_id
     *
     * @return self
     */
    public function setTransporterBulkId($transporter_bulk_id)
    {
        if (is_null($transporter_bulk_id)) {
            array_push($this->openAPINullablesSetToNull, 'transporter_bulk_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('transporter_bulk_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['transporter_bulk_id'] = $transporter_bulk_id;
