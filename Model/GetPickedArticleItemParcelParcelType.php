<?php
/**
 * GetPickedArticleItemParcelParcelType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetPickedArticleItemParcelParcelType Class Doc Comment
 *
 * @category Class
 * @package  OngoingAPI
 * @author   OpenAPI Generator team
 ...
 */
class GetPickedArticleItemParcelParcelType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPickedArticleItemParcel_parcelType';
